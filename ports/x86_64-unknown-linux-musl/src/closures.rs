...
#[inline]
unsafe fn atomic_load_relaxed_i32(ptr: *mut ::core::ffi::c_int) -> ::core::ffi::c_int {
    (*(ptr as *const ::core::sync::atomic::AtomicI32)).load(::core::sync::atomic::Ordering::Relaxed)
}

#[inline]
unsafe fn atomic_exchange_acquire_i32(
    ptr: *mut ::core::ffi::c_int,
    value: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    (*(ptr as *const ::core::sync::atomic::AtomicI32))
        .swap(value, ::core::sync::atomic::Ordering::Acquire)
}

#[inline]
unsafe fn atomic_store_release_i32(ptr: *mut ::core::ffi::c_int, value: ::core::ffi::c_int) {
    (*(ptr as *const ::core::sync::atomic::AtomicI32))
        .store(value, ::core::sync::atomic::Ordering::Release);
}

#[inline]
unsafe fn atomic_load_acquire_u64(ptr: *mut u64) -> u64 {
    (*(ptr as *const ::core::sync::atomic::AtomicU64)).load(::core::sync::atomic::Ordering::Acquire)
}

#[inline]
unsafe fn atomic_store_release_u64(ptr: *mut u64, value: u64) {
...
unsafe extern "C" fn spin_acquire_lock(mut sl: *mut ::core::ffi::c_int) -> ::core::ffi::c_int {
    ...
    while atomic_load_relaxed_i32(sl) != 0 as ::core::ffi::c_int
        || atomic_exchange_acquire_i32(sl, 1 as ::core::ffi::c_int) != 0
    {
        spins += 1;
...
unsafe extern "C" fn init_mparams() -> ::core::ffi::c_int {
    if atomic_exchange_acquire_i32(&raw mut malloc_global_mutex, 1 as ::core::ffi::c_int) != 0 {
    ...
    if mparams.magic == 0 as size_t {
        ...
        atomic_store_release_u64(&raw mut mparams.magic, magic);
    }
    atomic_store_release_i32(&raw mut malloc_global_mutex, 0);
    return 1 as ::core::ffi::c_int;
}
...
unsafe extern "C" fn sys_alloc(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
    ...
    (atomic_load_acquire_u64(&raw mut mparams.magic) != 0 as size_t || init_mparams() != 0)
        as ::core::ffi::c_int;
    ...
    if HAVE_MORECORE != 0 && tbase == CMFAIL {
        if asize < HALF_MAX_SIZE_T {
            ...
            if atomic_exchange_acquire_i32(&raw mut malloc_global_mutex, 1 as ::core::ffi::c_int)
                != 0
            {
                spin_acquire_lock(&raw mut malloc_global_mutex);
            } else {
...
unsafe extern "C" fn dlmalloc(mut bytes: size_t) -> *mut ::core::ffi::c_void {
    ...
    if if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
        if atomic_exchange_acquire_i32(&raw mut _gm_.mutex, 1 as ::core::ffi::c_int) != 0 {
    ...
    } == 0
    {
        ...
        if bytes as usize <= MAX_SMALL_REQUEST {
                ...
                != 0 as ::core::ffi::c_uint
            {
                ...
                mem = (p as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as usize as isize)
                    as *mut ::core::ffi::c_void;
                current_block = 446404116201302243;
        ...
        if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
            atomic_store_release_i32(&raw mut _gm_.mutex, 0);
        }
        return mem;
    } else {
        return ::core::ptr::null_mut::<::core::ffi::c_void>();
                ...
                != 0
            {
                ...
                if (*p).head & PINUSE_BIT == 0 {
                    ...
                    if (*p).head & INUSE_BITS == 0 as size_t {
                        ...
                        current_block = 8556108345853098498;
                    } else {
                            ...
                            != 0
                        {
                            ...
                            current_block = 15941797165452792955;
                        }
                    }
                } else {
                    current_block = 10778260831612459202;
    ...
    if bytes as usize >= (MAX_REQUEST as usize).wrapping_sub(alignment as usize) {
        ...
        if !mem.is_null() {
            ...
            if if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
                if atomic_exchange_acquire_i32(&raw mut (*m).mutex, 1 as ::core::ffi::c_int) != 0 {
            ...
            if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
                atomic_store_release_i32(&raw mut (*m).mutex, 0);
            }
        }
    }
    return mem;
...
unsafe extern "C" fn selinux_enabled_check() -> ::core::ffi::c_int {
    ...
    while getline(&raw mut buf, &raw mut len, f) >= 0 as ssize_t {
...
unsafe extern "C" fn pax_flags_check() -> ::core::ffi::c_int {
    ...
    while getline(&raw mut buf, &raw mut len, f) != -(1 as ::core::ffi::c_int) as ssize_t {
        if !(strncmp(
            buf,
...
unsafe extern "C" fn dlmmap_locked(
    ...
    if execfd == -(1 as ::core::ffi::c_int) {
        open_temp_exec_file_opts_idx = 0 as ::core::ffi::c_int;
        current_block = 716298584813836495;
    } else {
