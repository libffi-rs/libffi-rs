extern "C" {
    ...
    fn ffi_prep_cif_machdep_efi64(cif: *mut ffi_cif) -> ffi_status;
    fn ffi_call_efi64(
        cif: *mut ffi_cif,
    ...
    's_390: {
        ...
        match (*type_0).type_0 as ::core::ffi::c_int {
            ...
            | FFI_TYPE_UINT128 | FFI_TYPE_SINT128 | FFI_TYPE_POINTER => {
                current_block_80 = 13002847050935544564;
            }
            FFI_TYPE_FLOAT => {
                current_block_80 = 5145836485585444537;
            }
            FFI_TYPE_DOUBLE => {
            ...
            FFI_TYPE_STRUCT => {
                ...
                if words == 0 {
                    current_block_80 = 16164501123729880799;
                } else {
            ...
            FFI_TYPE_COMPLEX => {
                ...
                match (*inner).type_0 as ::core::ffi::c_int {
                    ...
                    FFI_TYPE_SINT128 | FFI_TYPE_UINT128 => {
                        current_block_80 = 732295815335058977;
                        match current_block_80 {
                            732295815335058977 => return 0 as size_t,
                            2165623813156138699 => {
                    ...
                    FFI_TYPE_FLOAT => {
                        current_block_80 = 2165623813156138699;
                        match current_block_80 {
                            732295815335058977 => return 0 as size_t,
                            2165623813156138699 => {
                                *classes.offset(0 as ::core::ffi::c_int as isize) =
                    ...
                    FFI_TYPE_DOUBLE => {
                        current_block_80 = 9378052560089318616;
                        match current_block_80 {
                            732295815335058977 => return 0 as size_t,
                            2165623813156138699 => {
                                *classes.offset(0 as ::core::ffi::c_int as isize) =
                    ...
                    FFI_TYPE_LONGDOUBLE => {
                        current_block_80 = 16805197968349678697;
                        match current_block_80 {
                            732295815335058977 => return 0 as size_t,
                            2165623813156138699 => {
                                *classes.offset(0 as ::core::ffi::c_int as isize) =
...
pub unsafe extern "C" fn ffi_prep_cif_machdep(mut cif: *mut ffi_cif) -> ffi_status {
    ...
    if (*cif).abi as ::core::ffi::c_uint == FFI_EFI64 as ::core::ffi::c_int as ::core::ffi::c_uint
        ...
        FFI_TYPE_STRUCT => {
            ...
            if n == 0 as size_t {
                ...
                if rtype_size == 4 as size_t && sse0 as ::core::ffi::c_int != 0 {
                    ...
                    flags =
                        (flags as size_t | rtype_size << UNIX64_SIZE_SHIFT) as ::core::ffi::c_uint;
                }
            }
        }
        FFI_TYPE_COMPLEX => {
    ...
    while i < avn {
            ...
            || ssecount + nsse > MAX_SSE_REGS
        {
            ...
            bytes = (bytes.wrapping_sub(1 as size_t)
                | (align - 1 as ::core::ffi::c_long) as size_t)
                .wrapping_add(1 as size_t);
...
unsafe extern "C" fn ffi_call_int(
    ...
    ffi_call_unix64_from_rust(
        ...
        ((*cif).bytes as ::core::ffi::c_ulong)
            .wrapping_add(::core::mem::size_of::<register_args>() as ::core::ffi::c_ulong),
...
pub unsafe extern "C" fn ffi_call(
    ...
    if (*cif).abi as ::core::ffi::c_uint == FFI_EFI64 as ::core::ffi::c_int as ::core::ffi::c_uint
        || (*cif).abi as ::core::ffi::c_uint
            == FFI_GNUW64 as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        ffi_call_efi64(cif, fn_0, rvalue, avalue);
        return;
    }
...
pub unsafe extern "C" fn ffi_call_go(
    ...
    if (*cif).abi as ::core::ffi::c_uint == FFI_EFI64 as ::core::ffi::c_int as ::core::ffi::c_uint
        || (*cif).abi as ::core::ffi::c_uint
            == FFI_GNUW64 as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        ffi_call_go_efi64(cif, fn_0, rvalue, avalue, closure);
        return;
    }
...
pub unsafe extern "C" fn ffi_closure_unix64_inner(
    ...
    alloca_allocations.push(::std::vec::from_elem(
        0,
        (avn as usize).wrapping_mul(::core::mem::size_of::<*mut ::core::ffi::c_void>() as usize)
            as usize,
    ));
    ...
    if flags & UNIX64_FLAG_RET_IN_MEM != 0 {
        ...
        let mut r: *mut ::core::ffi::c_void =
            (*reg_args).gpr[fresh6 as usize] as *mut ::core::ffi::c_void;
    ...
    while i < avn {
                            ...
                            <= X86_64_SSEUP_CLASS as ::core::ffi::c_int as ::core::ffi::c_uint)
        {
            ...
            alloca_allocations.push(::std::vec::from_elem(
                0,
                16 as ::core::ffi::c_int as ::core::ffi::c_ulong as usize,
            ));
            let mut a: *mut ::core::ffi::c_char =
                alloca_allocations.last_mut().unwrap().as_mut_ptr() as *mut ::core::ffi::c_char;
            let mut j: ::core::ffi::c_uint = 0;
