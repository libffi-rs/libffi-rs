...
// x86_64 musl uses the SysV 80-bit extended value in a 16-byte, 16-byte-
// aligned storage slot. Rust has no stable C `long double` scalar, and this
// translation only needs its ABI size/alignment for the ffi_type descriptor.
#[repr(C, align(16))]
pub struct x86_64_musl_long_double_storage([u8; 16]);

#[no_mangle]
pub static mut ffi_type_longdouble: ffi_type = _ffi_type {
    size: ::core::mem::size_of::<x86_64_musl_long_double_storage>() as size_t,
    alignment: ::core::mem::align_of::<x86_64_musl_long_double_storage>() as ::core::ffi::c_ushort,
...
// C2Rust 0.22.1 cannot emit C complex-valued statics. Recreate libffi's
// descriptors directly: C complex values are pairs of their scalar type.
#[no_mangle]
pub static mut ffi_type_complex_float: ffi_type = _ffi_type {
    size: (2 * ::core::mem::size_of::<::core::ffi::c_float>()) as size_t,
...
pub static mut ffi_type_complex_double: ffi_type = _ffi_type {
    size: (2 * ::core::mem::size_of::<::core::ffi::c_double>()) as size_t,
...
pub static mut ffi_type_complex_longdouble: ffi_type = _ffi_type {
    size: (2 * ::core::mem::size_of::<x86_64_musl_long_double_storage>()) as size_t,
    alignment: ::core::mem::align_of::<x86_64_musl_long_double_storage>() as ::core::ffi::c_ushort,
    type_0: FFI_TYPE_COMPLEX as ::core::ffi::c_ushort,
