...
pub static mut ffi_type_longdouble: ffi_type = _ffi_type {
    size: ::core::mem::size_of::<FfiLongDouble>() as size_t,
...
// libffi-sys exposes these descriptors behind its `complex` feature on Unix.
// LoongArch libffi 3.5.2 does not classify FFI_TYPE_COMPLEX in prep_cif, but
// exporting correctly laid-out descriptors keeps the public data-symbol ABI
// complete; attempts to prepare such a CIF correctly return FFI_BAD_ARGTYPE.
...
static FFI_ELEMENTS_COMPLEX_FLOAT: FfiElements =
    FfiElements([&raw mut ffi_type_float, ::core::ptr::null_mut()]);
static FFI_ELEMENTS_COMPLEX_DOUBLE: FfiElements =
    FfiElements([&raw mut ffi_type_double, ::core::ptr::null_mut()]);
static FFI_ELEMENTS_COMPLEX_LONGDOUBLE: FfiElements =
    FfiElements([&raw mut ffi_type_longdouble, ::core::ptr::null_mut()]);

#[no_mangle]
pub static mut ffi_type_complex_float: ffi_type = ffi_type {
    size: 2 * ::core::mem::size_of::<::core::ffi::c_float>(),
    alignment: ::core::mem::align_of::<::core::ffi::c_float>() as _,
    type_0: FFI_TYPE_COMPLEX as _,
    elements: FFI_ELEMENTS_COMPLEX_FLOAT.0.as_ptr() as *mut *mut ffi_type,
};
#[no_mangle]
pub static mut ffi_type_complex_double: ffi_type = ffi_type {
    size: 2 * ::core::mem::size_of::<::core::ffi::c_double>(),
    alignment: ::core::mem::align_of::<::core::ffi::c_double>() as _,
    type_0: FFI_TYPE_COMPLEX as _,
    elements: FFI_ELEMENTS_COMPLEX_DOUBLE.0.as_ptr() as *mut *mut ffi_type,
};
#[no_mangle]
pub static mut ffi_type_complex_longdouble: ffi_type = ffi_type {
    size: 2 * ::core::mem::size_of::<FfiLongDouble>(),
    alignment: ::core::mem::align_of::<FfiLongDouble>() as _,
    type_0: FFI_TYPE_COMPLEX as _,
    elements: FFI_ELEMENTS_COMPLEX_LONGDOUBLE.0.as_ptr() as *mut *mut ffi_type,
};
