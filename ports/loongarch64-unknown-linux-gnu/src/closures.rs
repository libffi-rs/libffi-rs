...
#[inline]
unsafe fn atomic_load_relaxed(p: *const ::core::ffi::c_int) -> ::core::ffi::c_int {
    (&*(p as *const ::core::sync::atomic::AtomicI32)).load(::core::sync::atomic::Ordering::Relaxed)
}
#[inline]
unsafe fn atomic_load_acquire(p: *const ::core::ffi::c_int) -> ::core::ffi::c_int {
    (&*(p as *const ::core::sync::atomic::AtomicI32)).load(::core::sync::atomic::Ordering::Acquire)
}
#[inline]
unsafe fn atomic_xchg_acquire(
    p: *mut ::core::ffi::c_int,
    value: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    (&*(p as *const ::core::sync::atomic::AtomicI32))
        .swap(value, ::core::sync::atomic::Ordering::Acquire)
}
#[inline]
unsafe fn atomic_store_release(p: *mut ::core::ffi::c_int, value: ::core::ffi::c_int) {
    (&*(p as *const ::core::sync::atomic::AtomicI32))
        .store(value, ::core::sync::atomic::Ordering::Release);
}

#[inline]
unsafe fn atomic_load_acquire_usize(p: *const usize) -> usize {
    (&*(p as *const ::core::sync::atomic::AtomicUsize))
        .load(::core::sync::atomic::Ordering::Acquire)
}
#[inline]
unsafe fn atomic_store_release_usize(p: *mut usize, value: usize) {
    (&*(p as *const ::core::sync::atomic::AtomicUsize))
        .store(value, ::core::sync::atomic::Ordering::Release);
}
...
unsafe extern "C" fn dlmmap_locked(
    ...
    if execfd == -(1 as ::core::ffi::c_int) {
        open_temp_exec_file_opts_idx = 0 as ::core::ffi::c_int;
        current_block = 11465413684427322000;
    } else {
        current_block = 735147466149431745;
    }
    loop {
        match current_block {
            11465413684427322000 => {
