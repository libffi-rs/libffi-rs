...
unsafe extern "C" fn ffi_tramp_get_libffi() -> ::core::ffi::c_int {
    ...
    while feof(fp) == 0 as ::core::ffi::c_int {
        if fgets(
                ...
                ::core::mem::size_of::<[::core::ffi::c_char; 4196]>()
                    as ::core::ffi::c_int,
                fp,
            )
            .is_null()
        ...
        if !(addr as ::core::ffi::c_ulong >= start
            && (addr as ::core::ffi::c_ulong) < end)
        {
            continue;
        }
        tramp_globals.offset = offset
            .wrapping_add((addr as ::core::ffi::c_ulong).wrapping_sub(start)) as off_t;
...
unsafe extern "C" fn ffi_tramp_get_temp_file() -> ::core::ffi::c_int {
    ...
    if count >= 0 as ::core::ffi::c_int && count as size_t == tramp_globals.map_size
        && tramp_table_alloc() != 0
    {
        return 1 as ::core::ffi::c_int;
    }
...
unsafe extern "C" fn ffi_tramp_init() -> ::core::ffi::c_int {
    ...
    tramp_globals.text = ffi_tramp_arch(
        &raw mut tramp_globals.size,
        &raw mut tramp_globals.map_size,
    );
    tramp_globals.ntramp = tramp_globals.map_size.wrapping_div(tramp_globals.size)
        as ::core::ffi::c_int;
    page_size = sysconf(_SC_PAGESIZE as ::core::ffi::c_int);
    if page_size >= 0 as ::core::ffi::c_long
        && page_size as size_t > tramp_globals.map_size
    {
        return 0 as ::core::ffi::c_int;
    }
...
unsafe extern "C" fn tramp_table_alloc() -> ::core::ffi::c_int {
    ...
    let mut code: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<
        ::core::ffi::c_char,
    >();
    let mut parm: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<
        ::core::ffi::c_char,
    >();
    ...
    tramp_array = malloc(
        (::core::mem::size_of::<tramp>() as size_t)
            .wrapping_mul(tramp_globals.ntramp as size_t),
    ) as *mut tramp;
