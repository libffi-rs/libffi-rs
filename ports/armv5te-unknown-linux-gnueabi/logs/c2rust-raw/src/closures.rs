...
pub struct _IO_FILE {
    ...
    pub _unused2: [::core::ffi::c_char; 40],
}
...
pub const PAX_EMUTRAMP: C2RustUnnamed_4 = 2;
pub const PAX_MPROTECT: C2RustUnnamed_4 = 1;
...
pub struct __pthread_cleanup_frame {
    pub __cancel_routine: Option<unsafe extern "C" fn(*mut ::core::ffi::c_void) -> ()>,
...
pub const __O_DIRECTORY: ::core::ffi::c_int = 0o40000 as ::core::ffi::c_int;
...
#[inline]
unsafe extern "C" fn __pthread_cleanup_routine(
    mut __frame: *mut __pthread_cleanup_frame,
) {
    if (*__frame).__do_it != 0 {
        (*__frame)
            .__cancel_routine
            .expect("non-null function pointer")((*__frame).__cancel_arg);
    }
}
#[inline]
...
unsafe extern "C" fn selinux_enabled_check() -> ::core::ffi::c_int {
    ...
    if statfs(b"/selinux\0" as *const u8 as *const ::core::ffi::c_char, &raw mut sfs)
        >= 0 as ::core::ffi::c_int
    ...
    while getline(&raw mut buf, &raw mut len, f) >= 0 as ::core::ffi::c_int {
...
unsafe extern "C" fn pax_flags_check() -> ::core::ffi::c_int {
    ...
    while getline(&raw mut buf, &raw mut len, f) != -(1 as ::core::ffi::c_int) {
        if !(strncmp(
            buf,
...
pub const MALLOC_ALIGNMENT: size_t = (2 as usize)
...
pub const M_TRIM_THRESHOLD: ::core::ffi::c_int = -1;
pub const M_GRANULARITY: ::core::ffi::c_int = -2;
pub const M_MMAP_THRESHOLD: ::core::ffi::c_int = -3;
pub const SIZE_T_SIZE: usize = ::core::mem::size_of::<size_t>();
pub const SIZE_T_BITSIZE: usize = (::core::mem::size_of::<size_t>() as usize)
    << 3 as ::core::ffi::c_int;
...
pub const TWO_SIZE_T_SIZES: usize = SIZE_T_SIZE << 1 as ::core::ffi::c_int;
pub const FOUR_SIZE_T_SIZES: usize = SIZE_T_SIZE << 2 as ::core::ffi::c_int;
...
pub const MFAIL: *mut ::core::ffi::c_void = !(0 as ::core::ffi::c_int as size_t)
    as *mut ::core::ffi::c_void;
pub const CMFAIL: *mut ::core::ffi::c_char = !(0 as ::core::ffi::c_int as size_t)
...
unsafe extern "C" fn spin_acquire_lock(
    mut sl: *mut ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    let mut spins: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    while ::core::intrinsics::atomic_load_relaxed(sl) != 0 as ::core::ffi::c_int
        || ::core::intrinsics::atomic_xchg_acquire(sl, 1 as ::core::ffi::c_int) != 0
    {
        spins += 1;
...
pub const MCHUNK_SIZE: usize = ::core::mem::size_of::<mchunk>();
pub const CHUNK_OVERHEAD: usize = ::core::mem::size_of::<size_t>();
pub const MMAP_CHUNK_OVERHEAD: usize = SIZE_T_SIZE << 1 as ::core::ffi::c_int;
pub const MMAP_FOOT_PAD: usize = SIZE_T_SIZE << 2 as ::core::ffi::c_int;
pub const MIN_CHUNK_SIZE: usize = MCHUNK_SIZE.wrapping_add(CHUNK_ALIGN_MASK)
    & !CHUNK_ALIGN_MASK;
pub const MAX_REQUEST: usize = MIN_CHUNK_SIZE.wrapping_neg() << 2 as ::core::ffi::c_int;
pub const MIN_REQUEST: usize = MIN_CHUNK_SIZE
...
pub const FENCEPOST_HEAD: size_t = INUSE_BITS | SIZE_T_SIZE;
...
unsafe extern "C" fn has_segment_link(
    mut m: mstate,
    mut ss: msegmentptr,
) -> ::core::ffi::c_int {
    let mut sp: msegmentptr = &raw mut (*m).seg;
...
unsafe extern "C" fn init_mparams() -> ::core::ffi::c_int {
    if ::core::intrinsics::atomic_xchg_acquire(
    ...
    if mparams.magic == 0 as size_t {
        ...
        if ::core::mem::size_of::<size_t>() as usize
            ...
            || MALLOC_ALIGNMENT & MALLOC_ALIGNMENT.wrapping_sub(SIZE_T_ONE)
                != 0 as size_t
            || MCHUNK_SIZE & MCHUNK_SIZE.wrapping_sub(SIZE_T_ONE) != 0 as usize
        ...
        mparams.default_mflags = (USE_LOCK_BIT as size_t | USE_MMAP_BIT
            | USE_NONCONTIGUOUS_BIT as size_t) as flag_t;
        _gm_.mflags = mparams.default_mflags;
        _gm_.mutex = 0 as ::core::ffi::c_int;
        magic = (time(::core::ptr::null_mut::<time_t>()) as ::core::ffi::c_ulong
            ^ 0x55555555 as ::core::ffi::c_uint as size_t as ::core::ffi::c_ulong)
            as size_t;
        magic |= 8 as ::core::ffi::c_uint as size_t;
        magic &= !(7 as ::core::ffi::c_uint as size_t);
        ::core::intrinsics::atomic_store_release(&raw mut mparams.magic, magic);
    }
    ::core::intrinsics::atomic_store_release(&raw mut malloc_global_mutex, 0);
    return 1 as ::core::ffi::c_int;
}
unsafe extern "C" fn change_mparam(
    mut param_number: ::core::ffi::c_int,
    mut value: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    let mut val: size_t = 0;
    (::core::intrinsics::atomic_load_acquire(&raw mut mparams.magic) != 0 as size_t
        || init_mparams() != 0) as ::core::ffi::c_int;
    val = if value == -(1 as ::core::ffi::c_int) { MAX_SIZE_T } else { value as size_t };
    match param_number {
        M_TRIM_THRESHOLD => {
        ...
        M_GRANULARITY => {
            if val >= mparams.page_size
                && val & val.wrapping_sub(1 as size_t) == 0 as size_t
            {
...
unsafe extern "C" fn internal_malloc_stats(mut m: mstate) {
    (::core::intrinsics::atomic_load_acquire(&raw mut mparams.magic) != 0 as size_t
        || init_mparams() != 0) as ::core::ffi::c_int;
    ...
    {
        let mut maxfp: size_t = 0 as size_t;
        let mut fp: size_t = 0 as size_t;
        let mut used: size_t = 0 as size_t;
        if !(*m).top.is_null() {
            let mut s: msegmentptr = &raw mut (*m).seg;
            ...
            used = fp
                .wrapping_sub(
                    (*m)
                        .topsize
                        .wrapping_add(
                            (if ::core::ptr::null_mut::<::core::ffi::c_char>()
                                .offset(
                                    ((::core::mem::size_of::<size_t>() as usize)
                                        << 1 as ::core::ffi::c_int) as isize,
                                ) as *mut ::core::ffi::c_void as size_t & CHUNK_ALIGN_MASK
                                == 0 as size_t
                            {
                                0 as size_t
                            } else {
                                ...
                                .wrapping_add(
                                    (::core::mem::size_of::<malloc_segment>() as size_t)
                                        .wrapping_add(CHUNK_OVERHEAD)
                                        .wrapping_add(CHUNK_ALIGN_MASK) & !CHUNK_ALIGN_MASK,
                                )
                                .wrapping_add(MIN_CHUNK_SIZE),
                        ),
                );
            while !s.is_null() {
                let mut q: mchunkptr = (*s)
                    .base
                    .offset(
                        (if (*s)
                            .base
                ...
                while q as *mut ::core::ffi::c_char >= (*s).base
                    && (q as *mut ::core::ffi::c_char)
                        < (*s).base.offset((*s).size as isize) && q != (*m).top
                    && (*q).head != FENCEPOST_HEAD
                {
                    if !((*q).head & INUSE_BITS != PINUSE_BIT) {
                        used = used
                            .wrapping_sub(
                                (*q).head & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT),
                            );
                    }
                    q = (q as *mut ::core::ffi::c_char)
                        .offset(((*q).head & !FLAG_BITS) as isize) as mchunkptr;
                }
                s = (*s).next as msegmentptr;
            }
        }
        if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
            ::core::intrinsics::atomic_store_release(&raw mut (*m).mutex, 0);
        }
        fprintf(
            stderr,
            b"max system bytes = %10lu\n\0" as *const u8 as *const ::core::ffi::c_char,
            maxfp as ::core::ffi::c_ulong,
        );
        fprintf(
            stderr,
            b"system bytes     = %10lu\n\0" as *const u8 as *const ::core::ffi::c_char,
            fp as ::core::ffi::c_ulong,
        );
        fprintf(
            stderr,
            b"in use bytes     = %10lu\n\0" as *const u8 as *const ::core::ffi::c_char,
            used as ::core::ffi::c_ulong,
        );
    }
}
unsafe extern "C" fn mmap_alloc(
    mut m: mstate,
    mut nb: size_t,
) -> *mut ::core::ffi::c_void {
    ...
    if mmsize > nb {
        ...
        if mm != CMFAIL {
            let mut offset: size_t = if mm
                .offset(
                    ((::core::mem::size_of::<size_t>() as usize)
                        << 1 as ::core::ffi::c_int) as isize,
                ) as *mut ::core::ffi::c_void as size_t & CHUNK_ALIGN_MASK == 0 as size_t
            {
                0 as size_t
            } else {
                MALLOC_ALIGNMENT
            ...
            let mut psize: size_t = mmsize
                .wrapping_sub(offset)
                .wrapping_sub(MMAP_FOOT_PAD);
            ...
            (*((p as *mut ::core::ffi::c_char)
                .offset(
                    psize.wrapping_add(::core::mem::size_of::<size_t>() as size_t)
                        as isize,
                ) as mchunkptr))
                .head = 0 as size_t;
            ...
            return (p as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as isize)
                as *mut ::core::ffi::c_void;
        }
    }
    return ::core::ptr::null_mut::<::core::ffi::c_void>();
...
unsafe extern "C" fn mmap_resize(
        ...
        && oldsize.wrapping_sub(nb) <= mparams.granularity << 1 as ::core::ffi::c_int
    {
        ...
        if cp != CMFAIL {
            ...
            let mut psize: size_t = newmmsize
                .wrapping_sub(offset)
                .wrapping_sub(MMAP_FOOT_PAD);
            (*newp).head = psize;
            (*((newp as *mut ::core::ffi::c_char).offset(psize as isize) as mchunkptr))
                .head = FENCEPOST_HEAD;
...
unsafe extern "C" fn init_top(mut m: mstate, mut p: mchunkptr, mut psize: size_t) {
    ...
    (*((p as *mut ::core::ffi::c_char).offset(psize as isize) as mchunkptr)).head = (if ::core::ptr::null_mut::<
        ::core::ffi::c_char,
    >()
        .offset(
            ((::core::mem::size_of::<size_t>() as usize) << 1 as ::core::ffi::c_int)
...
unsafe extern "C" fn init_bins(mut m: mstate) {
    ...
    while i < NSMALLBINS {
        let mut bin: sbinptr = (&raw mut (*m).smallbins as *mut mchunkptr)
            .offset((i << 1 as ::core::ffi::c_int) as isize) as *mut mchunkptr
            as *mut ::core::ffi::c_char as sbinptr;
...
unsafe extern "C" fn prepend_alloc(
    ...
    let mut oldfirst: mchunkptr = oldbase
        .offset(
            (if oldbase
                .offset(
                    ((::core::mem::size_of::<size_t>() as usize)
    ...
    let mut psize: size_t = (oldfirst as *mut ::core::ffi::c_char)
        .offset_from(p as *mut ::core::ffi::c_char) as ::core::ffi::c_int as size_t;
    let mut q: mchunkptr = (p as *mut ::core::ffi::c_char).offset(nb as isize)
        as mchunkptr;
    ...
    if oldfirst == (*m).top {
        ...
        (*((q as *mut ::core::ffi::c_char).offset(dsize as isize) as mchunkptr))
            .prev_foot = dsize;
    } else {
        if !((*oldfirst).head & INUSE_BITS != PINUSE_BIT) {
            let mut nsize: size_t = (*oldfirst).head
            ...
            if nsize >> SMALLBIN_SHIFT < NSMALLBINS as size_t {
                ...
                if (F
                    ...
                    || F as *mut ::core::ffi::c_char >= (*m).least_addr
                        && (*F).bk == oldfirst) as ::core::ffi::c_int
                    as ::core::ffi::c_long != 0
                {
                    if B == F {
                        ...
                        == (&raw mut (*m).smallbins as *mut mchunkptr)
                            .offset((I << 1 as ::core::ffi::c_int) as isize)
                            as *mut mchunkptr as *mut ::core::ffi::c_char as sbinptr
                        || B as *mut ::core::ffi::c_char >= (*m).least_addr
                            && (*B).fd == oldfirst) as ::core::ffi::c_int
                        as ::core::ffi::c_long != 0
                    {
                ...
                if (*TP).bk != TP {
                    ...
                    if (F_0 as *mut ::core::ffi::c_char >= (*m).least_addr
                        && (*F_0).bk == TP && (*R).fd == TP) as ::core::ffi::c_int
                        as ::core::ffi::c_long != 0
                    {
                    ...
                    {
                        let mut CP: *mut tchunkptr = ::core::ptr::null_mut::<
                            tchunkptr,
                        >();
                        loop {
                ...
                if !XP.is_null() {
                    let mut H: *mut tbinptr = (&raw mut (*m).treebins as *mut tbinptr)
                        .offset((*TP).index as isize) as *mut tbinptr;
                    if TP == *H {
                        *H = R as tbinptr;
                        if (*H).is_null() {
                            (*m).treemap
                        ...
                        as ::core::ffi::c_int as ::core::ffi::c_long != 0
                    {
                        if (*XP).child[0 as ::core::ffi::c_int as usize] == TP {
                            (*XP).child[0 as ::core::ffi::c_int as usize] = R
                                as *mut malloc_tree_chunk;
                        } else {
                            (*XP).child[1 as ::core::ffi::c_int as usize] = R
                                as *mut malloc_tree_chunk;
                        }
                    } else {
                        abort();
                    ...
                    if !R.is_null() {
                        if (R as *mut ::core::ffi::c_char >= (*m).least_addr)
                            as ::core::ffi::c_int as ::core::ffi::c_long != 0
                        {
                            let mut C0: tchunkptr = ::core::ptr::null_mut::<
                                malloc_tree_chunk,
                            >();
                            let mut C1: tchunkptr = ::core::ptr::null_mut::<
                                malloc_tree_chunk,
                            >();
                            ...
                            if !C0.is_null() {
                                if (C0 as *mut ::core::ffi::c_char >= (*m).least_addr)
                                    as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                {
                                    (*R).child[0 as ::core::ffi::c_int as usize] = C0
                                        as *mut malloc_tree_chunk;
                            ...
                            if !C1.is_null() {
                                if (C1 as *mut ::core::ffi::c_char >= (*m).least_addr)
                                    as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                {
                                    (*R).child[1 as ::core::ffi::c_int as usize] = C1
                                        as *mut malloc_tree_chunk;
            ...
            oldfirst = (oldfirst as *mut ::core::ffi::c_char).offset(nsize as isize)
                as mchunkptr;
            qsize = qsize.wrapping_add(nsize);
        }
        (*oldfirst).head &= !PINUSE_BIT;
        (*q).head = qsize | PINUSE_BIT;
        (*((q as *mut ::core::ffi::c_char).offset(qsize as isize) as mchunkptr))
            .prev_foot = qsize;
        if qsize >> SMALLBIN_SHIFT < NSMALLBINS as size_t {
            ...
            let mut B_0: mchunkptr = (&raw mut (*m).smallbins as *mut mchunkptr)
                .offset((I_0 << 1 as ::core::ffi::c_int) as isize) as *mut mchunkptr
                as *mut ::core::ffi::c_char as mchunkptr;
            ...
            let mut X: ::core::ffi::c_uint = qsize as ::core::ffi::c_uint
                >> TREEBIN_SHIFT;
            if X == 0 as ::core::ffi::c_uint {
                ...
                I_1 = ((K as size_t) << 1 as ::core::ffi::c_int)
                    .wrapping_add(
                        qsize
                            >> K
                                .wrapping_add(
            ...
            H_0 = (&raw mut (*m).treebins as *mut tbinptr).offset(I_1 as isize)
                as *mut tbinptr;
            (*TP_0).index = I_1;
            (*TP_0).child[1 as ::core::ffi::c_int as usize] = ::core::ptr::null_mut::<
                malloc_tree_chunk,
            >();
            (*TP_0).child[0 as ::core::ffi::c_int as usize] = (*TP_0)
                .child[1 as ::core::ffi::c_int as usize];
                ...
                let mut K_0: size_t = qsize
                    << (if I_1 == NTREEBINS.wrapping_sub(1 as ::core::ffi::c_uint) {
                        ...
                        SIZE_T_BITSIZE
                            .wrapping_sub(SIZE_T_ONE)
                            .wrapping_sub(
                                (I_1 as usize >> 1 as ::core::ffi::c_int)
                                    .wrapping_add(TREEBIN_SHIFT as usize)
...
unsafe extern "C" fn add_segment(
    ...
    let mut old_end: *mut ::core::ffi::c_char = (*oldsp)
        .base
        .offset((*oldsp).size as isize);
    let mut ssize: size_t = (::core::mem::size_of::<malloc_segment>() as size_t)
        .wrapping_add(CHUNK_OVERHEAD)
        .wrapping_add(CHUNK_ALIGN_MASK) & !CHUNK_ALIGN_MASK;
    let mut rawsp: *mut ::core::ffi::c_char = old_end
        .offset(
            -(ssize.wrapping_add(FOUR_SIZE_T_SIZES).wrapping_add(CHUNK_ALIGN_MASK)
                as isize),
        );
    ...
    let mut csp: *mut ::core::ffi::c_char = if asp
        < old_top.offset(MIN_CHUNK_SIZE as isize)
    {
        old_top
    } else {
        asp
    ...
    let mut ss: msegmentptr = (sp as *mut ::core::ffi::c_char)
        .offset(TWO_SIZE_T_SIZES as isize) as *mut ::core::ffi::c_void as msegmentptr;
    let mut tnext: mchunkptr = (sp as *mut ::core::ffi::c_char).offset(ssize as isize)
        as mchunkptr;
    ...
    *ss = (*m).seg as malloc_segment;
    ...
    if mmapped as size_t != USE_MMAP_BIT {
        ...
        if *((*m)
            ...
            .offset((*m).seg.size as isize)
            .offset(-(::core::mem::size_of::<ptrdiff_t>() as usize as isize))
            as *mut ptrdiff_t) != (*m).seg.exec_offset
        {
            abort();
        } else {
            *((*m)
                ...
                .offset((*m).seg.size as isize)
                .offset(-(::core::mem::size_of::<ptrdiff_t>() as usize as isize))
                as *mut ptrdiff_t) = 0 as ::core::ffi::c_int as ptrdiff_t;
        };
    };
    (*m).seg.next = ss as *mut malloc_segment;
    loop {
        let mut nextp: mchunkptr = (p as *mut ::core::ffi::c_char)
            .offset(::core::mem::size_of::<size_t>() as usize as isize) as mchunkptr;
    ...
    if csp != old_top {
        ...
        let mut psize: size_t = csp.offset_from(old_top) as ::core::ffi::c_int as size_t;
        let mut tn: mchunkptr = (q as *mut ::core::ffi::c_char).offset(psize as isize)
            as mchunkptr;
        (*tn).head &= !PINUSE_BIT;
        (*q).head = psize | PINUSE_BIT;
        (*((q as *mut ::core::ffi::c_char).offset(psize as isize) as mchunkptr))
            .prev_foot = psize;
        if psize >> SMALLBIN_SHIFT < NSMALLBINS as size_t {
            ...
            let mut X: ::core::ffi::c_uint = psize as ::core::ffi::c_uint
                >> TREEBIN_SHIFT;
            if X == 0 as ::core::ffi::c_uint {
                I_0 = 0 as bindex_t;
            } else if X > 0xffff as ::core::ffi::c_uint {
                ...
                >() as ::core::ffi::c_uint)
                    ...
                    .wrapping_sub(1 as ::core::ffi::c_uint)
                    .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
                I_0 = ((K as size_t) << 1 as ::core::ffi::c_int)
                    .wrapping_add(
                        psize
                            >> K
                                .wrapping_add(
            ...
            H = (&raw mut (*m).treebins as *mut tbinptr).offset(I_0 as isize)
                as *mut tbinptr;
            (*TP).index = I_0;
            (*TP).child[1 as ::core::ffi::c_int as usize] = ::core::ptr::null_mut::<
                malloc_tree_chunk,
            >();
            (*TP).child[0 as ::core::ffi::c_int as usize] = (*TP)
                .child[1 as ::core::ffi::c_int as usize];
                ...
                let mut K_0: size_t = psize
                    << (if I_0 == NTREEBINS.wrapping_sub(1 as ::core::ffi::c_uint) {
                        ...
                        SIZE_T_BITSIZE
                            .wrapping_sub(SIZE_T_ONE)
                            .wrapping_sub(
                                (I_0 as usize >> 1 as ::core::ffi::c_int)
                                    .wrapping_add(TREEBIN_SHIFT as usize)
                                    .wrapping_sub(2 as usize),
                            )
                    });
...
unsafe extern "C" fn sys_alloc(
    ...
    (::core::intrinsics::atomic_load_acquire(&raw mut mparams.magic) != 0 as size_t
        || init_mparams() != 0) as ::core::ffi::c_int;
    if (*m).mflags as size_t & USE_MMAP_BIT != 0 && nb >= mparams.mmap_threshold
        ...
        .wrapping_add(
            (if ::core::ptr::null_mut::<::core::ffi::c_char>()
                ...
                & (2 as usize)
                    ...
                    .wrapping_sub(1 as ::core::ffi::c_int as size_t) == 0 as size_t
            {
                0 as size_t
            } else {
                (2 as usize)
                ...
                .wrapping_add(
                    (::core::mem::size_of::<mchunk>() as size_t)
                        .wrapping_add(
                            (2 as usize)
                                .wrapping_mul(
                                    ::core::mem::size_of::<*mut ::core::ffi::c_void>() as usize,
    ...
    if MORECORE_CONTIGUOUS != 0
        && (*m).mflags as ::core::ffi::c_uint & USE_NONCONTIGUOUS_BIT == 0
    {
        ...
        if ss.is_null() {
            ...
            if base != CMFAIL {
                ...
                if !(base as size_t & mparams.page_size.wrapping_sub(SIZE_T_ONE)
                    == 0 as size_t)
                {
                    ssize = ssize
                        .wrapping_add(
                ...
                if ssize > nb && ssize < HALF_MAX_SIZE_T
                    ...
                    && {
                        br = !(0 as ::core::ffi::c_int as size_t)
                            as *mut ::core::ffi::c_void as *mut ::core::ffi::c_char;
                        br == base
                    }
                {
            ...
            if br != CMFAIL {
                            ...
                            )
                {
                    ...
                    if esize < HALF_MAX_SIZE_T {
                        let mut end: *mut ::core::ffi::c_char = !(0 as ::core::ffi::c_int
                            as size_t) as *mut ::core::ffi::c_void
                            as *mut ::core::ffi::c_char;
                        if end != CMFAIL {
    ...
    if HAVE_MORECORE != 0 && tbase == CMFAIL {
        if asize < HALF_MAX_SIZE_T {
            ...
            if br_0 != CMFAIL && end_0 != CMFAIL && br_0 < end_0 {
                let mut ssize_0: size_t = end_0.offset_from(br_0) as ::core::ffi::c_int
                    as size_t;
                if ssize_0
                    > nb
                        .wrapping_add(
    ...
    if tbase != CMFAIL {
        ...
        if (*m).top.is_null() {
            ...
            if m == &raw mut _gm_ {
                ...
                let mut mn: mchunkptr = ((m as *mut ::core::ffi::c_char)
                    .offset(
                        -(((::core::mem::size_of::<size_t>() as usize)
                            << 1 as ::core::ffi::c_int) as isize),
                    ) as mchunkptr as *mut ::core::ffi::c_char)
                    .offset(
                        ((*((m as *mut ::core::ffi::c_char)
                            .offset(
                                -(((::core::mem::size_of::<size_t>() as usize)
                                    << 1 as ::core::ffi::c_int) as isize),
                            ) as mchunkptr))
                            .head & !FLAG_BITS) as isize,
                    ) as mchunkptr;
                init_top(
                    m,
                    mn,
            ...
            if !sp.is_null()
                ...
                && *(tbase
                    .offset(tsize as isize)
                    .offset(-(::core::mem::size_of::<ptrdiff_t>() as usize as isize))
                    as *mut ptrdiff_t) == (*sp).exec_offset
                && 1 as ::core::ffi::c_int as size_t & USE_MMAP_BIT
                    == mmap_flag as size_t
                    ...
                    >= base
                        ...
                        .offset(
                                ...
                                == 0 as size_t
                            {
                                ...
                                .wrapping_add(MIN_CHUNK_SIZE) as isize),
                        )
            {
                ...
                if p == (*m).dv {
                    ...
                    if (*tp).bk != tp {
                        ...
                        if (F as *mut ::core::ffi::c_char >= (*m).least_addr
                            && (*F).bk == tp && (*R).fd == tp) as ::core::ffi::c_int
                            as ::core::ffi::c_long != 0
                        {
                        ...
                        let mut RP: *mut tchunkptr = ::core::ptr::null_mut::<
                            tchunkptr,
                        >();
                        RP = (&raw mut (*tp).child as *mut *mut malloc_tree_chunk)
                            .offset(1 as ::core::ffi::c_int as isize)
                    ...
                    if !XP.is_null() {
                        let mut H: *mut tbinptr = (&raw mut (*m).treebins
                            as *mut tbinptr)
                            .offset((*tp).index as isize) as *mut tbinptr;
                        if tp == *H {
                            *H = R as tbinptr;
                ...
                if dlmunmap(base as *mut ::core::ffi::c_void, size)
                    == 0 as ::core::ffi::c_int
                {
                    ...
                    if X == 0 as ::core::ffi::c_uint {
                        ...
                        I = ((K as size_t) << 1 as ::core::ffi::c_int)
                            .wrapping_add(
                                psize
                                    >> K
                                        .wrapping_add(
                    ...
                    H_0 = (&raw mut (*m).treebins as *mut tbinptr).offset(I as isize)
                        as *mut tbinptr;
                    (*tp).index = I;
                    (*tp).child[1 as ::core::ffi::c_int as usize] = ::core::ptr::null_mut::<
                        malloc_tree_chunk,
                        ...
                        let mut K_0: size_t = psize
                            << (if I == NTREEBINS.wrapping_sub(1 as ::core::ffi::c_uint)
                            {
                                ...
                                SIZE_T_BITSIZE
                                    .wrapping_sub(SIZE_T_ONE)
                                    .wrapping_sub(
                                        (I as usize >> 1 as ::core::ffi::c_int)
                                            .wrapping_add(TREEBIN_SHIFT as usize)
                                            .wrapping_sub(2 as usize),
                                    )
                            });
                        loop {
                            if (*T).head & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT)
                                != psize
                            {
                                let mut C: *mut tchunkptr = (&raw mut (*T).child
                                    as *mut *mut malloc_tree_chunk)
...
unsafe extern "C" fn sys_trim(mut m: mstate, mut pad: size_t) -> ::core::ffi::c_int {
    ...
    (::core::intrinsics::atomic_load_acquire(&raw mut mparams.magic) != 0 as size_t
        || init_mparams() != 0) as ::core::ffi::c_int;
    if pad < MAX_REQUEST && !(*m).top.is_null() {
        pad = (pad as ::core::ffi::c_uint)
            .wrapping_add(
                (if ::core::ptr::null_mut::<::core::ffi::c_char>()
                    .offset(
                        ((::core::mem::size_of::<size_t>() as usize)
                    ...
                    == 0 as size_t
                {
                    ...
                    .wrapping_add(MIN_CHUNK_SIZE) as ::core::ffi::c_uint,
            ) as size_t as size_t;
        if (*m).topsize > pad {
            ...
            let mut extra: size_t = (*m)
                ...
                .wrapping_sub(SIZE_T_ONE)
                .wrapping_mul(unit);
            let mut sp: msegmentptr = segment_holding(
                m,
                (*m).top as *mut ::core::ffi::c_char,
            );
            if sp.is_null() {
            ...
            if 1 as ::core::ffi::c_int as size_t & EXTERN_BIT as size_t == 0 {
                if 1 as ::core::ffi::c_int as size_t & USE_MMAP_BIT != 0 {
                    if HAVE_MMAP != 0 && (*sp).size >= extra
                        && has_segment_link(m, sp) == 0
                    {
                        let mut newsize: size_t = (*sp).size.wrapping_sub(extra);
                        if !(0 as ::core::ffi::c_int as size_t)
                            as *mut ::core::ffi::c_void != MFAIL
                            || dlmunmap(
                                (*sp).base.offset(newsize as isize)
                                    as *mut ::core::ffi::c_void,
                                extra,
                            ) == 0 as ::core::ffi::c_int
                        {
...
unsafe extern "C" fn dispose_chunk(mut m: mstate, mut p: mchunkptr, mut psize: size_t) {
    let mut next: mchunkptr = (p as *mut ::core::ffi::c_char).offset(psize as isize)
        as mchunkptr;
    if (*p).head & PINUSE_BIT == 0 {
        ...
        if (*p).head & INUSE_BITS == 0 as size_t {
            psize = (psize as ::core::ffi::c_uint)
                .wrapping_add(
                    prevsize.wrapping_add(MMAP_FOOT_PAD) as ::core::ffi::c_uint,
                ) as size_t as size_t;
            if dlmunmap(
                ...
                if prevsize >> SMALLBIN_SHIFT < NSMALLBINS as size_t {
                    ...
                    if (F
                        == (&raw mut (*m).smallbins as *mut mchunkptr)
                            ...
                            as *mut mchunkptr as *mut ::core::ffi::c_char as sbinptr
                        || F as *mut ::core::ffi::c_char >= (*m).least_addr
                            && (*F).bk == p) as ::core::ffi::c_int as ::core::ffi::c_long
                        != 0
                    {
                        if B == F {
                            (*m).smallmap
        ...
        as ::core::ffi::c_long != 0
    {
                ...
                if nsize >> SMALLBIN_SHIFT < NSMALLBINS as size_t {
                    ...
                    if (F_1
                        ...
                        || F_1 as *mut ::core::ffi::c_char >= (*m).least_addr
                            && (*F_1).bk == next) as ::core::ffi::c_int
                        as ::core::ffi::c_long != 0
                    {
                        if B_0 == F_1 {
                            (*m).smallmap
                                &= !((1 as ::core::ffi::c_int as binmap_t) << I_0);
                        } else if (B_0
                            == (&raw mut (*m).smallbins as *mut mchunkptr)
                                .offset((I_0 << 1 as ::core::ffi::c_int) as isize)
                                as *mut mchunkptr as *mut ::core::ffi::c_char as sbinptr
                            || B_0 as *mut ::core::ffi::c_char >= (*m).least_addr
                                && (*B_0).fd == next) as ::core::ffi::c_int
                            as ::core::ffi::c_long != 0
                        {
                    ...
                    let mut R_0: tchunkptr = ::core::ptr::null_mut::<
                        malloc_tree_chunk,
                    >();
                    if (*TP_0).bk != TP_0 {
                        ...
                        let mut RP_0: *mut tchunkptr = ::core::ptr::null_mut::<
                            tchunkptr,
                        >();
                        ...
                        {
                            let mut CP_0: *mut tchunkptr = ::core::ptr::null_mut::<
                                tchunkptr,
                            >();
                            loop {
                    ...
                    if !XP_0.is_null() {
                        let mut H_0: *mut tbinptr = (&raw mut (*m).treebins
                            as *mut tbinptr)
                            .offset((*TP_0).index as isize) as *mut tbinptr;
                        if TP_0 == *H_0 {
                            *H_0 = R_0 as tbinptr;
                            if (*H_0).is_null() {
                                (*m).treemap
                            ...
                            as ::core::ffi::c_int as ::core::ffi::c_long != 0
                        {
                            if (*XP_0).child[0 as ::core::ffi::c_int as usize] == TP_0 {
                                (*XP_0).child[0 as ::core::ffi::c_int as usize] = R_0
                                    as *mut malloc_tree_chunk;
                            } else {
                                (*XP_0).child[1 as ::core::ffi::c_int as usize] = R_0
                                    as *mut malloc_tree_chunk;
                            }
                        } else {
                            abort();
                        ...
                        if !R_0.is_null() {
                            if (R_0 as *mut ::core::ffi::c_char >= (*m).least_addr)
                                as ::core::ffi::c_int as ::core::ffi::c_long != 0
                            {
                                let mut C0_0: tchunkptr = ::core::ptr::null_mut::<
                                    malloc_tree_chunk,
                                >();
                                let mut C1_0: tchunkptr = ::core::ptr::null_mut::<
                                    malloc_tree_chunk,
                                >();
                                (*R_0).parent = XP_0 as *mut malloc_tree_chunk;
                                C0_0 = (*TP_0).child[0 as ::core::ffi::c_int as usize]
                                    as tchunkptr;
                                if !C0_0.is_null() {
                                    if (C0_0 as *mut ::core::ffi::c_char >= (*m).least_addr)
                                        as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                    {
                                        (*R_0).child[0 as ::core::ffi::c_int as usize] = C0_0
                                            as *mut malloc_tree_chunk;
                                ...
                                C1_0 = (*TP_0).child[1 as ::core::ffi::c_int as usize]
                                    as tchunkptr;
                                if !C1_0.is_null() {
                                    if (C1_0 as *mut ::core::ffi::c_char >= (*m).least_addr)
                                        as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                    {
                                        (*R_0).child[1 as ::core::ffi::c_int as usize] = C1_0
                                            as *mut malloc_tree_chunk;
        ...
        if psize >> SMALLBIN_SHIFT < NSMALLBINS as size_t {
            ...
            let mut B_1: mchunkptr = (&raw mut (*m).smallbins as *mut mchunkptr)
                .offset((I_1 << 1 as ::core::ffi::c_int) as isize) as *mut mchunkptr
                as *mut ::core::ffi::c_char as mchunkptr;
            ...
            if X == 0 as ::core::ffi::c_uint {
                ...
                >() as ::core::ffi::c_uint)
                    ...
                    .wrapping_sub(1 as ::core::ffi::c_uint)
                    .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
                I_2 = ((K as size_t) << 1 as ::core::ffi::c_int)
                    .wrapping_add(
                        psize
                            >> K
                                .wrapping_add(
            ...
            H_1 = (&raw mut (*m).treebins as *mut tbinptr).offset(I_2 as isize)
                as *mut tbinptr;
            (*TP_1).index = I_2;
            (*TP_1).child[1 as ::core::ffi::c_int as usize] = ::core::ptr::null_mut::<
                malloc_tree_chunk,
            >();
            (*TP_1).child[0 as ::core::ffi::c_int as usize] = (*TP_1)
                .child[1 as ::core::ffi::c_int as usize];
                ...
                let mut K_0: size_t = psize
                    << (if I_2 == NTREEBINS.wrapping_sub(1 as ::core::ffi::c_uint) {
                        ...
                        SIZE_T_BITSIZE
                            .wrapping_sub(SIZE_T_ONE)
                            .wrapping_sub(
                                (I_2 as usize >> 1 as ::core::ffi::c_int)
                                    .wrapping_add(TREEBIN_SHIFT as usize)
                                    .wrapping_sub(2 as usize),
                            )
                    });
...
unsafe extern "C" fn tmalloc_large(
    mut m: mstate,
    mut nb: size_t,
) -> *mut ::core::ffi::c_void {
    ...
    let mut X: ::core::ffi::c_uint = nb as ::core::ffi::c_uint >> TREEBIN_SHIFT;
    if X == 0 as ::core::ffi::c_uint {
        idx = 0 as bindex_t;
    } else if X > 0xffff as ::core::ffi::c_uint {
        ...
        let mut K: ::core::ffi::c_uint = (::core::mem::size_of::<::core::ffi::c_uint>()
            ...
            .wrapping_sub(1 as ::core::ffi::c_uint)
            .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
        idx = ((K as size_t) << 1 as ::core::ffi::c_int)
            .wrapping_add(
                nb
                    >> K
                        .wrapping_add(
    ...
    if !t.is_null() {
        let mut sizebits: size_t = nb
            << (if idx == NTREEBINS.wrapping_sub(1 as ::core::ffi::c_uint) {
                ...
                SIZE_T_BITSIZE
                    .wrapping_sub(SIZE_T_ONE)
                    .wrapping_sub(
                        (idx as usize >> 1 as ::core::ffi::c_int)
                            .wrapping_add(TREEBIN_SHIFT as usize)
                            .wrapping_sub(2 as usize),
                    )
            });
        ...
        loop {
            ...
            let mut trem: size_t = ((*t).head & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT))
                .wrapping_sub(nb);
            if trem < rsize {
                v = t;
                rsize = trem;
            ...
            t = (*t)
                .child[(sizebits >> SIZE_T_BITSIZE.wrapping_sub(SIZE_T_ONE)
                & 1 as size_t) as usize] as tchunkptr;
            if !rt.is_null() && rt != t {
                rst = rt;
            }
            if t.is_null() {
    ...
    if t.is_null() && v.is_null() {
        let mut leftbits: binmap_t = ((1 as ::core::ffi::c_int as binmap_t) << idx
            << 1 as ::core::ffi::c_int
            | ((1 as ::core::ffi::c_int as binmap_t) << idx << 1 as ::core::ffi::c_int)
                .wrapping_neg()) & (*m).treemap;
    ...
    while !t.is_null() {
        let mut trem_0: size_t = ((*t).head & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT))
            .wrapping_sub(nb);
        if trem_0 < rsize {
            rsize = trem_0;
            v = t;
    ...
    if !v.is_null() && rsize < (*m).dvsize.wrapping_sub(nb) {
        if (v as *mut ::core::ffi::c_char >= (*m).least_addr) as ::core::ffi::c_int
            as ::core::ffi::c_long != 0
        {
            let mut r: mchunkptr = (v as *mut ::core::ffi::c_char).offset(nb as isize)
                as mchunkptr;
                ...
                as ::core::ffi::c_int as ::core::ffi::c_long != 0
            {
                ...
                if (*v).bk != v {
                    ...
                    R = (*v).bk as tchunkptr;
                    if (F as *mut ::core::ffi::c_char >= (*m).least_addr && (*F).bk == v
                ...
                if !XP.is_null() {
                    let mut H: *mut tbinptr = (&raw mut (*m).treebins as *mut tbinptr)
                        .offset((*v).index as isize) as *mut tbinptr;
                    if v == *H {
                        *H = R as tbinptr;
                        if (*H).is_null() {
                            (*m).treemap
                                &= !((1 as ::core::ffi::c_int as binmap_t) << (*v).index);
                        }
                    } else if (XP as *mut ::core::ffi::c_char >= (*m).least_addr)
                        as ::core::ffi::c_int as ::core::ffi::c_long != 0
                    {
                    ...
                    if !R.is_null() {
                            ...
                            as ::core::ffi::c_int as ::core::ffi::c_long != 0
                        {
                            ...
                            >();
                            (*R).parent = XP as *mut malloc_tree_chunk;
                            C0 = (*v).child[0 as ::core::ffi::c_int as usize]
                                as tchunkptr;
                            if !C0.is_null() {
                                if (C0 as *mut ::core::ffi::c_char >= (*m).least_addr)
                                    as ::core::ffi::c_int as ::core::ffi::c_long != 0
                            ...
                            C1 = (*v).child[1 as ::core::ffi::c_int as usize]
                                as tchunkptr;
                            if !C1.is_null() {
                                if (C1 as *mut ::core::ffi::c_char >= (*m).least_addr)
                                    as ::core::ffi::c_int as ::core::ffi::c_long != 0
                ...
                if rsize < MIN_CHUNK_SIZE {
                    ...
                    (*((v as *mut ::core::ffi::c_char)
                        .offset(rsize.wrapping_add(nb) as isize) as mchunkptr))
                        .head |= PINUSE_BIT;
                } else {
                    (*v).head = nb | PINUSE_BIT | CINUSE_BIT;
                    (*r).head = rsize | PINUSE_BIT;
                    (*((r as *mut ::core::ffi::c_char).offset(rsize as isize)
                        as mchunkptr))
                        .prev_foot = rsize;
                    if rsize >> SMALLBIN_SHIFT < NSMALLBINS as size_t {
                        let mut I: bindex_t = (rsize >> SMALLBIN_SHIFT) as bindex_t;
                        let mut B: mchunkptr = (&raw mut (*m).smallbins
                            as *mut mchunkptr)
                            .offset((I << 1 as ::core::ffi::c_int) as isize)
                            as *mut mchunkptr as *mut ::core::ffi::c_char as mchunkptr;
                        let mut F_0: mchunkptr = B;
                        if (*m).smallmap & (1 as ::core::ffi::c_int as binmap_t) << I
                            == 0
                        {
                            (*m).smallmap |= (1 as ::core::ffi::c_int as binmap_t) << I;
                        } else if ((*B).fd as *mut ::core::ffi::c_char
                            >= (*m).least_addr) as ::core::ffi::c_int
                            as ::core::ffi::c_long != 0
                        {
                        ...
                        let mut H_0: *mut tbinptr = ::core::ptr::null_mut::<tbinptr>();
                        let mut I_0: bindex_t = 0;
                        let mut X_0: ::core::ffi::c_uint = rsize as ::core::ffi::c_uint
                            >> TREEBIN_SHIFT;
                        if X_0 == 0 as ::core::ffi::c_uint {
                            I_0 = 0 as bindex_t;
                        } else if X_0 > 0xffff as ::core::ffi::c_uint {
                            I_0 = NTREEBINS.wrapping_sub(1 as ::core::ffi::c_uint)
                                as bindex_t;
                        } else {
                            ...
                            >() as ::core::ffi::c_uint)
                                ...
                                .wrapping_sub(1 as ::core::ffi::c_uint)
                                .wrapping_sub(
                                    X_0.leading_zeros() as i32 as ::core::ffi::c_uint,
                                );
                            I_0 = ((K_0 as size_t) << 1 as ::core::ffi::c_int)
                                .wrapping_add(
                                    rsize
                                        >> K_0
                                            .wrapping_add(
                        ...
                        H_0 = (&raw mut (*m).treebins as *mut tbinptr)
                            .offset(I_0 as isize) as *mut tbinptr;
                        (*TP).index = I_0;
                        (*TP).child[1 as ::core::ffi::c_int as usize] = ::core::ptr::null_mut::<
                            malloc_tree_chunk,
                        >();
                        (*TP).child[0 as ::core::ffi::c_int as usize] = (*TP)
                            .child[1 as ::core::ffi::c_int as usize];
                        if (*m).treemap & (1 as ::core::ffi::c_int as binmap_t) << I_0
                            == 0
                        {
                            (*m).treemap |= (1 as ::core::ffi::c_int as binmap_t) << I_0;
                            *H_0 = TP as tbinptr;
                            ...
                            let mut K_1: size_t = rsize
                                << (if I_0
                                    == NTREEBINS.wrapping_sub(1 as ::core::ffi::c_uint)
                                {
                                    0 as usize
                                } else {
                                    SIZE_T_BITSIZE
                ...
                return (v as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as isize)
                    as *mut ::core::ffi::c_void;
            }
        }
        abort();
...
unsafe extern "C" fn tmalloc_small(
    mut m: mstate,
    mut nb: size_t,
) -> *mut ::core::ffi::c_void {
    let mut t: tchunkptr = ::core::ptr::null_mut::<malloc_tree_chunk>();
        ...
        as ::core::ffi::c_long != 0
    {
            ...
            as ::core::ffi::c_int as ::core::ffi::c_long != 0
        {
            ...
            if (*v).bk != v {
                ...
                R = (*v).bk as tchunkptr;
                if (F as *mut ::core::ffi::c_char >= (*m).least_addr && (*F).bk == v
                    && (*R).fd == v) as ::core::ffi::c_int as ::core::ffi::c_long != 0
                {
                    (*F).bk = R as *mut malloc_tree_chunk;
                    (*R).fd = F as *mut malloc_tree_chunk;
                } else {
...
unsafe extern "C" fn dlmalloc(mut bytes: size_t) -> *mut ::core::ffi::c_void {
    ...
    {
        let mut mem: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<
            ::core::ffi::c_void,
        >();
        let mut nb: size_t = 0;
        if bytes <= MAX_SMALL_REQUEST {
                ...
                != 0 as ::core::ffi::c_uint
            {
                ...
                b = (&raw mut _gm_.smallbins as *mut mchunkptr)
                    .offset((idx << 1 as ::core::ffi::c_int) as isize) as *mut mchunkptr
                    as *mut ::core::ffi::c_char as sbinptr as mchunkptr;
                p = (*b).fd as mchunkptr;
                let mut F: mchunkptr = (*p).fd as mchunkptr;
                if b == F {
                    _gm_.smallmap &= !((1 as ::core::ffi::c_int as binmap_t) << idx);
                } else if (F as *mut ::core::ffi::c_char >= _gm_.least_addr
                    && (*F).bk == p) as ::core::ffi::c_int as ::core::ffi::c_long != 0
                {
                    (*F).bk = b as *mut malloc_chunk;
                    (*b).fd = F as *mut malloc_chunk;
                } else {
                ...
                (*p).head = (idx as size_t) << 3 as ::core::ffi::c_uint | PINUSE_BIT
                    | CINUSE_BIT;
                (*((p as *mut ::core::ffi::c_char)
                    .offset((idx << 3 as ::core::ffi::c_uint) as isize) as mchunkptr))
                    .head |= PINUSE_BIT;
                mem = (p as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as isize)
                    as *mut ::core::ffi::c_void;
                current_block = 7427894829642772479;
                ...
                if smallbits != 0 as binmap_t {
                    ...
                    let mut leftbits: binmap_t = smallbits << idx
                        & ((1 as ::core::ffi::c_int as binmap_t) << idx
                            << 1 as ::core::ffi::c_int
                            | ((1 as ::core::ffi::c_int as binmap_t) << idx
                                << 1 as ::core::ffi::c_int)
                                .wrapping_neg());
                    ...
                    if b_0 == F_0 {
                        ...
                        && (*F_0).bk == p_0) as ::core::ffi::c_int as ::core::ffi::c_long
                        != 0
                    {
                    ...
                    rsize = ((i as size_t) << SMALLBIN_SHIFT).wrapping_sub(nb);
                    if SIZE_T_SIZE != 4 as usize && rsize < MIN_CHUNK_SIZE {
                        (*p_0).head = (i as size_t) << 3 as ::core::ffi::c_uint
                            | PINUSE_BIT | CINUSE_BIT;
                        ...
                        r = (p_0 as *mut ::core::ffi::c_char).offset(nb as isize)
                            as mchunkptr;
                        (*r).head = rsize | PINUSE_BIT;
                        (*((r as *mut ::core::ffi::c_char).offset(rsize as isize)
                            as mchunkptr))
                        ...
                        if DVS != 0 as size_t {
                            ...
                            let mut I: bindex_t = (DVS >> SMALLBIN_SHIFT) as bindex_t;
                            let mut B: mchunkptr = (&raw mut _gm_.smallbins
                                as *mut mchunkptr)
                                .offset((I << 1 as ::core::ffi::c_int) as isize)
                                as *mut mchunkptr as *mut ::core::ffi::c_char as mchunkptr;
                            let mut F_1: mchunkptr = B;
                            if _gm_.smallmap & (1 as ::core::ffi::c_int as binmap_t) << I
                                == 0
                            {
                                _gm_.smallmap |= (1 as ::core::ffi::c_int as binmap_t) << I;
                            } else if ((*B).fd as *mut ::core::ffi::c_char
                                >= _gm_.least_addr) as ::core::ffi::c_int
                                as ::core::ffi::c_long != 0
                            {
                    ...
                    mem = (p_0 as *mut ::core::ffi::c_char)
                        .offset(TWO_SIZE_T_SIZES as isize) as *mut ::core::ffi::c_void;
                    current_block = 7427894829642772479;
            ...
            nb = bytes.wrapping_add(CHUNK_OVERHEAD).wrapping_add(CHUNK_ALIGN_MASK)
                & !CHUNK_ALIGN_MASK;
        ...
        match current_block {
            7419121793134201633 => {
                if nb <= _gm_.dvsize {
                    ...
                    if rsize_0 >= MIN_CHUNK_SIZE {
                        _gm_.dv = (p_1 as *mut ::core::ffi::c_char).offset(nb as isize)
                            as mchunkptr;
                        ...
                        (*((p_1 as *mut ::core::ffi::c_char).offset(dvs as isize)
                            as mchunkptr))
                            .head |= PINUSE_BIT;
                    }
                    ...
                    _gm_.top = (p_2 as *mut ::core::ffi::c_char).offset(nb as isize)
                        as mchunkptr;
        ...
        if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
            ::core::intrinsics::atomic_store_release(&raw mut _gm_.mutex, 0);
        }
        return mem;
    } else {
        return ::core::ptr::null_mut::<::core::ffi::c_void>()
...
unsafe extern "C" fn dlfree(mut mem: *mut ::core::ffi::c_void) {
    ...
    if !mem.is_null() {
        let mut p: mchunkptr = (mem as *mut ::core::ffi::c_char)
            .offset(-(TWO_SIZE_T_SIZES as isize)) as mchunkptr;
        if if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
            if ::core::intrinsics::atomic_xchg_acquire(
                &raw mut _gm_.mutex,
                1 as ::core::ffi::c_int,
        ...
        } == 0
        {
            if (p as *mut ::core::ffi::c_char >= _gm_.least_addr
                ...
                as ::core::ffi::c_long != 0
            {
                let mut psize: size_t = (*p).head
                    & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT);
                let mut next: mchunkptr = (p as *mut ::core::ffi::c_char)
                    .offset(psize as isize) as mchunkptr;
                if (*p).head & PINUSE_BIT == 0 {
                    let mut prevsize: size_t = (*p).prev_foot;
                    if (*p).head & INUSE_BITS == 0 as size_t {
                        psize = (psize as ::core::ffi::c_uint)
                        ...
                        current_block = 853568773389343594;
                    } else {
                        let mut prev: mchunkptr = (p as *mut ::core::ffi::c_char)
                            .offset(-(prevsize as isize)) as mchunkptr;
                        psize = psize.wrapping_add(prevsize);
                        p = prev;
                            ...
                            as ::core::ffi::c_int as ::core::ffi::c_long != 0
                        {
                            if p != _gm_.dv {
                                if prevsize >> SMALLBIN_SHIFT < NSMALLBINS as size_t {
                                    let mut F: mchunkptr = (*p).fd as mchunkptr;
                                    let mut B: mchunkptr = (*p).bk as mchunkptr;
                                    let mut I: bindex_t = (prevsize >> SMALLBIN_SHIFT)
                                        as bindex_t;
                                    if (F
                                    ...
                                    let mut TP: tchunkptr = p as tchunkptr;
                                    let mut XP: tchunkptr = (*TP).parent as tchunkptr;
                                    let mut R: tchunkptr = ::core::ptr::null_mut::<
                                        malloc_tree_chunk,
                                    >();
                                    if (*TP).bk != TP {
                                        let mut F_0: tchunkptr = (*TP).fd as tchunkptr;
                                        ...
                                        if !R.is_null() {
                                                ...
                                                as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                            {
                                                ...
                                                C0 = (*TP).child[0 as ::core::ffi::c_int as usize]
                                                    as tchunkptr;
                                                if !C0.is_null() {
                                                    if (C0 as *mut ::core::ffi::c_char >= _gm_.least_addr)
                                                        as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                                    {
                                                        (*R).child[0 as ::core::ffi::c_int as usize] = C0
                                                            as *mut malloc_tree_chunk;
                                                ...
                                                C1 = (*TP).child[1 as ::core::ffi::c_int as usize]
                                                    as tchunkptr;
                                                if !C1.is_null() {
                                                    if (C1 as *mut ::core::ffi::c_char >= _gm_.least_addr)
                                                        as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                                    {
                                                        (*R).child[1 as ::core::ffi::c_int as usize] = C1
                                                            as *mut malloc_tree_chunk;
                            ...
                            current_block = 16635223273154059438;
                        }
                    }
                } else {
                    current_block = 10778260831612459202;
                                    ...
                                    as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                {
                                    if (*next).head & CINUSE_BIT == 0 {
                                        if next == _gm_.top {
                                            ...
                                            _gm_.dv = p;
                                            (*p).head = dsize | PINUSE_BIT;
                                            (*((p as *mut ::core::ffi::c_char).offset(dsize as isize)
                                                as mchunkptr))
                                                .prev_foot = dsize;
                                            current_block = 853568773389343594;
                                        } else {
                                            ...
                                            if nsize >> SMALLBIN_SHIFT < NSMALLBINS as size_t {
                                                let mut F_1: mchunkptr = (*next).fd as mchunkptr;
                                                let mut B_0: mchunkptr = (*next).bk as mchunkptr;
                                                let mut I_0: bindex_t = (nsize >> SMALLBIN_SHIFT)
                                                    as bindex_t;
                                                if (F_1
                                                    == (&raw mut _gm_.smallbins as *mut mchunkptr)
                                                        .offset((I_0 << 1 as ::core::ffi::c_int) as isize)
                                                        as *mut mchunkptr as *mut ::core::ffi::c_char as sbinptr
                                                    || F_1 as *mut ::core::ffi::c_char >= _gm_.least_addr
                                                        && (*F_1).bk == next) as ::core::ffi::c_int
                                                    as ::core::ffi::c_long != 0
                                                {
                                                    if B_0 == F_1 {
                                                        ...
                                                        == (&raw mut _gm_.smallbins as *mut mchunkptr)
                                                            .offset((I_0 << 1 as ::core::ffi::c_int) as isize)
                                                            as *mut mchunkptr as *mut ::core::ffi::c_char as sbinptr
                                                        || B_0 as *mut ::core::ffi::c_char >= _gm_.least_addr
                                                            && (*B_0).fd == next) as ::core::ffi::c_int
                                                        as ::core::ffi::c_long != 0
                                                    {
                                                        (*F_1).bk = B_0 as *mut malloc_chunk;
                                                ...
                                                if (*TP_0).bk != TP_0 {
                                                    let mut F_2: tchunkptr = (*TP_0).fd as tchunkptr;
                                                    R_0 = (*TP_0).bk as tchunkptr;
                                                    if (F_2 as *mut ::core::ffi::c_char >= _gm_.least_addr
                                                        && (*F_2).bk == TP_0 && (*R_0).fd == TP_0)
                                                        as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                                    {
                                                        (*F_2).bk = R_0 as *mut malloc_tree_chunk;
                                                        ...
                                                        }
                                                    {
                                                        ...
                                                        if (RP_0 as *mut ::core::ffi::c_char >= _gm_.least_addr)
                                                            as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                                        {
                                                            *RP_0 = ::core::ptr::null_mut::<malloc_tree_chunk>();
                                                        } else {
                                                ...
                                                if !XP_0.is_null() {
                                                    let mut H_0: *mut tbinptr = (&raw mut _gm_.treebins
                                                        as *mut tbinptr)
                                                        .offset((*TP_0).index as isize) as *mut tbinptr;
                                                    if TP_0 == *H_0 {
                                                        *H_0 = R_0 as tbinptr;
                                                    ...
                                                    if !R_0.is_null() {
                                                        if (R_0 as *mut ::core::ffi::c_char >= _gm_.least_addr)
                                                            as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                                        {
                                                            let mut C0_0: tchunkptr = ::core::ptr::null_mut::<
                                                                malloc_tree_chunk,
                                                            ...
                                                            C0_0 = (*TP_0).child[0 as ::core::ffi::c_int as usize]
                                                                as tchunkptr;
                                                            if !C0_0.is_null() {
                                                                if (C0_0 as *mut ::core::ffi::c_char >= _gm_.least_addr)
                                                                    as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                                                {
                                                                    (*R_0).child[0 as ::core::ffi::c_int as usize] = C0_0
                                                                        as *mut malloc_tree_chunk;
                                                            ...
                                                            C1_0 = (*TP_0).child[1 as ::core::ffi::c_int as usize]
                                                                as tchunkptr;
                                                            if !C1_0.is_null() {
                                                                if (C1_0 as *mut ::core::ffi::c_char >= _gm_.least_addr)
                                                                    as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                                                {
                                                                    (*R_0).child[1 as ::core::ffi::c_int as usize] = C1_0
                                                                        as *mut malloc_tree_chunk;
                                    ...
                                    match current_block {
                                        ...
                                        _ => {
                                            if psize >> SMALLBIN_SHIFT < NSMALLBINS as size_t {
                                                let mut I_1: bindex_t = (psize >> SMALLBIN_SHIFT)
                                                    as bindex_t;
                                                ...
                                                let mut F_3: mchunkptr = B_1;
                                                if _gm_.smallmap
                                                    & (1 as ::core::ffi::c_int as binmap_t) << I_1 == 0
                                                {
                                                    _gm_.smallmap
                                                ...
                                                let mut tp: tchunkptr = p as tchunkptr;
                                                let mut H_1: *mut tbinptr = ::core::ptr::null_mut::<
                                                    tbinptr,
                                                >();
                                                let mut I_2: bindex_t = 0;
                                                let mut X: ::core::ffi::c_uint = psize
                                                    as ::core::ffi::c_uint >> TREEBIN_SHIFT;
                                                if X == 0 as ::core::ffi::c_uint {
                                                    I_2 = 0 as bindex_t;
                                                } else if X > 0xffff as ::core::ffi::c_uint {
                                                    I_2 = NTREEBINS.wrapping_sub(1 as ::core::ffi::c_uint)
                                                        as bindex_t;
                                                } else {
                                                    let mut K: ::core::ffi::c_uint = (::core::mem::size_of::<
                                                        ::core::ffi::c_uint,
                                                ...
                                                H_1 = (&raw mut _gm_.treebins as *mut tbinptr)
                                                    .offset(I_2 as isize) as *mut tbinptr;
                                                (*tp).index = I_2;
                                                (*tp).child[1 as ::core::ffi::c_int as usize] = ::core::ptr::null_mut::<
                                                    malloc_tree_chunk,
                                                >();
                                                (*tp).child[0 as ::core::ffi::c_int as usize] = (*tp)
                                                    .child[1 as ::core::ffi::c_int as usize];
                                                if _gm_.treemap
                                                    & (1 as ::core::ffi::c_int as binmap_t) << I_2 == 0
                                                {
                                                    _gm_.treemap
                                                        |= (1 as ::core::ffi::c_int as binmap_t) << I_2;
                                                    *H_1 = tp as tbinptr;
                                                    (*tp).parent = H_1 as tchunkptr as *mut malloc_tree_chunk;
                                                    (*tp).bk = tp as *mut malloc_tree_chunk;
                                                    (*tp).fd = (*tp).bk;
                                                } else {
                                                    let mut T: tchunkptr = *H_1;
                                                    ...
                                                    loop {
                                                            ...
                                                            != psize
                                                        {
                                                            ...
                                                            if !(*C).is_null() {
                                                                T = *C;
                                                            } else if (C as *mut ::core::ffi::c_char >= _gm_.least_addr)
                                                                as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                                            {
                                                                *C = tp;
                                                                (*tp).parent = T as *mut malloc_tree_chunk;
                                                            ...
                                                            let mut F_4: tchunkptr = (*T).fd as tchunkptr;
                                                            if (T as *mut ::core::ffi::c_char >= _gm_.least_addr
                                                                && F_4 as *mut ::core::ffi::c_char >= _gm_.least_addr)
                                                                as ::core::ffi::c_int as ::core::ffi::c_long != 0
                                                            {
                                                                (*F_4).bk = tp as *mut malloc_tree_chunk;
                                                                (*T).fd = (*F_4).bk;
                                                                (*tp).fd = F_4 as *mut malloc_tree_chunk;
                                                                (*tp).bk = T as *mut malloc_tree_chunk;
                                                                (*tp).parent = ::core::ptr::null_mut::<malloc_tree_chunk>();
                                                                break;
                                                            } else {
                                                ...
                                                _gm_.release_checks = _gm_.release_checks.wrapping_sub(1);
...
unsafe extern "C" fn dlcalloc(
    mut n_elements: size_t,
    mut elem_size: size_t,
) -> *mut ::core::ffi::c_void {
    let mut mem: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<
        ::core::ffi::c_void,
    >();
    let mut req: size_t = 0 as size_t;
    if n_elements != 0 as size_t {
        req = n_elements.wrapping_mul(elem_size);
        if (n_elements | elem_size) & !(0xffff as ::core::ffi::c_int as size_t) != 0
            && req.wrapping_div(n_elements) != elem_size
        {
            req = MAX_SIZE_T;
        }
    }
    ...
    if !mem.is_null()
        && !((*((mem as *mut ::core::ffi::c_char)
            ...
            .head & INUSE_BITS == 0 as size_t)
    {
        memset(mem, 0 as ::core::ffi::c_int, req);
    }
    return mem;
}
unsafe extern "C" fn try_realloc_chunk(
    ...
    let mut next: mchunkptr = (p as *mut ::core::ffi::c_char).offset(oldsize as isize)
        as mchunkptr;
        ...
        as ::core::ffi::c_long != 0
    {
        if (*p).head & INUSE_BITS == 0 as size_t {
            ...
            if rsize >= MIN_CHUNK_SIZE {
                let mut r: mchunkptr = (p as *mut ::core::ffi::c_char)
                    .offset(nb as isize) as mchunkptr;
            ...
            if oldsize.wrapping_add((*m).topsize) > nb {
                ...
                let mut newtop: mchunkptr = (p as *mut ::core::ffi::c_char)
                    .offset(nb as isize) as mchunkptr;
                (*p).head = (*p).head & PINUSE_BIT | nb | CINUSE_BIT;
                (*((p as *mut ::core::ffi::c_char).offset(nb as isize) as mchunkptr))
                    .head |= PINUSE_BIT;
            ...
            if oldsize.wrapping_add(dvs) >= nb {
                ...
                if dsize >= MIN_CHUNK_SIZE {
                    let mut r_0: mchunkptr = (p as *mut ::core::ffi::c_char)
                        .offset(nb as isize) as mchunkptr;
                    let mut n: mchunkptr = (r_0 as *mut ::core::ffi::c_char)
                        .offset(dsize as isize) as mchunkptr;
                    (*p).head = (*p).head & PINUSE_BIT | nb | CINUSE_BIT;
                    (*((p as *mut ::core::ffi::c_char).offset(nb as isize) as mchunkptr))
                        .head |= PINUSE_BIT;
                    (*r_0).head = dsize | PINUSE_BIT;
                    (*((r_0 as *mut ::core::ffi::c_char).offset(dsize as isize)
                        as mchunkptr))
                        .prev_foot = dsize;
                    (*n).head &= !PINUSE_BIT;
                    (*m).dvsize = dsize;
                    ...
                    (*((p as *mut ::core::ffi::c_char).offset(newsize_0 as isize)
                        as mchunkptr))
                        .head |= PINUSE_BIT;
                    (*m).dvsize = 0 as size_t;
                    (*m).dv = ::core::ptr::null_mut::<malloc_chunk>();
            ...
            let mut nextsize: size_t = (*next).head
                & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT);
            if oldsize.wrapping_add(nextsize) >= nb {
                let mut rsize_0: size_t = oldsize
                    .wrapping_add(nextsize)
                    .wrapping_sub(nb);
                ...
                if rsize_0 < MIN_CHUNK_SIZE {
                    ...
                    (*((p as *mut ::core::ffi::c_char).offset(newsize_1 as isize)
                        as mchunkptr))
                        .head |= PINUSE_BIT;
                } else {
                    let mut r_1: mchunkptr = (p as *mut ::core::ffi::c_char)
                        .offset(nb as isize) as mchunkptr;
                    (*p).head = (*p).head & PINUSE_BIT | nb | CINUSE_BIT;
                    (*((p as *mut ::core::ffi::c_char).offset(nb as isize) as mchunkptr))
                        .head |= PINUSE_BIT;
                    (*r_1).head = (*r_1).head & PINUSE_BIT | rsize_0 | CINUSE_BIT;
                    (*((r_1 as *mut ::core::ffi::c_char).offset(rsize_0 as isize)
                        as mchunkptr))
                        .head |= PINUSE_BIT;
...
unsafe extern "C" fn internal_memalign(
    ...
    if alignment < MIN_CHUNK_SIZE {
        alignment = MIN_CHUNK_SIZE as size_t;
    }
    ...
    if bytes >= MAX_REQUEST.wrapping_sub(alignment as usize) {
        if !m.is_null() {
            *__errno_location() = ENOMEM;
        }
    } else {
        let mut nb: size_t = if bytes < MIN_REQUEST {
            MIN_CHUNK_SIZE
        } else {
            bytes.wrapping_add(CHUNK_OVERHEAD).wrapping_add(CHUNK_ALIGN_MASK)
                & !CHUNK_ALIGN_MASK
        };
        ...
        if !mem.is_null() {
            ...
            if mem as size_t & alignment.wrapping_sub(1 as size_t) != 0 as size_t {
                let mut br: *mut ::core::ffi::c_char = (((mem
                    as *mut ::core::ffi::c_char)
                    .offset(alignment as isize)
                    .offset(-(1 as ::core::ffi::c_int as size_t as isize)) as size_t
                    & alignment.wrapping_neg()) as *mut ::core::ffi::c_char)
                    .offset(-(TWO_SIZE_T_SIZES as isize)) as mchunkptr
                    as *mut ::core::ffi::c_char;
                let mut pos: *mut ::core::ffi::c_char = if br
                    .offset_from(p as *mut ::core::ffi::c_char) as ::core::ffi::c_int
                    as size_t >= MIN_CHUNK_SIZE
                {
                    br
                } else {
                ...
                let mut leadsize: size_t = pos.offset_from(p as *mut ::core::ffi::c_char)
                    as ::core::ffi::c_int as size_t;
                let mut newsize: size_t = ((*p).head
                    & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT))
                    .wrapping_sub(leadsize);
                if (*p).head & INUSE_BITS == 0 as size_t {
                    ...
                    (*((p as *mut ::core::ffi::c_char).offset(leadsize as isize)
                        as mchunkptr))
                        .head |= PINUSE_BIT;
            ...
            if !((*p).head & INUSE_BITS == 0 as size_t) {
                let mut size: size_t = (*p).head
                    & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT);
                if size > nb.wrapping_add(MIN_CHUNK_SIZE) {
                    let mut remainder_size: size_t = size.wrapping_sub(nb);
                    let mut remainder: mchunkptr = (p as *mut ::core::ffi::c_char)
                        .offset(nb as isize) as mchunkptr;
                    (*p).head = (*p).head & PINUSE_BIT | nb | CINUSE_BIT;
                    (*((p as *mut ::core::ffi::c_char).offset(nb as isize) as mchunkptr))
                        .head |= PINUSE_BIT;
                    (*remainder).head = (*remainder).head & PINUSE_BIT | remainder_size
                        | CINUSE_BIT;
                    (*((remainder as *mut ::core::ffi::c_char)
                        .offset(remainder_size as isize) as mchunkptr))
                        .head |= PINUSE_BIT;
...
unsafe extern "C" fn ialloc(
    mut m: mstate,
    mut n_elements: size_t,
    mut sizes: *mut size_t,
    mut opts: ::core::ffi::c_int,
    mut chunks: *mut *mut ::core::ffi::c_void,
) -> *mut *mut ::core::ffi::c_void {
    let mut element_size: size_t = 0;
    ...
    >();
    let mut p: mchunkptr = ::core::ptr::null_mut::<malloc_chunk>();
    let mut remainder_size: size_t = 0;
    let mut marray: *mut *mut ::core::ffi::c_void = ::core::ptr::null_mut::<
        *mut ::core::ffi::c_void,
    >();
    let mut array_chunk: mchunkptr = ::core::ptr::null_mut::<malloc_chunk>();
    let mut was_enabled: flag_t = 0;
    ...
    if !chunks.is_null() {
        if n_elements == 0 as size_t {
            return chunks as *mut *mut ::core::ffi::c_void;
        }
        marray = chunks as *mut *mut ::core::ffi::c_void;
        array_size = 0 as size_t;
    } else {
        if n_elements == 0 as size_t {
            return dlmalloc(0 as size_t) as *mut *mut ::core::ffi::c_void;
        }
        marray = ::core::ptr::null_mut::<*mut ::core::ffi::c_void>();
        array_size = (if n_elements
    ...
    if opts & 0x1 as ::core::ffi::c_int != 0 {
        element_size = (if *sizes < MIN_REQUEST {
            MIN_CHUNK_SIZE
        } else {
            (*sizes).wrapping_add(CHUNK_OVERHEAD).wrapping_add(CHUNK_ALIGN_MASK)
                & !CHUNK_ALIGN_MASK
        }) as size_t;
        contents_size = n_elements.wrapping_mul(element_size);
    } else {
        element_size = 0 as size_t;
        contents_size = 0 as size_t;
        i = 0 as size_t;
        while i != n_elements {
            contents_size = (contents_size as ::core::ffi::c_uint)
                .wrapping_add(
                    (if *sizes.offset(i as isize) < MIN_REQUEST {
                        MIN_CHUNK_SIZE
                    } else {
                        (*sizes.offset(i as isize) as usize)
                            .wrapping_add(CHUNK_OVERHEAD)
                            .wrapping_add(CHUNK_ALIGN_MASK) & !CHUNK_ALIGN_MASK
                    }) as ::core::ffi::c_uint,
                ) as size_t as size_t;
    ...
    size = contents_size.wrapping_add(array_size);
    was_enabled = ((*m).mflags as size_t & USE_MMAP_BIT) as flag_t;
    (*m).mflags &= !USE_MMAP_BIT as ::core::ffi::c_uint;
    mem = dlmalloc(size.wrapping_sub(::core::mem::size_of::<size_t>() as size_t));
    if was_enabled != 0 {
        (*m).mflags |= USE_MMAP_BIT as ::core::ffi::c_uint;
    }
    if mem.is_null() {
    ...
    p = (mem as *mut ::core::ffi::c_char).offset(-(TWO_SIZE_T_SIZES as isize))
        as mchunkptr;
    remainder_size = (*p).head & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT);
    if opts & 0x2 as ::core::ffi::c_int != 0 {
        memset(
            mem as *mut size_t as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            remainder_size.wrapping_sub(SIZE_T_SIZE).wrapping_sub(array_size),
        );
    }
    if marray.is_null() {
        let mut array_chunk_size: size_t = 0;
        array_chunk = (p as *mut ::core::ffi::c_char).offset(contents_size as isize)
            as mchunkptr;
        array_chunk_size = remainder_size.wrapping_sub(contents_size);
        marray = (array_chunk as *mut ::core::ffi::c_char)
            .offset(TWO_SIZE_T_SIZES as isize) as *mut ::core::ffi::c_void
            as *mut *mut ::core::ffi::c_void;
        (*array_chunk).head = array_chunk_size | PINUSE_BIT | CINUSE_BIT;
        remainder_size = contents_size;
    }
    i = 0 as size_t;
    loop {
        let ref mut fresh7 = *marray.offset(i as isize);
        *fresh7 = (p as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as isize)
            as *mut ::core::ffi::c_void;
        if i != n_elements.wrapping_sub(1 as size_t) {
            if element_size != 0 as size_t {
                size = element_size;
            } else {
                size = (if *sizes.offset(i as isize) < MIN_REQUEST {
                    MIN_CHUNK_SIZE
                } else {
                    (*sizes.offset(i as isize) as usize)
                        .wrapping_add(CHUNK_OVERHEAD)
            ...
            remainder_size = remainder_size.wrapping_sub(size);
            (*p).head = size | PINUSE_BIT | CINUSE_BIT;
            p = (p as *mut ::core::ffi::c_char).offset(size as isize) as mchunkptr;
            i = i.wrapping_add(1);
        } else {
            (*p).head = remainder_size | PINUSE_BIT | CINUSE_BIT;
            break;
        }
    }
    if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
...
unsafe extern "C" fn internal_bulk_free(
    ...
    {
        let mut a: *mut *mut ::core::ffi::c_void = ::core::ptr::null_mut::<
            *mut ::core::ffi::c_void,
        >();
        let mut fence: *mut *mut ::core::ffi::c_void = array.offset(nelem as isize)
            as *mut *mut ::core::ffi::c_void;
            ...
            if !mem.is_null() {
                ...
                *a = ::core::ptr::null_mut::<::core::ffi::c_void>();
                if (p as *mut ::core::ffi::c_char >= (*m).least_addr
                    ...
                    as ::core::ffi::c_long != 0
                {
                    let mut b: *mut *mut ::core::ffi::c_void = a
                        .offset(1 as ::core::ffi::c_int as isize);
                    let mut next: mchunkptr = (p as *mut ::core::ffi::c_char)
                        .offset(((*p).head & !FLAG_BITS) as isize) as mchunkptr;
                    if b != fence
                        && *b
                            == (next as *mut ::core::ffi::c_char)
                                .offset(TWO_SIZE_T_SIZES as isize)
                                as *mut ::core::ffi::c_void
                    {
...
unsafe extern "C" fn dlrealloc(
    ...
    if oldmem.is_null() {
        ...
        *__errno_location() = ENOMEM;
        ...
        {
            let mut newp: mchunkptr = try_realloc_chunk(
                m,
                oldp,
                nb,
                1 as ::core::ffi::c_int,
            ...
            if !newp.is_null() {
                mem = (newp as *mut ::core::ffi::c_char)
                    .offset(TWO_SIZE_T_SIZES as isize) as *mut ::core::ffi::c_void;
            } else {
                mem = dlmalloc(bytes);
                if !mem.is_null() {
                    let mut oc: size_t = ((*oldp).head
                        & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT))
                        .wrapping_sub(
                            (if (*oldp).head & INUSE_BITS == 0 as size_t {
                                MMAP_CHUNK_OVERHEAD
                            } else {
                                CHUNK_OVERHEAD
                            }),
                        );
                    memcpy(mem, oldmem, if oc < bytes { oc } else { bytes });
                    dlfree(oldmem);
                }
            }
        }
...
unsafe extern "C" fn dlmemalign(
    ...
    return internal_memalign(&raw mut _gm_, alignment, bytes);
}
#[no_mangle]
pub unsafe extern "C" fn dlposix_memalign(
    ...
    if alignment == MALLOC_ALIGNMENT {
        ...
        let mut d: size_t = alignment
            .wrapping_div(::core::mem::size_of::<*mut ::core::ffi::c_void>() as size_t);
        let mut r: size_t = alignment
            .wrapping_rem(::core::mem::size_of::<*mut ::core::ffi::c_void>() as size_t);
        if r != 0 as size_t || d == 0 as size_t
            || d & d.wrapping_sub(SIZE_T_ONE) != 0 as size_t
        {
            return EINVAL
        } else if bytes <= MAX_REQUEST.wrapping_sub(alignment as usize) {
            if alignment < MIN_CHUNK_SIZE {
                alignment = MIN_CHUNK_SIZE as size_t;
            }
...
unsafe extern "C" fn dlvalloc(mut bytes: size_t) -> *mut ::core::ffi::c_void {
    let mut pagesz: size_t = 0;
    (::core::intrinsics::atomic_load_acquire(&raw mut mparams.magic) != 0 as size_t
        || init_mparams() != 0) as ::core::ffi::c_int;
    pagesz = mparams.page_size;
    return dlmemalign(pagesz, bytes);
}
unsafe extern "C" fn dlpvalloc(mut bytes: size_t) -> *mut ::core::ffi::c_void {
    let mut pagesz: size_t = 0;
    (::core::intrinsics::atomic_load_acquire(&raw mut mparams.magic) != 0 as size_t
        || init_mparams() != 0) as ::core::ffi::c_int;
    pagesz = mparams.page_size;
    return dlmemalign(
        pagesz,
        bytes.wrapping_add(pagesz).wrapping_sub(SIZE_T_ONE)
            & !pagesz.wrapping_sub(SIZE_T_ONE),
    );
}
unsafe extern "C" fn dlindependent_calloc(
    mut n_elements: size_t,
    mut elem_size: size_t,
    mut chunks: *mut *mut ::core::ffi::c_void,
) -> *mut *mut ::core::ffi::c_void {
    let mut sz: size_t = elem_size;
    return ialloc(
        &raw mut _gm_,
        n_elements,
        &raw mut sz,
...
unsafe extern "C" fn dlindependent_comalloc(
    mut n_elements: size_t,
    mut sizes: *mut size_t,
    mut chunks: *mut *mut ::core::ffi::c_void,
) -> *mut *mut ::core::ffi::c_void {
...
unsafe extern "C" fn dlmalloc_trim(mut pad: size_t) -> ::core::ffi::c_int {
    ...
    {
        result = sys_trim(&raw mut _gm_, pad);
        if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
            ::core::intrinsics::atomic_store_release(&raw mut _gm_.mutex, 0);
        }
    }
...
unsafe extern "C" fn dlmalloc_footprint() -> size_t {
    return _gm_.footprint;
}
unsafe extern "C" fn dlmalloc_max_footprint() -> size_t {
...
unsafe extern "C" fn dlmalloc_stats() {
    internal_malloc_stats(&raw mut _gm_);
}
unsafe extern "C" fn dlmallopt(
    mut param_number: ::core::ffi::c_int,
    mut value: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    return change_mparam(param_number, value);
}
unsafe extern "C" fn dlmalloc_usable_size(mut mem: *mut ::core::ffi::c_void) -> size_t {
    if !mem.is_null() {
        let mut p: mchunkptr = (mem as *mut ::core::ffi::c_char)
            .offset(-(TWO_SIZE_T_SIZES as isize)) as mchunkptr;
        if (*p).head & INUSE_BITS != PINUSE_BIT {
            return ((*p).head & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT))
                .wrapping_sub(
                    (if (*p).head & INUSE_BITS == 0 as size_t {
                        MMAP_CHUNK_OVERHEAD
                    } else {
...
unsafe extern "C" fn open_temp_exec_file_dir(
    ...
    static mut suffix: [::core::ffi::c_char; 11] = unsafe {
        ::core::mem::transmute::<[u8; 11], [::core::ffi::c_char; 11]>(*b"/ffiXXXXXX\0")
    };
    ...
    let mut fd: ::core::ffi::c_int = 0;
    flags = O_CLOEXEC;
    fd = open(dir, flags | O_RDWR | O_EXCL | O_TMPFILE, 0o700 as ::core::ffi::c_int);
    if fd != -(1 as ::core::ffi::c_int)
        || *__errno_location() != EINVAL && *__errno_location() != EISDIR
    ...
    tempname = alloca_allocations.last_mut().unwrap().as_mut_ptr()
        as *mut ::core::ffi::c_char;
    if tempname.is_null() {
        return -(1 as ::core::ffi::c_int);
    }
...
unsafe extern "C" fn open_temp_exec_file_mnt(
    ...
    static mut last_mounts: *const ::core::ffi::c_char = ::core::ptr::null::<
        ::core::ffi::c_char,
    >();
    ...
    loop {
        ...
        if getmntent_r(
                ...
                ::core::mem::size_of::<[::core::ffi::c_char; 12288]>()
                    as ::core::ffi::c_int,
            )
            .is_null()
        {
        ...
        if !hasmntopt(&raw mut mnt, b"ro\0" as *const u8 as *const ::core::ffi::c_char)
            .is_null()
            || !hasmntopt(
                    &raw mut mnt,
                    b"noexec\0" as *const u8 as *const ::core::ffi::c_char,
                )
                .is_null() || access(mnt.mnt_dir, W_OK) != 0
        {
            continue;
        }
...
static mut open_temp_exec_file_opts: [C2RustUnnamed_1; 9] = unsafe {
    [
        C2RustUnnamed_1 {
            func: Some(
...
unsafe extern "C" fn open_temp_exec_file_opts_next() -> ::core::ffi::c_int {
    ...
    if open_temp_exec_file_opts_idx as usize
        == (::core::mem::size_of::<[C2RustUnnamed_1; 9]>() as usize)
...
unsafe extern "C" fn allocate_space(
    ...
    while len > 0 as off_t {
        let mut to_write: off_t = if len < page_size { len } else { page_size as off_t };
        if (write(fd, buf.as_mut_ptr() as *const ::core::ffi::c_void, to_write as size_t)
            as off_t) < to_write
        {
            return -(1 as ::core::ffi::c_int);
        }
...
unsafe extern "C" fn dlmmap_locked(
    ...
    if execfd == -(1 as ::core::ffi::c_int) {
        open_temp_exec_file_opts_idx = 0 as ::core::ffi::c_int;
        current_block = 7809082751475489221;
    } else {
        ...
        match current_block {
            ...
            _ => {
                ...
                if ptr == MFAIL {
                    ...
                    if offset == 0
                        && open_temp_exec_file_opts[open_temp_exec_file_opts_idx
                                as usize]
                            .repeat != 0
                    {
...
unsafe extern "C" fn dlmmap(
    ...
    if execfd == -(1 as ::core::ffi::c_int) && ffi_tramp_is_supported() != 0 {
        ptr = mmap(start, length, prot & !PROT_EXEC, flags, fd, offset as __off_t);
        return ptr;
    }
    if !(execfd == -(1 as ::core::ffi::c_int)
...
unsafe extern "C" fn dlmunmap(
    ...
    let mut seg: msegmentptr = segment_holding(
        &raw mut _gm_,
        start as *mut ::core::ffi::c_char,
    );
    let mut code: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<
        ::core::ffi::c_void,
    >();
    if !seg.is_null()
        && {
            code = (start as *mut ::core::ffi::c_char)
                .offset((*seg).exec_offset as isize) as *mut ::core::ffi::c_void;
            code != start
        }
    {
...
pub unsafe extern "C" fn ffi_closure_alloc(
    ...
    let mut ptr: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<
        ::core::ffi::c_void,
    >();
    let mut ftramp: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<
        ::core::ffi::c_void,
    >();
    if code.is_null() {
        return NULL;
