...
unsafe extern "C" fn initialize_aggregate(
    ...
    while !(*ptr).is_null() {
        if (((**ptr).size == 0 as size_t
            && initialize_aggregate(*ptr, ::core::ptr::null_mut::<size_t>())
                as ::core::ffi::c_uint
        ...
        (*arg).alignment = (if (*arg).alignment as ::core::ffi::c_int
    ...
    (*arg).size = ((*arg).size.wrapping_sub(1 as size_t)
        ...
        .wrapping_add(1 as size_t);
    if (*arg).size == 0 as size_t { return FFI_BAD_TYPEDEF } else { return FFI_OK };
}
#[no_mangle]
pub unsafe extern "C" fn ffi_prep_cif_core(
    ...
    if (*(*cif).rtype).size == 0 as size_t
        && initialize_aggregate((*cif).rtype, ::core::ptr::null_mut::<size_t>())
            as ::core::ffi::c_uint != FFI_OK as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        return FFI_BAD_TYPEDEF;
    }
    if (*(*cif).rtype).type_0 as ::core::ffi::c_int == FFI_TYPE_STRUCT {
        bytes = (::core::mem::size_of::<*mut ::core::ffi::c_void>()
