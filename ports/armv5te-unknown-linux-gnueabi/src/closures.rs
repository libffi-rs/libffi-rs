...
pub const __O_TMPFILE: ::core::ffi::c_int = 0o20000000 as ::core::ffi::c_int | __O_DIRECTORY;
...
#[inline]
unsafe extern "C" fn __pthread_cleanup_routine(mut __frame: *mut __pthread_cleanup_frame) {
...
unsafe extern "C" fn spin_acquire_lock(mut sl: *mut ::core::ffi::c_int) -> ::core::ffi::c_int {
    ...
    while crate::atomics::atomic_load_relaxed(sl) != 0 as ::core::ffi::c_int
        || crate::atomics::atomic_xchg_acquire(sl, 1 as ::core::ffi::c_int) != 0
    {
        spins += 1;
...
pub const MIN_CHUNK_SIZE: usize = MCHUNK_SIZE.wrapping_add(CHUNK_ALIGN_MASK) & !CHUNK_ALIGN_MASK;
...
unsafe extern "C" fn init_mparams() -> ::core::ffi::c_int {
    if crate::atomics::atomic_xchg_acquire(&raw mut malloc_global_mutex, 1 as ::core::ffi::c_int)
        != 0
    {
    ...
    if mparams.magic == 0 as size_t {
        ...
        crate::atomics::atomic_store_release(&raw mut mparams.magic, magic);
    }
    crate::atomics::atomic_store_release(&raw mut malloc_global_mutex, 0);
    return 1 as ::core::ffi::c_int;
}
unsafe extern "C" fn change_mparam(
    ...
    (crate::atomics::atomic_load_acquire(&raw mut mparams.magic) != 0 as size_t
    ...
    match param_number {
        ...
        M_GRANULARITY => {
            if val >= mparams.page_size && val & val.wrapping_sub(1 as size_t) == 0 as size_t {
...
unsafe extern "C" fn internal_malloc_stats(mut m: mstate) {
    ...
    if if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
        if crate::atomics::atomic_xchg_acquire(&raw mut (*m).mutex, 1 as ::core::ffi::c_int) != 0 {
    ...
    } == 0
    {
        ...
        if !(*m).top.is_null() {
            ...
            fp = (*m).footprint;
            used = fp.wrapping_sub(
                (*m).topsize.wrapping_add(
            ...
            while !s.is_null() {
                    ...
                    && (*q).head != FENCEPOST_HEAD
                {
                    if !((*q).head & INUSE_BITS != PINUSE_BIT) {
                        used =
                            used.wrapping_sub((*q).head & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT));
                    }
        ...
        if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
            crate::atomics::atomic_store_release(&raw mut (*m).mutex, 0);
        }
        fprintf(
            stderr,
    ...
    if oldfirst == (*m).top {
        ...
        if qsize >> SMALLBIN_SHIFT < NSMALLBINS as size_t {
            ...
            if X == 0 as ::core::ffi::c_uint {
                ...
                I_1 = ((K as size_t) << 1 as ::core::ffi::c_int).wrapping_add(
        ...
        if psize >> SMALLBIN_SHIFT < NSMALLBINS as size_t {
            ...
            if X == 0 as ::core::ffi::c_uint {
                ...
                let mut K: ::core::ffi::c_uint = (::core::mem::size_of::<::core::ffi::c_uint>()
                    ...
                    .wrapping_sub(1 as ::core::ffi::c_uint)
                    .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
                I_0 = ((K as size_t) << 1 as ::core::ffi::c_int).wrapping_add(
...
unsafe extern "C" fn sys_alloc(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
    ...
    if MORECORE_CONTIGUOUS != 0 && (*m).mflags as ::core::ffi::c_uint & USE_NONCONTIGUOUS_BIT == 0 {
        ...
        if crate::atomics::atomic_xchg_acquire(
                    ...
                    if X == 0 as ::core::ffi::c_uint {
                        ...
                        let mut K: ::core::ffi::c_uint =
                            (::core::mem::size_of::<::core::ffi::c_uint>() as ::core::ffi::c_uint)
                                ...
                                .wrapping_sub(1 as ::core::ffi::c_uint)
                                .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
                        I = ((K as size_t) << 1 as ::core::ffi::c_int).wrapping_add(
                            psize
                                >> K.wrapping_add(
    ...
    if (*p).head & PINUSE_BIT == 0 {
        ...
        if (*p).head & INUSE_BITS == 0 as size_t {
            psize = (psize as ::core::ffi::c_uint)
                .wrapping_add(prevsize.wrapping_add(MMAP_FOOT_PAD) as ::core::ffi::c_uint)
                as size_t as size_t;
            if dlmunmap(
        ...
        if psize >> SMALLBIN_SHIFT < NSMALLBINS as size_t {
            ...
            if X == 0 as ::core::ffi::c_uint {
                ...
                let mut K: ::core::ffi::c_uint = (::core::mem::size_of::<::core::ffi::c_uint>()
                    ...
                    .wrapping_sub(1 as ::core::ffi::c_uint)
                    .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
                I_2 = ((K as size_t) << 1 as ::core::ffi::c_int).wrapping_add(
                    psize >> K.wrapping_add(TREEBIN_SHIFT.wrapping_sub(1 as ::core::ffi::c_uint))
                        & 1 as size_t,
                ) as bindex_t;
            }
...
unsafe extern "C" fn tmalloc_large(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
    ...
    if X == 0 as ::core::ffi::c_uint {
        ...
        let mut K: ::core::ffi::c_uint = (::core::mem::size_of::<::core::ffi::c_uint>()
            ...
            .wrapping_sub(1 as ::core::ffi::c_uint)
            .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
        idx = ((K as size_t) << 1 as ::core::ffi::c_int).wrapping_add(
                ...
                if rsize < MIN_CHUNK_SIZE {
                    ...
                    if rsize >> SMALLBIN_SHIFT < NSMALLBINS as size_t {
                        ...
                        if X_0 == 0 as ::core::ffi::c_uint {
                            ...
                            I_0 = ((K_0 as size_t) << 1 as ::core::ffi::c_int).wrapping_add(
                                rsize
                                    >> K_0.wrapping_add(
                                        TREEBIN_SHIFT.wrapping_sub(1 as ::core::ffi::c_uint),
                                    )
...
unsafe extern "C" fn dlmalloc(mut bytes: size_t) -> *mut ::core::ffi::c_void {
    ...
    if if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
        if crate::atomics::atomic_xchg_acquire(&raw mut _gm_.mutex, 1 as ::core::ffi::c_int) != 0 {
    ...
    } == 0
    {
        ...
        if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
            crate::atomics::atomic_store_release(&raw mut _gm_.mutex, 0);
        }
        return mem;
    } else {
        return ::core::ptr::null_mut::<::core::ffi::c_void>();
...
unsafe extern "C" fn dlfree(mut mem: *mut ::core::ffi::c_void) {
    ...
    if !mem.is_null() {
        ...
        if if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
            if crate::atomics::atomic_xchg_acquire(&raw mut _gm_.mutex, 1 as ::core::ffi::c_int)
                != 0
            {
                spin_acquire_lock(&raw mut _gm_.mutex)
            } else {
        ...
        } == 0
        {
                ...
                != 0
            {
                ...
                if (*p).head & PINUSE_BIT == 0 {
                    let mut prevsize: size_t = (*p).prev_foot;
                    if (*p).head & INUSE_BITS == 0 as size_t {
                        psize = (psize as ::core::ffi::c_uint).wrapping_add(
    ...
    if bytes >= MAX_REQUEST.wrapping_sub(alignment as usize) {
        ...
        if !mem.is_null() {
            let mut p: mchunkptr =
                (mem as *mut ::core::ffi::c_char).offset(-(TWO_SIZE_T_SIZES as isize)) as mchunkptr;
            if if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
                if crate::atomics::atomic_xchg_acquire(&raw mut (*m).mutex, 1 as ::core::ffi::c_int)
                    != 0
                {
                    spin_acquire_lock(&raw mut (*m).mutex)
                } else {
