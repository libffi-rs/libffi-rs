...
// C2Rust 0.22.1 cannot lower C complex-valued initializers.  These are the
// exact ordinary ffi_type descriptors generated by upstream's TYPEDEF macro.
#[no_mangle]
pub static mut ffi_type_complex_float: ffi_type = _ffi_type {
    size: 8,
    alignment: 4,
    type_0: FFI_TYPE_COMPLEX as u16,
    elements: ::core::ptr::addr_of_mut!(ffi_elements_complex_float) as *mut *mut ffi_type,
};
#[no_mangle]
pub static mut ffi_type_complex_double: ffi_type = _ffi_type {
    ...
    alignment: 8,
    type_0: FFI_TYPE_COMPLEX as u16,
    elements: ::core::ptr::addr_of_mut!(ffi_elements_complex_double) as *mut *mut ffi_type,
};
#[no_mangle]
pub static mut ffi_type_complex_longdouble: ffi_type = _ffi_type {
    ...
    alignment: 8,
    type_0: FFI_TYPE_COMPLEX as u16,
    elements: ::core::ptr::addr_of_mut!(ffi_elements_complex_longdouble) as *mut *mut ffi_type,
};
