...
pub type ffi_arg = ::core::ffi::c_ulonglong;
pub type ffi_sarg = ::core::ffi::c_longlong;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub union ffi_java_raw {
    pub sint: ::core::ffi::c_int,
    pub uint: ::core::ffi::c_uint,
    pub flt: ::core::ffi::c_float,
...
pub const FFI_SIZEOF_JAVA_RAW: ::core::ffi::c_int = 4 as ::core::ffi::c_int;
#[no_mangle]
        ...
        *args = raw as *mut ::core::ffi::c_void;
        raw = raw.offset(
            ((**tp).size.wrapping_sub(1 as size_t)
                | (::core::mem::size_of::<ffi_java_raw>() as size_t).wrapping_sub(1 as size_t))
            .wrapping_add(1 as size_t)
            .wrapping_div(::core::mem::size_of::<ffi_java_raw>() as size_t) as isize,
        );
        i = i.wrapping_add(1);
        tp = tp.offset(1);
        args = args.offset(1);
    ...
    while i < (*cif).nargs {
        match (**tp).type_0 as ::core::ffi::c_int {
            FFI_TYPE_UINT8 => {
                let fresh0 = raw;
                raw = raw.offset(1);
                (*fresh0).uint = *(*args as *mut UINT8) as ::core::ffi::c_uint;
            }
            FFI_TYPE_SINT8 => {
                let fresh1 = raw;
                raw = raw.offset(1);
                (*fresh1).sint = *(*args as *mut SINT8) as ::core::ffi::c_int;
            }
            FFI_TYPE_UINT16 => {
                let fresh2 = raw;
                raw = raw.offset(1);
                (*fresh2).uint = *(*args as *mut UINT16) as ::core::ffi::c_uint;
            }
            FFI_TYPE_SINT16 => {
                let fresh3 = raw;
                raw = raw.offset(1);
                (*fresh3).sint = *(*args as *mut SINT16) as ::core::ffi::c_int;
            }
            FFI_TYPE_UINT32 => {
                let fresh4 = raw;
                raw = raw.offset(1);
                (*fresh4).uint = *(*args as *mut UINT32) as ::core::ffi::c_uint;
            }
            FFI_TYPE_SINT32 => {
                let fresh5 = raw;
                raw = raw.offset(1);
                (*fresh5).sint = *(*args as *mut SINT32) as ::core::ffi::c_int;
            }
            FFI_TYPE_FLOAT => {
                let fresh6 = raw;
                raw = raw.offset(1);
            ...
            _ => {
                ...
                raw = raw.offset(
                    ((**tp).size.wrapping_sub(1 as size_t)
                        | (::core::mem::size_of::<ffi_java_raw>() as size_t)
                            .wrapping_sub(1 as size_t))
                    .wrapping_add(1 as size_t)
                    .wrapping_div(::core::mem::size_of::<ffi_java_raw>() as size_t)
                        as isize,
                );
            }
        }
