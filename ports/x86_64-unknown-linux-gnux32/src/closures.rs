...
unsafe fn atomic_load_relaxed_i32(p: *mut core::ffi::c_int) -> core::ffi::c_int {
...
unsafe fn atomic_store_release_i32(p: *mut core::ffi::c_int, v: core::ffi::c_int) {
    (&*p.cast::<AtomicI32>()).store(v, Ordering::Release)
}
unsafe fn atomic_load_acquire_usize(p: *mut usize) -> usize {
    (&*p.cast::<AtomicUsize>()).load(Ordering::Acquire)
}
unsafe fn atomic_store_release_usize(p: *mut usize, v: usize) {
...
unsafe extern "C" fn init_mparams() -> ::core::ffi::c_int {
    ...
    if mparams.magic == 0 as size_t {
        ...
        magic = (time(::core::ptr::null_mut::<time_t>())
            ^ 0x55555555 as ::core::ffi::c_uint as size_t as time_t) as size_t;
        magic |= 8 as ::core::ffi::c_uint as size_t;
        magic &= !(7 as ::core::ffi::c_uint as size_t);
        atomic_store_release_usize(&raw mut mparams.magic, magic);
    }
...
unsafe extern "C" fn sys_alloc(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
    ...
    (atomic_load_acquire_usize(&raw mut mparams.magic) != 0 as size_t || init_mparams() != 0)
        as ::core::ffi::c_int;
        ...
        if bytes <= MAX_SMALL_REQUEST {
                ...
                != 0 as ::core::ffi::c_uint
            {
                ...
                mem = (p as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as usize as isize)
                    as *mut ::core::ffi::c_void;
                current_block = 7119449015415511339;
                ...
                != 0
            {
                ...
                if (*p).head & PINUSE_BIT == 0 {
                    ...
                    if (*p).head & INUSE_BITS == 0 as size_t {
                        ...
                        current_block = 4816874432217190567;
                    } else {
                            ...
                            != 0
                        {
                            ...
                            current_block = 5795551367587702735;
                        }
                    }
                } else {
                    current_block = 10778260831612459202;
...
unsafe extern "C" fn dlmmap_locked(
    ...
    if execfd == -(1 as ::core::ffi::c_int) {
        open_temp_exec_file_opts_idx = 0 as ::core::ffi::c_int;
        current_block = 12603019444559903176;
    } else {
        current_block = 735147466149431745;
    }
    loop {
        match current_block {
            12603019444559903176 => {
