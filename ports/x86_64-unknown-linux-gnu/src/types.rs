...
// SysV x86-64 GNU/Linux stores an 80-bit x87 long double in a
// 16-byte, 16-byte-aligned slot. Rust has no stable matching scalar.
#[repr(C, align(16))]
pub struct x86_64_gnu_long_double_storage([u8; 16]);
#[no_mangle]
pub static mut ffi_type_longdouble: ffi_type = _ffi_type {
    size: ::core::mem::size_of::<x86_64_gnu_long_double_storage>() as size_t,
    alignment: ::core::mem::align_of::<x86_64_gnu_long_double_storage>() as ::core::ffi::c_ushort,
...
// C2Rust 0.22.1 cannot emit C complex-valued statics. Complex values are
// represented by a pair of their scalar element type on this ABI.
#[no_mangle]
...
pub static mut ffi_type_complex_longdouble: ffi_type = _ffi_type {
    size: (2 * ::core::mem::size_of::<x86_64_gnu_long_double_storage>()) as size_t,
    alignment: ::core::mem::align_of::<x86_64_gnu_long_double_storage>() as ::core::ffi::c_ushort,
    type_0: FFI_TYPE_COMPLEX as ::core::ffi::c_ushort,
