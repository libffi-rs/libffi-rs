...
pub static mut ffi_type_longdouble: ffi_type = _ffi_type {
    size: ::core::mem::size_of::<crate::F128>() as size_t,
...
// C2Rust 0.22.1 cannot emit C `_Complex` static initializers. These values
// reproduce this configured target's FFI_COMPLEX_TYPEDEF definitions.
#[no_mangle]
...
pub static mut ffi_type_complex_longdouble: ffi_type = _ffi_type {
    size: 2 * ::core::mem::size_of::<crate::F128>(),
    alignment: 16,
    type_0: FFI_TYPE_COMPLEX as ::core::ffi::c_ushort,
