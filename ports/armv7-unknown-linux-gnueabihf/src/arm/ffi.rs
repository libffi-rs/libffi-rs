extern "C" {
    ...
    fn abort() -> !;
    fn __clear_cache(begin: *mut ::core::ffi::c_void, end: *mut ::core::ffi::c_void);
...
pub const ARM_TRAMP_MAP_SIZE: ::core::ffi::c_int = (1 as ::core::ffi::c_int) << ARM_TRAMP_MAP_SHIFT;
...
unsafe extern "C" fn ffi_align(
    ...
    return ((p as size_t).wrapping_sub(1 as size_t) | alignment.wrapping_sub(1 as size_t))
...
unsafe extern "C" fn ffi_put_arg(
    ...
    match (*ty).type_0 as ::core::ffi::c_int {
        ...
        FFI_TYPE_INT | FFI_TYPE_SINT32 | FFI_TYPE_UINT32 | FFI_TYPE_POINTER | FFI_TYPE_FLOAT => {
...
unsafe extern "C" fn ffi_prep_args_SYSV(
    ...
    while i < n {
        ...
        argp = ffi_align(ty, argp as *mut ::core::ffi::c_void) as *mut ::core::ffi::c_char;
        argp = argp.offset(ffi_put_arg(
            ty,
...
unsafe extern "C" fn ffi_prep_args_VFP(
    ...
    let mut regp: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
    let mut eo_regp: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
    ...
    while i < n {
        ...
        if vi < (*cif).vfp_nargs as ::core::ffi::c_int && is_vfp_type != 0 {
            let fresh2 = vi;
            vi = vi + 1;
            let mut vfp_slot: *mut ::core::ffi::c_char = vfp_space.offset(
                ((*cif).vfp_args[fresh2 as usize] as ::core::ffi::c_int * 4 as ::core::ffi::c_int)
                    as isize,
            );
            ffi_put_arg(ty, a, vfp_slot as *mut ::core::ffi::c_void);
        } else {
            if done_with_regs == 0 && is_vfp_type == 0 {
                let mut tregp: *mut ::core::ffi::c_char =
                    ffi_align(ty, regp as *mut ::core::ffi::c_void) as *mut ::core::ffi::c_char;
                let mut size: size_t = (*ty).size;
                size = if size < 4 as size_t {
                    4 as size_t
                } else {
                    size
                };
                if tregp.offset(size as isize) <= eo_regp {
                    regp = tregp
                        .offset(ffi_put_arg(ty, a, tregp as *mut ::core::ffi::c_void) as isize);
                    done_with_regs = (regp == argp) as ::core::ffi::c_int as ::core::ffi::c_char;
            ...
            match current_block_18 {
                ...
                _ => {
                    stack_used = 1 as ::core::ffi::c_char;
                    argp =
                        ffi_align(ty, argp as *mut ::core::ffi::c_void) as *mut ::core::ffi::c_char;
                    argp =
                        argp.offset(ffi_put_arg(ty, a, argp as *mut ::core::ffi::c_void) as isize);
                }
            }
        }
        i += 1;
...
pub unsafe extern "C" fn ffi_prep_cif_machdep_var(
    ...
    if (*cif).abi as ::core::ffi::c_uint == FFI_VFP as ::core::ffi::c_int as ::core::ffi::c_uint {
        (*cif).abi = FFI_SYSV;
    }
...
unsafe extern "C" fn ffi_call_int(
    ...
    let mut vfp_space: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
    let mut new_rvalue: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
    ...
    if rvalue.is_null() {
        ...
        rsize = 32 as size_t;
    } else if flags == ARM_TYPE_INT && (*rtype).type_0 as ::core::ffi::c_int == FFI_TYPE_STRUCT {
        rsize = 4 as size_t;
    }
    ...
    // C's alloca satisfies the target stack alignment. Vec<u8> only promises
    // byte alignment; use u64 backing storage because call_frame and VFP data
    // require 8-byte alignment on arm-linux-gnueabihf.
    let allocation_bytes = vfp_size
        .wrapping_add(bytes)
        .wrapping_add(::core::mem::size_of::<call_frame>() as size_t)
        .wrapping_add(rsize) as usize;
    // ffi_call_SYSV replaces SP with `stack + 16`; reserve downward-growing
    // stack space before the argument area. C's alloca naturally had the
    // caller stack below it, whereas C2Rust's Vec emulation did not.
    const CALLEE_STACK_RESERVE: usize = 64 * 1024;
    let allocation_layout =
        ::std::alloc::Layout::from_size_align(allocation_bytes + CALLEE_STACK_RESERVE, 8).unwrap();
    let allocation_base = ::std::alloc::alloc_zeroed(allocation_layout);
    if allocation_base.is_null() {
        ::std::alloc::handle_alloc_error(allocation_layout);
    }
    stack = allocation_base.add(CALLEE_STACK_RESERVE).cast();
    ...
    if rsize != 0 {
        // Keep wide VFP return stores in a separately aligned scratch area.
        // `frame + 1` is only 4-byte aligned for this ARM call_frame layout.
        let return_layout = ::std::alloc::Layout::from_size_align(rsize as usize, 8).unwrap();
        new_rvalue = ::std::alloc::alloc_zeroed(return_layout).cast();
        if new_rvalue.is_null() {
            ::std::alloc::handle_alloc_error(return_layout);
        }
    }
    ...
    if !rvalue.is_null() && rvalue != new_rvalue as *mut ::core::ffi::c_void {
        memcpy(
            rvalue,
            (*frame).rvalue as *const ::core::ffi::c_void,
            (*rtype).size,
        );
    }
    // The assembly swaps SP, which prevents LLVM from reliably preserving the
    // heap base across the call. Deliberately retain this bounded backing stack.
    // See PORTING.md for the resulting ffi_call allocation limitation.
}
#[no_mangle]
...
unsafe extern "C" fn ffi_prep_incoming_args_VFP(
    ...
    while i < n {
        ...
        if vi < (*cif).vfp_nargs as ::core::ffi::c_int && is_vfp_type != 0 {
            ...
            *fresh6 = vfp_space.offset(
                ((*cif).vfp_args[fresh5 as usize] as ::core::ffi::c_int * 4 as ::core::ffi::c_int)
                    as isize,
...
pub unsafe extern "C" fn ffi_prep_closure_loc(
    ...
    let mut closure_func: unsafe extern "C" fn() = ffi_closure_SYSV;
    ...
    if ffi_tramp_is_present(closure.cast()) != 0 {
        closure_func = if closure_func as usize == ffi_closure_SYSV as usize {
        ...
        ffi_tramp_set_parms(
            ...
            closure_func as *mut ::core::ffi::c_void,
            closure.cast(),
        );
    } else {
        let tramp = (*closure).c2rust_unnamed.tramp.as_mut_ptr();
        memcpy(tramp.cast(), ffi_arm_trampoline.as_ptr().cast(), 8);
        __clear_cache(tramp.cast(), tramp.add(8).cast());
        __clear_cache(codeloc, codeloc.cast::<u8>().add(8).cast());
        tramp
            .add(8)
...
pub unsafe extern "C" fn ffi_prep_go_closure(
    ...
    let mut closure_func: Option<unsafe extern "C" fn() -> ()> =
...
unsafe extern "C" fn vfp_type_p(mut ty: *const ffi_type) -> ::core::ffi::c_int {
    ...
    return (ele_count << 8 as ::core::ffi::c_int | candidate as size_t) as ::core::ffi::c_int;
}
unsafe extern "C" fn place_vfp_arg(
    ...
    if reg as ::core::ffi::c_int & 1 as ::core::ffi::c_int != 0 && align == 2 as ::core::ffi::c_int
    {
    ...
    while reg as ::core::ffi::c_int + nregs <= 16 as ::core::ffi::c_int {
        ...
        match current_block_16 {
            ...
            _ => {
                ...
                if (*cif).vfp_used
                    & (1 as ::core::ffi::c_int) << (*cif).vfp_reg_free as ::core::ffi::c_int
                    != 0
                {
                    reg = (reg as ::core::ffi::c_int + nregs) as ::core::ffi::c_ushort;
                    while (*cif).vfp_used & (1 as ::core::ffi::c_int) << reg as ::core::ffi::c_int
                        != 0
                    {
...
unsafe extern "C" fn layout_vfp_args(mut cif: *mut ffi_cif) {
    ...
    memset(
        &raw mut (*cif).vfp_args as *mut ::core::ffi::c_schar as *mut ::core::ffi::c_void,
        -(1 as ::core::ffi::c_int),
        16 as size_t,
    );
