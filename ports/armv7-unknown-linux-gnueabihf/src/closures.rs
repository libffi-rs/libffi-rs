...
// C2Rust emitted removed core intrinsics for GCC __atomic builtins. Keep the
// generated storage layout and perform the same operations through stable atomics.
unsafe fn atomic_load_i32_relaxed(ptr: *mut ::core::ffi::c_int) -> ::core::ffi::c_int {
    (*(ptr.cast::<::core::sync::atomic::AtomicI32>())).load(::core::sync::atomic::Ordering::Relaxed)
}
unsafe fn atomic_exchange_i32_acquire(
    ptr: *mut ::core::ffi::c_int,
    value: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    (*(ptr.cast::<::core::sync::atomic::AtomicI32>()))
        .swap(value, ::core::sync::atomic::Ordering::Acquire)
}
unsafe fn atomic_store_i32_release(ptr: *mut ::core::ffi::c_int, value: ::core::ffi::c_int) {
    (*(ptr.cast::<::core::sync::atomic::AtomicI32>()))
        .store(value, ::core::sync::atomic::Ordering::Release)
}
unsafe fn atomic_load_usize_acquire(ptr: *mut usize) -> usize {
    (*(ptr.cast::<::core::sync::atomic::AtomicUsize>()))
        .load(::core::sync::atomic::Ordering::Acquire)
}
unsafe fn atomic_store_usize_release(ptr: *mut usize, value: usize) {
    (*(ptr.cast::<::core::sync::atomic::AtomicUsize>()))
        .store(value, ::core::sync::atomic::Ordering::Release)
}
unsafe extern "C" fn spin_acquire_lock(mut sl: *mut ::core::ffi::c_int) -> ::core::ffi::c_int {
    ...
    while atomic_load_i32_relaxed(sl) != 0 as ::core::ffi::c_int
        || atomic_exchange_i32_acquire(sl, 1 as ::core::ffi::c_int) != 0
    {
        spins += 1;
...
unsafe extern "C" fn init_mparams() -> ::core::ffi::c_int {
    if atomic_exchange_i32_acquire(&raw mut malloc_global_mutex, 1 as ::core::ffi::c_int) != 0 {
    ...
    if mparams.magic == 0 as size_t {
        ...
        atomic_store_usize_release(&raw mut mparams.magic, magic);
    }
    atomic_store_i32_release(&raw mut malloc_global_mutex, 0);
    return 1 as ::core::ffi::c_int;
}
...
unsafe extern "C" fn sys_alloc(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
    ...
    (atomic_load_usize_acquire(&raw mut mparams.magic) != 0 as size_t || init_mparams() != 0)
        as ::core::ffi::c_int;
    ...
    if HAVE_MORECORE != 0 && tbase == CMFAIL {
        if asize < HALF_MAX_SIZE_T {
            ...
            if atomic_exchange_i32_acquire(&raw mut malloc_global_mutex, 1 as ::core::ffi::c_int)
                != 0
            {
                spin_acquire_lock(&raw mut malloc_global_mutex);
            } else {
...
unsafe extern "C" fn dlmalloc(mut bytes: size_t) -> *mut ::core::ffi::c_void {
    ...
    if if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
        if atomic_exchange_i32_acquire(&raw mut _gm_.mutex, 1 as ::core::ffi::c_int) != 0 {
    ...
    } == 0
    {
        ...
        if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
            atomic_store_i32_release(&raw mut _gm_.mutex, 0);
        }
        return mem;
    } else {
        return ::core::ptr::null_mut::<::core::ffi::c_void>();
    ...
    if bytes >= (MAX_REQUEST as usize).wrapping_sub(alignment as usize) {
        ...
        if !mem.is_null() {
            ...
            if if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
                if atomic_exchange_i32_acquire(&raw mut (*m).mutex, 1 as ::core::ffi::c_int) != 0 {
            ...
            if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
                atomic_store_i32_release(&raw mut (*m).mutex, 0);
            }
        }
    }
    return mem;
