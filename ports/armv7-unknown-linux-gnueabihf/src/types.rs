...
pub static mut ffi_type_longdouble: ffi_type = _ffi_type {
    // arm-linux-gnueabihf GCC defines __SIZEOF_LONG_DOUBLE__=8 and
    // __LDBL_MANT_DIG__=53: long double has the binary64 ABI here.
    size: ::core::mem::size_of::<::core::ffi::c_double>() as size_t,
    alignment: 8 as ::core::ffi::c_uint as ::core::ffi::c_ushort,
    type_0: 3 as ::core::ffi::c_ushort,
    elements: ::core::ptr::null::<*mut _ffi_type>() as *mut *mut _ffi_type,
...
// C2Rust 0.22.1 cannot emit C complex-valued initializers. These are the
// target-specific equivalents of FFI_TYPEDEF/FFI_COMPLEX_TYPEDEF in types.c.
#[no_mangle]
