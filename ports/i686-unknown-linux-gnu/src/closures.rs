...
trait AtomicCompat: Copy {
    unsafe fn load_relaxed(ptr: *mut Self) -> Self;
    unsafe fn load_acquire(ptr: *mut Self) -> Self;
    unsafe fn exchange_acquire(ptr: *mut Self, value: Self) -> Self;
    unsafe fn store_release(ptr: *mut Self, value: Self);
}
macro_rules! impl_atomic_compat {
    ($value:ty, $atomic:ty) => {
        impl AtomicCompat for $value {
            unsafe fn load_relaxed(ptr: *mut Self) -> Self {
                (&*ptr.cast::<$atomic>()).load(::core::sync::atomic::Ordering::Relaxed)
            }
            unsafe fn load_acquire(ptr: *mut Self) -> Self {
                (&*ptr.cast::<$atomic>()).load(::core::sync::atomic::Ordering::Acquire)
            }
            unsafe fn exchange_acquire(ptr: *mut Self, value: Self) -> Self {
                (&*ptr.cast::<$atomic>()).swap(value, ::core::sync::atomic::Ordering::Acquire)
            }
            unsafe fn store_release(ptr: *mut Self, value: Self) {
                (&*ptr.cast::<$atomic>()).store(value, ::core::sync::atomic::Ordering::Release)
            }
        }
    };
}
impl_atomic_compat!(i32, ::core::sync::atomic::AtomicI32);
impl_atomic_compat!(usize, ::core::sync::atomic::AtomicUsize);
unsafe fn atomic_load_relaxed<T: AtomicCompat>(ptr: *mut T) -> T {
    T::load_relaxed(ptr)
}
unsafe fn atomic_load_acquire<T: AtomicCompat>(ptr: *mut T) -> T {
    T::load_acquire(ptr)
}
unsafe fn atomic_xchg_acquire<T: AtomicCompat>(ptr: *mut T, value: T) -> T {
    T::exchange_acquire(ptr, value)
}
unsafe fn atomic_store_release<T: AtomicCompat>(ptr: *mut T, value: T) {
...
pub union C2RustUnnamed_0 {
    pub __elision_data: C2RustUnnamed_1,
...
pub const PAX_EMUTRAMP: C2RustUnnamed_5 = 2;
pub const PAX_MPROTECT: C2RustUnnamed_5 = 1;
...
pub const MIN_CHUNK_SIZE: ::core::ffi::c_uint = MCHUNK_SIZE
    .wrapping_add(CHUNK_ALIGN_MASK as ::core::ffi::c_uint)
    & !(CHUNK_ALIGN_MASK as ::core::ffi::c_uint);
...
pub const MIN_REQUEST: ::core::ffi::c_uint = MIN_CHUNK_SIZE
    ...
    .wrapping_sub(SIZE_T_ONE as ::core::ffi::c_uint);
...
pub const FENCEPOST_HEAD: ::core::ffi::c_uint = INUSE_BITS as ::core::ffi::c_uint | SIZE_T_SIZE;
...
unsafe extern "C" fn sys_alloc(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
    ...
    (atomic_load_acquire(&raw mut mparams.magic) != 0 as size_t || init_mparams() != 0)
        as ::core::ffi::c_int;
...
unsafe extern "C" fn sys_trim(mut m: mstate, mut pad: size_t) -> ::core::ffi::c_int {
    ...
    if pad < MAX_REQUEST as usize && !(*m).top.is_null() {
        pad = (pad as ::core::ffi::c_uint).wrapping_add(
            ...
            .wrapping_add(MIN_CHUNK_SIZE as size_t) as ::core::ffi::c_uint,
        ) as size_t as size_t;
        if (*m).topsize > pad {
        ...
        if bytes <= MAX_SMALL_REQUEST {
                ...
                != 0 as ::core::ffi::c_uint
            {
                ...
                mem = (p as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as usize as isize)
                    as *mut ::core::ffi::c_void;
                current_block = 15555816920916866559;
                ...
                != 0
            {
                ...
                if (*p).head & PINUSE_BIT == 0 {
                    ...
                    if (*p).head & INUSE_BITS == 0 as size_t {
                        ...
                        current_block = 16319921603609123620;
                    } else {
                            ...
                            != 0
                        {
                            ...
                            current_block = 10741211225805945432;
                        }
                    }
                } else {
                    current_block = 10778260831612459202;
...
static mut open_temp_exec_file_mutex: pthread_mutex_t = pthread_mutex_t {
    __data: __pthread_mutex_s {
        ...
        c2rust_unnamed: C2RustUnnamed_0 {
            __elision_data: C2RustUnnamed_1 {
                __espins: 0 as ::core::ffi::c_short,
                __eelision: 0 as ::core::ffi::c_short,
            },
        },
    },
};
...
static mut open_temp_exec_file_opts: [C2RustUnnamed_2; 9] = unsafe {
    [
        C2RustUnnamed_2 {
            func: Some(
...
unsafe extern "C" fn open_temp_exec_file_opts_next() -> ::core::ffi::c_int {
    ...
    if open_temp_exec_file_opts_idx as usize
        == (::core::mem::size_of::<[C2RustUnnamed_2; 9]>() as usize)
...
unsafe extern "C" fn dlmmap_locked(
    ...
    if execfd == -(1 as ::core::ffi::c_int) {
        open_temp_exec_file_opts_idx = 0 as ::core::ffi::c_int;
        current_block = 739213692347969199;
    } else {
