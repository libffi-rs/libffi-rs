...
pub const O_TMPFILE: ::core::ffi::c_int = 0o20040000 as ::core::ffi::c_int;
...
pub const SIZE_T_SIZE: ::core::ffi::c_uint =
    ::core::mem::size_of::<size_t>() as ::core::ffi::c_uint;
...
pub const TWO_SIZE_T_SIZES: ::core::ffi::c_uint = SIZE_T_SIZE << 1 as ::core::ffi::c_int;
...
pub const MCHUNK_SIZE: ::core::ffi::c_uint =
    ::core::mem::size_of::<mchunk>() as ::core::ffi::c_uint;
pub const CHUNK_OVERHEAD: ::core::ffi::c_uint =
    ::core::mem::size_of::<size_t>() as ::core::ffi::c_uint;
pub const MMAP_FOOT_PAD: usize = (SIZE_T_SIZE as usize) << 2 as ::core::ffi::c_int;
pub const MIN_CHUNK_SIZE: ::core::ffi::c_uint =
    MCHUNK_SIZE.wrapping_add(CHUNK_ALIGN_MASK) & !CHUNK_ALIGN_MASK;
pub const MAX_REQUEST: ::core::ffi::c_uint =
    MIN_CHUNK_SIZE.wrapping_neg() << 2 as ::core::ffi::c_int;
pub const MIN_REQUEST: ::core::ffi::c_uint = MIN_CHUNK_SIZE
...
pub const FENCEPOST_HEAD: ::core::ffi::c_uint = INUSE_BITS | SIZE_T_SIZE;
...
unsafe extern "C" fn init_mparams() -> ::core::ffi::c_int {
    ...
    if mparams.magic == 0 as size_t {
        ...
        gsize = if sysconf(_SC_PAGE_SIZE) as size_t != 0 as size_t {
            sysconf(_SC_PAGE_SIZE) as size_t
        } else {
            psize
        };
        ...
        magic = (time(::core::ptr::null_mut::<time_t>())
            ^ 0x55555555 as ::core::ffi::c_uint as time_t) as size_t;
        magic |= 8 as ::core::ffi::c_uint;
        magic &= !(7 as ::core::ffi::c_uint);
                    ...
                    if (*T).head & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT) != qsize {
                        let mut C: *mut tchunkptr =
                            (&raw mut (*T).child as *mut *mut malloc_tree_chunk).offset(
                                (K_0 >> SIZE_T_BITSIZE.wrapping_sub(SIZE_T_ONE as usize)
...
unsafe extern "C" fn sys_trim(mut m: mstate, mut pad: size_t) -> ::core::ffi::c_int {
    ...
    if (pad as usize) < MAX_REQUEST as usize && !(*m).top.is_null() {
        pad = (pad as ::core::ffi::c_uint).wrapping_add(
            ...
            .wrapping_add(MIN_CHUNK_SIZE as usize) as ::core::ffi::c_uint,
        ) as size_t as size_t;
        if (*m).topsize > pad {
...
unsafe extern "C" fn tmalloc_large(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
    ...
    if !t.is_null() {
        ...
        loop {
            ...
            t = (*t).child[(sizebits >> SIZE_T_BITSIZE.wrapping_sub(SIZE_T_ONE as usize)
        ...
        if bytes as usize <= MAX_SMALL_REQUEST {
                ...
                != 0 as ::core::ffi::c_uint
            {
                ...
                mem = (p as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as usize as isize)
                    as *mut ::core::ffi::c_void;
                current_block = 16921960570293508356;
                ...
                != 0
            {
                ...
                if (*p).head & PINUSE_BIT == 0 {
                    ...
                    if (*p).head & INUSE_BITS == 0 as size_t {
                        ...
                        current_block = 17450892800646874608;
                    } else {
                            ...
                            != 0
                        {
                            ...
                            current_block = 5703887477079909636;
                        }
                    }
                } else {
                    current_block = 10778260831612459202;
...
unsafe extern "C" fn allocate_space(
    ...
    while len > 0 as off_t {
        let mut to_write: off_t = if len < page_size as off_t {
            len
        } else {
            page_size as off_t
        };
...
unsafe extern "C" fn dlmmap_locked(
    ...
    if execfd == -(1 as ::core::ffi::c_int) {
        open_temp_exec_file_opts_idx = 0 as ::core::ffi::c_int;
        current_block = 9134561224428637556;
    } else {
...
pub unsafe extern "C" fn ffi_closure_alloc(
    size: size_t,
    code: *mut *mut ::core::ffi::c_void,
) -> *mut ::core::ffi::c_void {
    if code.is_null() || size > 4096 {
        return NULL;
    }
    // Linux/musl closure pages must be writable while preparing the dynamic
    // trampoline and executable when called. Keep one self-contained mapping.
    let ptr = mmap(
        NULL,
        4096,
...
#[no_mangle]
pub unsafe extern "C" fn ffi_closure_free(ptr: *mut ::core::ffi::c_void) {
    if !ptr.is_null() {
        munmap(ptr, 4096);
    }
}
