...
// AArch64 musl uses IEEE binary128 long double. Rust has no stable C ABI
// long-double scalar; this type preserves its 16-byte size and alignment.
#[repr(C, align(16))]
pub struct aarch64_musl_long_double([u8; 16]);

#[no_mangle]
pub static mut ffi_type_longdouble: ffi_type = _ffi_type {
    size: ::core::mem::size_of::<aarch64_musl_long_double>() as size_t,
...
// C2Rust 0.22.1 cannot translate C complex-valued statics. A C complex
// value is represented by two scalar components on this target.
#[no_mangle]
...
pub static mut ffi_type_complex_longdouble: ffi_type = _ffi_type {
    size: 2 * ::core::mem::size_of::<aarch64_musl_long_double>(),
    alignment: ::core::mem::align_of::<aarch64_musl_long_double>() as ::core::ffi::c_ushort,
    type_0: FFI_TYPE_COMPLEX as ::core::ffi::c_ushort,
