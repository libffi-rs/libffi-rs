...
#[inline]
unsafe fn ffi_clear_cache(start: *mut ::core::ffi::c_void, end: *mut ::core::ffi::c_void) {
    ffi_rs_clear_cache(start, end);
}
extern "C" {
    fn abort() -> !;
    fn ffi_rs_clear_cache(start: *mut ::core::ffi::c_void, end: *mut ::core::ffi::c_void);
    fn ffi_call_SYSV(
    ...
    fn ffi_closure_SYSV_V_alt();
    fn ffi_go_closure_SYSV();
    fn ffi_go_closure_SYSV_V();
    fn memcpy(
        _: *mut ::core::ffi::c_void,
        _: *const ::core::ffi::c_void,
        _: size_t,
    ) -> *mut ::core::ffi::c_void;
    fn ffi_data_to_code_pointer(data: *mut ::core::ffi::c_void) -> *mut ::core::ffi::c_void;
...
unsafe extern "C" fn is_vfp_type(mut ty: *const ffi_type) -> ::core::ffi::c_int {
    ...
    match candidate {
        ...
        FFI_TYPE_STRUCT => {
            ...
            match candidate {
                FFI_TYPE_FLOAT => {
                    ele_count = (size as usize)
                        .wrapping_div(::core::mem::size_of::<::core::ffi::c_float>() as usize)
                        as size_t;
                    if size as usize
                        != (ele_count as usize)
                ...
                FFI_TYPE_LONGDOUBLE => {
                    ele_count = (size as usize)
                        .wrapping_div(::core::mem::size_of::<u128>() as usize)
                        as size_t;
                    if size as usize
                        != (ele_count as usize)
                            .wrapping_mul(::core::mem::size_of::<u128>() as usize)
                    {
                        return 0 as ::core::ffi::c_int;
                    }
                }
...
unsafe extern "C" fn allocate_int_to_reg_or_stack(
    ...
    if (*state).ngrn < N_X_ARG_REG as ::core::ffi::c_uint {
        let fresh1 = (*state).ngrn;
        (*state).ngrn = (*state).ngrn.wrapping_add(1);
        return (&raw mut (*context).x as *mut UINT64).offset(fresh1 as isize) as *mut UINT64
...
unsafe extern "C" fn allocate_int128_to_reg_or_stack(
    ...
    ngrn = ngrn.wrapping_add(ngrn & 1 as ::core::ffi::c_uint);
...
pub unsafe extern "C" fn ffi_prep_cif_machdep_var(
    ...
    (*cif).flags |= AARCH64_FLAG_VARARG as ::core::ffi::c_uint;
    return status;
}
unsafe extern "C" fn ffi_call_int(
    ...
    let mut alloca_allocations: Vec<Vec<u128>> = Vec::new();
    ...
    let allocation_bytes = CALLEE_STACK_RESERVE
        .wrapping_add(::core::mem::size_of::<call_context>())
        .wrapping_add(stack_bytes as usize)
        .wrapping_add(40)
        .wrapping_add(rsize as usize);
    alloca_allocations.push(::std::vec::from_elem(
        0_u128,
        allocation_bytes.div_ceil(::core::mem::size_of::<u128>()),
    ));
    context = (alloca_allocations.last_mut().unwrap().as_mut_ptr() as *mut u8)
        .add(CALLEE_STACK_RESERVE) as *mut call_context;
    stack = context.offset(1 as ::core::ffi::c_int as isize) as *mut ::core::ffi::c_void;
    frame = (stack as uintptr_t).wrapping_add(stack_bytes) as *mut ::core::ffi::c_void;
    rvalue = if rsize != 0 {
        (frame as uintptr_t).wrapping_add(40 as uintptr_t) as *mut ::core::ffi::c_void
    } else {
        orig_rvalue
    };
    ...
    while i < nargs {
        ...
        match t {
            ...
            | FFI_TYPE_POINTER => {
                current_block_57 = 9155758410681453652;
            }
            FFI_TYPE_UINT128 | FFI_TYPE_SINT128 => {
        ...
        match current_block_57 {
            9155758410681453652 => {
                ...
                if state.ngrn < N_X_ARG_REG as ::core::ffi::c_uint {
                    let fresh0 = state.ngrn;
                    state.ngrn = state.ngrn.wrapping_add(1);
                    (*context).x[fresh0 as usize] = ext as UINT64;
                } else {
                    let mut d: *mut ::core::ffi::c_void =
                        allocate_to_stack(&raw mut state, stack, (*ty).alignment as size_t, s);
                    state.ngrn = N_X_ARG_REG as ::core::ffi::c_uint;
                    *(d as *mut ffi_arg) = ext;
                }
            }
            _ => {}
        }
...
pub unsafe extern "C" fn ffi_prep_closure_loc(
    ...
    let mut tramp_code: *mut ::core::ffi::c_uchar = ::core::ptr::null_mut::<::core::ffi::c_uchar>();
    ...
    static mut trampoline: [::core::ffi::c_uchar; 16] = [
    ...
    if ffi_tramp_is_present(closure as *mut ::core::ffi::c_void) != 0 {
        if start == Some(ffi_closure_SYSV_V as unsafe extern "C" fn() -> ()) {
            start = Some(ffi_closure_SYSV_V_alt as unsafe extern "C" fn() -> ())
                as Option<unsafe extern "C" fn() -> ()>;
        } else {
            start = Some(ffi_closure_SYSV_alt as unsafe extern "C" fn() -> ())
                as Option<unsafe extern "C" fn() -> ()>;
        }
        ffi_tramp_set_parms(
        ...
        *(tramp.offset(16 as ::core::ffi::c_int as isize) as *mut UINT64) =
            ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, uintptr_t>(start)
                as UINT64;
        ffi_clear_cache(
            tramp as *mut ::core::ffi::c_void,
            tramp.offset(FFI_TRAMPOLINE_SIZE as isize) as *mut ::core::ffi::c_void,
        );
        tramp_code = ffi_data_to_code_pointer(tramp as *mut ::core::ffi::c_void)
            as *mut ::core::ffi::c_uchar;
        ffi_clear_cache(
            tramp_code as *mut ::core::ffi::c_void,
            tramp_code.offset(FFI_TRAMPOLINE_SIZE as isize) as *mut ::core::ffi::c_void,
        );
    }
    (*closure).cif = cif;
    (*closure).fun = fun;
...
pub unsafe extern "C" fn ffi_prep_go_closure(
    ...
    if (*cif).flags & AARCH64_FLAG_ARG_V as ::core::ffi::c_uint != 0 {
        start = Some(ffi_go_closure_SYSV_V as unsafe extern "C" fn() -> ())
            as Option<unsafe extern "C" fn() -> ()>;
    } else {
        start = Some(ffi_go_closure_SYSV as unsafe extern "C" fn() -> ())
            as Option<unsafe extern "C" fn() -> ()>;
    }
...
pub unsafe extern "C" fn ffi_closure_SYSV_inner(
    ...
    let mut alloca_allocations: Vec<Vec<usize>> = Vec::new();
    alloca_allocations.push(::std::vec::from_elem(0, (*cif).nargs as usize));
    ...
    while i < nargs {
        ...
        match t {
            ...
            | FFI_TYPE_UINT32 | FFI_TYPE_SINT32 | FFI_TYPE_UINT64 | FFI_TYPE_SINT64
            | FFI_TYPE_POINTER => {
                let ref mut fresh2 = *avalue.offset(i as isize);
                *fresh2 = allocate_int_to_reg_or_stack(context, &raw mut state, stack, s);
            }
            FFI_TYPE_UINT128 | FFI_TYPE_SINT128 => {
                let ref mut fresh3 = *avalue.offset(i as isize);
                *fresh3 = allocate_int128_to_reg_or_stack(context, &raw mut state, stack);
            }
            FFI_TYPE_FLOAT | FFI_TYPE_DOUBLE | FFI_TYPE_LONGDOUBLE | FFI_TYPE_STRUCT
            | FFI_TYPE_COMPLEX => {
                h = is_vfp_type(ty);
                if h != 0 {
                        ...
                        && isvariadic != 0
                    {
                        if (state.ngrn as size_t).wrapping_add(n) <= N_X_ARG_REG as size_t {
                            ...
                            *fresh4 = compress_hfa_type(reg, reg, h);
                        } else {
                            state.ngrn = N_X_ARG_REG as ::core::ffi::c_uint;
                            state.nsrn = N_V_ARG_REG as ::core::ffi::c_uint;
                            let ref mut fresh5 = *avalue.offset(i as isize);
                            *fresh5 = allocate_to_stack(
                                &raw mut state,
                                stack,
                                (*ty).alignment as size_t,
                                s,
                        ...
                        *fresh6 = compress_hfa_type(reg_0, reg_0, h);
                    } else {
                        state.nsrn = N_V_ARG_REG as ::core::ffi::c_uint;
                    ...
                    *fresh8 = *(allocate_int_to_reg_or_stack(
                        context,
                        &raw mut state,
                        stack,
                    ...
                    if (state.ngrn as size_t).wrapping_add(n) <= N_X_ARG_REG as size_t {
                        ...
                        *fresh9 = (&raw mut (*context).x as *mut UINT64).offset(state.ngrn as isize)
                            as *mut UINT64
                            as *mut ::core::ffi::c_void;
                        state.ngrn = state.ngrn.wrapping_add(n as ::core::ffi::c_uint);
                    } else {
...
pub unsafe extern "C" fn ffi_tramp_arch(
    ...
    *tramp_size = AARCH64_TRAMP_SIZE as size_t;
    *map_size = AARCH64_TRAMP_MAP_SIZE as size_t;
...
pub const AARCH64_TRAMP_MAP_SHIFT: ::core::ffi::c_int = 14 as ::core::ffi::c_int;
pub const AARCH64_TRAMP_MAP_SIZE: ::core::ffi::c_int =
    (1 as ::core::ffi::c_int) << AARCH64_TRAMP_MAP_SHIFT;
pub const AARCH64_TRAMP_SIZE: ::core::ffi::c_int = 32 as ::core::ffi::c_int;
