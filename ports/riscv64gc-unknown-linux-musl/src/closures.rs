...
unsafe fn atomic_i32_load_relaxed(p: *mut core::ffi::c_int) -> core::ffi::c_int {
    (*(p.cast::<AtomicI32>())).load(Ordering::Relaxed)
}
unsafe fn atomic_i32_swap_acquire(
    p: *mut core::ffi::c_int,
    v: core::ffi::c_int,
) -> core::ffi::c_int {
    (*(p.cast::<AtomicI32>())).swap(v, Ordering::Acquire)
}
unsafe fn atomic_i32_store_release(p: *mut core::ffi::c_int, v: core::ffi::c_int) {
    (*(p.cast::<AtomicI32>())).store(v, Ordering::Release)
}
unsafe fn atomic_ulong_load_acquire(p: *mut core::ffi::c_ulong) -> core::ffi::c_ulong {
    (*(p.cast::<AtomicU64>())).load(Ordering::Acquire)
}
unsafe fn atomic_ulong_store_release(p: *mut core::ffi::c_ulong, v: core::ffi::c_ulong) {
...
pub union C2RustUnnamed_0 {
    pub __i: [::core::ffi::c_int; 10],
    pub __vi: [::core::ffi::c_int; 10],
    pub __p: [*mut ::core::ffi::c_void; 5],
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const HALF_MAX_SIZE_T: ::core::ffi::c_ulong =
    MAX_SIZE_T.wrapping_div(2 as ::core::ffi::c_ulong);
...
unsafe extern "C" fn spin_acquire_lock(mut sl: *mut ::core::ffi::c_int) -> ::core::ffi::c_int {
    ...
    while atomic_i32_load_relaxed(sl) != 0 as ::core::ffi::c_int
        || atomic_i32_swap_acquire(sl, 1 as ::core::ffi::c_int) != 0
    {
        spins += 1;
...
pub const MIN_CHUNK_SIZE: ::core::ffi::c_ulong =
    MCHUNK_SIZE.wrapping_add(CHUNK_ALIGN_MASK) & !CHUNK_ALIGN_MASK;
...
pub const FENCEPOST_HEAD: ::core::ffi::c_ulong = INUSE_BITS | SIZE_T_SIZE;
...
pub const MAX_SMALL_REQUEST: usize = (MAX_SMALL_SIZE as usize)
    ...
    .wrapping_sub(CHUNK_OVERHEAD as usize);
...
unsafe extern "C" fn init_mparams() -> ::core::ffi::c_int {
    if atomic_i32_swap_acquire(&raw mut malloc_global_mutex, 1 as ::core::ffi::c_int) != 0 {
        spin_acquire_lock(&raw mut malloc_global_mutex);
    } else {
    };
    if mparams.magic == 0 as ::core::ffi::c_ulong {
        let mut magic: size_t = 0;
        let mut psize: size_t = 0;
        let mut gsize: size_t = 0;
        psize = sysconf(_SC_PAGE_SIZE) as size_t;
        gsize = (if sysconf(_SC_PAGE_SIZE) as size_t != 0 as ::core::ffi::c_ulong {
            sysconf(_SC_PAGE_SIZE) as ::core::ffi::c_ulong
        } else {
            psize as ::core::ffi::c_ulong
        }) as size_t;
        if ::core::mem::size_of::<size_t>() as usize
            != ::core::mem::size_of::<*mut ::core::ffi::c_char>() as usize
            || (MAX_SIZE_T as usize) < MIN_CHUNK_SIZE as usize
            ...
            || MCHUNK_SIZE as usize & (MCHUNK_SIZE as usize).wrapping_sub(SIZE_T_ONE as usize)
                != 0 as usize
            || gsize & gsize.wrapping_sub(SIZE_T_ONE) != 0 as ::core::ffi::c_ulong
            || psize & psize.wrapping_sub(SIZE_T_ONE) != 0 as ::core::ffi::c_ulong
        {
            abort();
        }
        ...
        mparams.default_mflags = (USE_LOCK_BIT as ::core::ffi::c_ulong
            | USE_MMAP_BIT
            | USE_NONCONTIGUOUS_BIT as ::core::ffi::c_ulong)
            as flag_t;
        ...
        magic |= 8 as ::core::ffi::c_uint as size_t as ::core::ffi::c_ulong;
        magic &= !(7 as ::core::ffi::c_uint as size_t) as ::core::ffi::c_ulong;
        atomic_ulong_store_release(&raw mut mparams.magic, magic);
    }
    atomic_i32_store_release(&raw mut malloc_global_mutex, 0);
    return 1 as ::core::ffi::c_int;
}
unsafe extern "C" fn mmap_alloc(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
    ...
    if (*m).footprint_limit != 0 as ::core::ffi::c_ulong {
    ...
    if mmsize > nb {
        ...
        if mm != CMFAIL {
            ...
            (*((p as *mut ::core::ffi::c_char).offset(psize as isize) as mchunkptr)).head =
                FENCEPOST_HEAD as usize as size_t;
            ...
            (*m).footprint = ((*m).footprint as ::core::ffi::c_ulong)
                .wrapping_add(mmsize as ::core::ffi::c_ulong) as size_t
                as size_t;
...
unsafe extern "C" fn mmap_resize(
    ...
    if nb >> SMALLBIN_SHIFT < NSMALLBINS as ::core::ffi::c_ulong {
        return ::core::ptr::null_mut::<malloc_chunk>();
    }
    if oldsize as usize >= (nb as usize).wrapping_add(SIZE_T_SIZE as usize)
        && oldsize.wrapping_sub(nb) <= mparams.granularity << 1 as ::core::ffi::c_int
    {
        ...
        if cp != CMFAIL {
            ...
            (*m).footprint = ((*m).footprint as ::core::ffi::c_ulong)
                .wrapping_add(newmmsize.wrapping_sub(oldmmsize) as ::core::ffi::c_ulong)
                as size_t as size_t;
            if (*m).footprint > (*m).max_footprint {
                (*m).max_footprint = (*m).footprint;
            }
...
unsafe extern "C" fn init_top(mut m: mstate, mut p: mchunkptr, mut psize: size_t) {
    ...
    psize = (psize as ::core::ffi::c_ulong).wrapping_sub(offset as ::core::ffi::c_ulong) as size_t
        as size_t;
    (*m).top = p;
    (*m).topsize = psize;
    ...
    (*((p as *mut ::core::ffi::c_char).offset(psize as isize) as mchunkptr)).head =
        ...
        .wrapping_add(MIN_CHUNK_SIZE as usize) as size_t;
...
unsafe extern "C" fn prepend_alloc(
            ...
            == 0 as ::core::ffi::c_ulong
        {
            ...
            MALLOC_ALIGNMENT.wrapping_sub(
                newbase.offset(
                    ((::core::mem::size_of::<size_t>() as usize) << 1 as ::core::ffi::c_int)
                        as isize,
                ) as *mut ::core::ffi::c_void as ::core::ffi::c_ulong
                    & CHUNK_ALIGN_MASK,
            ) & CHUNK_ALIGN_MASK
        }) as isize,
    ) as mchunkptr;
    ...
    if oldfirst == (*m).top {
        (*m).topsize = ((*m).topsize as ::core::ffi::c_ulong)
            .wrapping_add(qsize as ::core::ffi::c_ulong) as size_t as size_t;
        let mut tsize: size_t = (*m).topsize;
        (*m).top = q;
        (*q).head = tsize | PINUSE_BIT;
    } else if oldfirst == (*m).dv {
        (*m).dvsize = ((*m).dvsize as ::core::ffi::c_ulong)
            .wrapping_add(qsize as ::core::ffi::c_ulong) as size_t as size_t;
        ...
        if !((*oldfirst).head & INUSE_BITS != PINUSE_BIT) {
            ...
            if nsize >> SMALLBIN_SHIFT < NSMALLBINS as ::core::ffi::c_ulong {
            ...
            qsize = (qsize as ::core::ffi::c_ulong).wrapping_add(nsize as ::core::ffi::c_ulong)
                as size_t as size_t;
        }
        (*oldfirst).head &= !PINUSE_BIT as ::core::ffi::c_ulong;
        (*q).head = qsize | PINUSE_BIT;
        (*((q as *mut ::core::ffi::c_char).offset(qsize as isize) as mchunkptr)).prev_foot = qsize;
        if qsize >> SMALLBIN_SHIFT < NSMALLBINS as ::core::ffi::c_ulong {
            ...
            if X == 0 as ::core::ffi::c_uint {
                ...
                I_1 = ((K << 1 as ::core::ffi::c_int) as ::core::ffi::c_ulong).wrapping_add(
                    qsize as ::core::ffi::c_ulong
...
unsafe extern "C" fn add_segment(
    ...
    *ss = (*m).seg as malloc_segment;
    (*m).seg.base = tbase;
    (*m).seg.size = tsize;
    if mmapped as ::core::ffi::c_ulong != USE_MMAP_BIT {
        abort();
    } else {
        (*m).seg.exec_offset = *((*m)
            .seg
            ...
            != (*m).seg.exec_offset
        {
            ...
            let ref mut fresh5 = *((*m)
                .seg
                .base
                .offset((*m).seg.size as isize)
                .offset(-(::core::mem::size_of::<ptrdiff_t>() as usize as isize))
                as *mut ptrdiff_t);
            *fresh5 = 0 as ptrdiff_t;
        };
    };
    ...
    loop {
        let mut nextp: mchunkptr = (p as *mut ::core::ffi::c_char)
            ...
            as mchunkptr;
        (*p).head = FENCEPOST_HEAD as usize as size_t;
        nfences += 1;
        ...
        if psize >> SMALLBIN_SHIFT < NSMALLBINS as ::core::ffi::c_ulong {
            ...
            if X == 0 as ::core::ffi::c_uint {
                ...
                let mut K: ::core::ffi::c_uint = (::core::mem::size_of::<::core::ffi::c_uint>()
                    ...
                    .wrapping_sub(1 as ::core::ffi::c_uint)
                    .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
                I_0 = ((K << 1 as ::core::ffi::c_int) as ::core::ffi::c_ulong).wrapping_add(
                    psize as ::core::ffi::c_ulong
                        >> K.wrapping_add(TREEBIN_SHIFT.wrapping_sub(1 as ::core::ffi::c_uint))
                        & 1 as ::core::ffi::c_ulong,
                ) as bindex_t;
...
unsafe extern "C" fn sys_alloc(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
    ...
    (atomic_ulong_load_acquire(&raw mut mparams.magic) != 0 as ::core::ffi::c_ulong
        || init_mparams() != 0) as ::core::ffi::c_int;
    if (*m).mflags as size_t & USE_MMAP_BIT != 0
        && nb >= mparams.mmap_threshold
        && (*m).topsize != 0 as ::core::ffi::c_ulong
    {
        ...
        if ss.is_null() {
            ...
            if base != CMFAIL {
                ...
                if !(base as size_t & mparams.page_size.wrapping_sub(SIZE_T_ONE)
                    == 0 as ::core::ffi::c_ulong)
                {
                    ssize = (ssize as ::core::ffi::c_ulong).wrapping_add(
                ...
                if ssize > nb
                    ...
                    && ((*m).footprint_limit == 0 as ::core::ffi::c_ulong
                ...
                if ssize < HALF_MAX_SIZE_T
                    && (ssize as usize)
                        < (nb as usize).wrapping_add(
                            ...
                            .wrapping_add(MIN_CHUNK_SIZE as usize)
                        ...
                        )
                {
                    ...
                    if esize < HALF_MAX_SIZE_T {
                        let mut end: *mut ::core::ffi::c_char = !(0 as ::core::ffi::c_int as size_t)
                            ...
                            as *mut ::core::ffi::c_char;
                        if end != CMFAIL {
                            ssize = (ssize as ::core::ffi::c_ulong)
                                .wrapping_add(esize as ::core::ffi::c_ulong)
                                as size_t as size_t;
                        } else {
    ...
    if tbase != CMFAIL {
        (*m).footprint = ((*m).footprint as ::core::ffi::c_ulong)
            .wrapping_add(tsize as ::core::ffi::c_ulong) as size_t
            as size_t;
        if (*m).footprint > (*m).max_footprint {
            (*m).max_footprint = (*m).footprint;
        }
        if (*m).top.is_null() {
            ...
            (*m).seg.base = tbase;
            (*m).seg.size = tsize;
            if mmap_flag as ::core::ffi::c_ulong != USE_MMAP_BIT {
                abort();
            } else {
                (*m).seg.exec_offset = *((*m)
                    .seg
                    ...
                    != (*m).seg.exec_offset
                {
                    ...
                    let ref mut fresh4 = *((*m)
                        .seg
                        .base
                        .offset((*m).seg.size as isize)
                        .offset(-(::core::mem::size_of::<ptrdiff_t>() as usize as isize))
                        as *mut ptrdiff_t);
                    *fresh4 = 0 as ptrdiff_t;
                };
            };
            ...
            if !sp.is_null()
                && 1 as ::core::ffi::c_int as ::core::ffi::c_ulong
                    & EXTERN_BIT as ::core::ffi::c_ulong
                    == 0
                && *(tbase
                    .offset(tsize as isize)
                    .offset(-(::core::mem::size_of::<ptrdiff_t>() as usize as isize))
                ...
                && 1 as ::core::ffi::c_int as size_t & USE_MMAP_BIT
                    == mmap_flag as ::core::ffi::c_ulong
                && ((*m).top as *mut ::core::ffi::c_char >= (*sp).base
                    && ((*m).top as *mut ::core::ffi::c_char)
                        < (*sp).base.offset((*sp).size as isize))
            {
                (*sp).size = ((*sp).size as ::core::ffi::c_ulong)
                    .wrapping_add(tsize as ::core::ffi::c_ulong)
                    as size_t as size_t;
        ...
        if nb < (*m).topsize {
            (*m).topsize = ((*m).topsize as ::core::ffi::c_ulong)
                .wrapping_sub(nb as ::core::ffi::c_ulong) as size_t
                as size_t;
...
unsafe extern "C" fn release_unused_segments(mut m: mstate) -> size_t {
    ...
    while !sp.is_null() {
        ...
        if 1 as ::core::ffi::c_int as size_t & USE_MMAP_BIT != 0
            && 1 as ::core::ffi::c_int as ::core::ffi::c_ulong & EXTERN_BIT as ::core::ffi::c_ulong
                == 0
        {
            ...
            if !((*p).head & INUSE_BITS != PINUSE_BIT)
                && (p as *mut ::core::ffi::c_char).offset(psize as isize)
                    >= base.offset(size as isize).offset(
                        ...
                        .wrapping_add(MIN_CHUNK_SIZE as usize) as isize),
                    )
            {
                ...
                if dlmunmap(base as *mut ::core::ffi::c_void, size) == 0 as ::core::ffi::c_int {
                    released = (released as ::core::ffi::c_ulong)
                        .wrapping_add(size as ::core::ffi::c_ulong)
                        as size_t as size_t;
                    (*m).footprint = ((*m).footprint as ::core::ffi::c_ulong)
                        .wrapping_sub(size as ::core::ffi::c_ulong)
                        as size_t as size_t;
                    sp = pred;
                    ...
                    if X == 0 as ::core::ffi::c_uint {
                        ...
                        let mut K: ::core::ffi::c_uint =
                            (::core::mem::size_of::<::core::ffi::c_uint>() as ::core::ffi::c_uint)
                                ...
                                .wrapping_sub(1 as ::core::ffi::c_uint)
                                .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
                        I = ((K << 1 as ::core::ffi::c_int) as ::core::ffi::c_ulong).wrapping_add(
                            psize as ::core::ffi::c_ulong
                                >> K.wrapping_add(
    ...
    (*m).release_checks = (if nsegs as size_t > MAX_RELEASE_CHECK_RATE as size_t {
        nsegs as ::core::ffi::c_ulong
    } else {
        MAX_RELEASE_CHECK_RATE as ::core::ffi::c_ulong
    }) as size_t;
    return released;
}
unsafe extern "C" fn sys_trim(mut m: mstate, mut pad: size_t) -> ::core::ffi::c_int {
    ...
    (atomic_ulong_load_acquire(&raw mut mparams.magic) != 0 as ::core::ffi::c_ulong
        || init_mparams() != 0) as ::core::ffi::c_int;
    if (pad as usize) < MAX_REQUEST as usize && !(*m).top.is_null() {
        pad = (pad as ::core::ffi::c_ulong).wrapping_add(
            ...
            .wrapping_add(MIN_CHUNK_SIZE as usize) as ::core::ffi::c_ulong,
        ) as size_t as size_t;
        if (*m).topsize > pad {
            ...
            if 1 as ::core::ffi::c_int as ::core::ffi::c_ulong & EXTERN_BIT as ::core::ffi::c_ulong
                == 0
            {
                if 1 as ::core::ffi::c_int as size_t & USE_MMAP_BIT != 0 {
            ...
            if released != 0 as ::core::ffi::c_ulong {
                (*sp).size = ((*sp).size as ::core::ffi::c_ulong)
                    .wrapping_sub(released as ::core::ffi::c_ulong)
                    as size_t as size_t;
                (*m).footprint = ((*m).footprint as ::core::ffi::c_ulong)
                    .wrapping_sub(released as ::core::ffi::c_ulong)
                    as size_t as size_t;
        ...
        released = (released as ::core::ffi::c_ulong)
            .wrapping_add(release_unused_segments(m) as ::core::ffi::c_ulong)
            as size_t as size_t;
        if released == 0 as ::core::ffi::c_ulong && (*m).topsize > (*m).trim_check {
            (*m).trim_check = MAX_SIZE_T;
        }
    }
    return if released != 0 as ::core::ffi::c_ulong {
        1 as ::core::ffi::c_int
    } else {
        0 as ::core::ffi::c_int
    };
...
unsafe extern "C" fn dispose_chunk(mut m: mstate, mut p: mchunkptr, mut psize: size_t) {
    ...
    if (*p).head & PINUSE_BIT == 0 {
        ...
        if (*p).head & INUSE_BITS == 0 as ::core::ffi::c_ulong {
            psize = (psize as ::core::ffi::c_ulong).wrapping_add(
                (prevsize as usize).wrapping_add(MMAP_FOOT_PAD) as ::core::ffi::c_ulong,
            ) as size_t as size_t;
            if dlmunmap(
            ...
            {
                (*m).footprint = ((*m).footprint as ::core::ffi::c_ulong)
                    .wrapping_sub(psize as ::core::ffi::c_ulong)
                    as size_t as size_t;
            }
            return;
        }
        prev = (p as *mut ::core::ffi::c_char).offset(-(prevsize as isize)) as mchunkptr;
        psize = (psize as ::core::ffi::c_ulong).wrapping_add(prevsize as ::core::ffi::c_ulong)
            as size_t as size_t;
        p = prev;
        ...
        {
            if p != (*m).dv {
                if prevsize >> SMALLBIN_SHIFT < NSMALLBINS as ::core::ffi::c_ulong {
                ...
                (*m).dvsize = psize;
                (*next).head &= !PINUSE_BIT as ::core::ffi::c_ulong;
                (*p).head = psize | PINUSE_BIT;
        ...
        != 0
    {
        if (*next).head & CINUSE_BIT == 0 {
            if next == (*m).top {
                (*m).topsize = ((*m).topsize as ::core::ffi::c_ulong)
                    .wrapping_add(psize as ::core::ffi::c_ulong)
                    as size_t as size_t;
                let mut tsize: size_t = (*m).topsize;
                (*m).top = p;
                ...
                psize = (psize as ::core::ffi::c_ulong).wrapping_add(nsize as ::core::ffi::c_ulong)
                    as size_t as size_t;
                if nsize >> SMALLBIN_SHIFT < NSMALLBINS as ::core::ffi::c_ulong {
        ...
        if psize >> SMALLBIN_SHIFT < NSMALLBINS as ::core::ffi::c_ulong {
            ...
            if X == 0 as ::core::ffi::c_uint {
                ...
                let mut K: ::core::ffi::c_uint = (::core::mem::size_of::<::core::ffi::c_uint>()
                    ...
                    .wrapping_sub(1 as ::core::ffi::c_uint)
                    .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
                I_2 = ((K << 1 as ::core::ffi::c_int) as ::core::ffi::c_ulong).wrapping_add(
                    psize as ::core::ffi::c_ulong
                        >> K.wrapping_add(TREEBIN_SHIFT.wrapping_sub(1 as ::core::ffi::c_uint))
                        & 1 as ::core::ffi::c_ulong,
                ) as bindex_t;
...
unsafe extern "C" fn tmalloc_large(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
    ...
    if X == 0 as ::core::ffi::c_uint {
        ...
        let mut K: ::core::ffi::c_uint = (::core::mem::size_of::<::core::ffi::c_uint>()
            ...
            .wrapping_sub(1 as ::core::ffi::c_uint)
            .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
        idx = ((K << 1 as ::core::ffi::c_int) as ::core::ffi::c_ulong).wrapping_add(
            nb as ::core::ffi::c_ulong
                >> K.wrapping_add(TREEBIN_SHIFT.wrapping_sub(1 as ::core::ffi::c_uint))
                & 1 as ::core::ffi::c_ulong,
        ) as bindex_t;
    }
    ...
    if !t.is_null() {
        ...
        loop {
            ...
            if trem < rsize {
                v = t;
                rsize = trem;
                if rsize == 0 as ::core::ffi::c_ulong {
                    break;
                }
            }
            rt = (*t).child[1 as ::core::ffi::c_int as usize] as tchunkptr;
            t = (*t).child[(sizebits as ::core::ffi::c_ulong
                >> SIZE_T_BITSIZE.wrapping_sub(SIZE_T_ONE as usize)
                & 1 as ::core::ffi::c_ulong) as usize] as tchunkptr;
            if !rt.is_null() && rt != t {
                rst = rt;
            }
            if t.is_null() {
                    ...
                    *fresh6 |= PINUSE_BIT as ::core::ffi::c_ulong;
                    ...
                    if rsize >> SMALLBIN_SHIFT < NSMALLBINS as ::core::ffi::c_ulong {
                        ...
                        if X_0 == 0 as ::core::ffi::c_uint {
                            ...
                            I_0 = ((K_0 << 1 as ::core::ffi::c_int) as ::core::ffi::c_ulong)
                                .wrapping_add(
                                    rsize as ::core::ffi::c_ulong
                                        >> K_0.wrapping_add(
                                            TREEBIN_SHIFT.wrapping_sub(1 as ::core::ffi::c_uint),
                                        )
                                        & 1 as ::core::ffi::c_ulong,
...
unsafe extern "C" fn tmalloc_small(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
        ...
        != 0
    {
            ...
            != 0
        {
            ...
            if (rsize as usize) < MIN_CHUNK_SIZE as usize {
                (*v).head = rsize.wrapping_add(nb) | PINUSE_BIT | CINUSE_BIT;
                let ref mut fresh7 = (*((v as *mut ::core::ffi::c_char)
                    .offset(rsize.wrapping_add(nb) as isize)
                    as mchunkptr))
                    .head;
                *fresh7 |= PINUSE_BIT as ::core::ffi::c_ulong;
            } else {
                (*v).head = nb | PINUSE_BIT | CINUSE_BIT;
                (*r).head = rsize | PINUSE_BIT;
                (*((r as *mut ::core::ffi::c_char).offset(rsize as isize) as mchunkptr))
...
unsafe extern "C" fn dlmalloc(mut bytes: size_t) -> *mut ::core::ffi::c_void {
    ...
    if if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
        if atomic_i32_swap_acquire(&raw mut _gm_.mutex, 1 as ::core::ffi::c_int) != 0 {
    ...
    } == 0
    {
        ...
        if bytes as usize <= MAX_SMALL_REQUEST {
            ...
            nb = (if (bytes as usize) < MIN_REQUEST as usize {
                ...
                != 0 as ::core::ffi::c_uint
            {
                ...
                let ref mut fresh1 = (*((p as *mut ::core::ffi::c_char)
                    ...
                    as mchunkptr))
                    .head;
                *fresh1 |= PINUSE_BIT as ::core::ffi::c_ulong;
                mem = (p as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as usize as isize)
                    as *mut ::core::ffi::c_void;
                current_block = 5535292031982912860;
                ...
                if smallbits != 0 as ::core::ffi::c_uint {
                    ...
                    if SIZE_T_SIZE as usize != 4 as usize
                        && (rsize as usize) < MIN_CHUNK_SIZE as usize
                    {
                        (*p_0).head =
                        ...
                        let ref mut fresh2 = (*((p_0 as *mut ::core::ffi::c_char)
                            ...
                            as mchunkptr))
                            .head;
                        *fresh2 |= PINUSE_BIT as ::core::ffi::c_ulong;
                    } else {
        ...
        } else if bytes as usize >= MAX_REQUEST as usize {
            nb = MAX_SIZE_T;
            current_block = 7419121793134201633;
        } else {
            nb = ((bytes as usize)
        ...
        match current_block {
            7419121793134201633 => {
                if nb <= _gm_.dvsize {
                    ...
                    if rsize_0 as usize >= MIN_CHUNK_SIZE as usize {
                        _gm_.dv =
                        ...
                        let ref mut fresh3 = (*((p_1 as *mut ::core::ffi::c_char)
                            ...
                            as mchunkptr))
                            .head;
                        *fresh3 |= PINUSE_BIT as ::core::ffi::c_ulong;
                    }
                    mem = (p_1 as *mut ::core::ffi::c_char)
                        .offset(TWO_SIZE_T_SIZES as usize as isize)
                        as *mut ::core::ffi::c_void;
                } else if nb < _gm_.topsize {
                    _gm_.topsize = (_gm_.topsize as ::core::ffi::c_ulong)
                        .wrapping_sub(nb as ::core::ffi::c_ulong)
                        as size_t as size_t;
        ...
        if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
            atomic_i32_store_release(&raw mut _gm_.mutex, 0);
        }
        return mem;
    } else {
        return ::core::ptr::null_mut::<::core::ffi::c_void>();
                ...
                != 0
            {
                ...
                if (*p).head & PINUSE_BIT == 0 {
                    ...
                    if (*p).head & INUSE_BITS == 0 as ::core::ffi::c_ulong {
                        ...
                        {
                            _gm_.footprint = (_gm_.footprint as ::core::ffi::c_ulong)
                                .wrapping_sub(psize as ::core::ffi::c_ulong)
                                as size_t as size_t;
                        }
                        current_block = 13878105071147073994;
                    } else {
                        let mut prev: mchunkptr = (p as *mut ::core::ffi::c_char)
                            .offset(-(prevsize as isize))
                            as mchunkptr;
                        psize = (psize as ::core::ffi::c_ulong)
                            .wrapping_add(prevsize as ::core::ffi::c_ulong)
                            as size_t as size_t;
                        p = prev;
                            ...
                            != 0
                        {
                            ...
                            current_block = 10261966699967004588;
                        }
                    }
                } else {
                    current_block = 10778260831612459202;
                                    ...
                                    != 0
                                {
                                    if (*next).head & CINUSE_BIT == 0 {
                                        if next == _gm_.top {
                                            ...
                                            _gm_.dvsize = (_gm_.dvsize as ::core::ffi::c_ulong)
                                                .wrapping_add(psize as ::core::ffi::c_ulong)
                                                as size_t
                                                as size_t;
                                            ...
                                            psize = (psize as ::core::ffi::c_ulong)
                                                .wrapping_add(nsize as ::core::ffi::c_ulong)
                                                as size_t
                                                as size_t;
                                            if nsize >> SMALLBIN_SHIFT
                                                < NSMALLBINS as ::core::ffi::c_ulong
                                            {
                                                let mut F_1: mchunkptr = (*next).fd as mchunkptr;
                                                let mut B_0: mchunkptr = (*next).bk as mchunkptr;
                                    ...
                                    match current_block {
                                        13878105071147073994 => {}
                                        _ => {
                                            if psize >> SMALLBIN_SHIFT
                                                < NSMALLBINS as ::core::ffi::c_ulong
                                            {
                                                            ...
                                                            != psize
                                                        {
                                                            let mut C: *mut tchunkptr = (&raw mut (*T).child
                                                                ...
                                                                .offset(
                                                                    (K_0 as ::core::ffi::c_ulong
                                                                        >> SIZE_T_BITSIZE.wrapping_sub(SIZE_T_ONE as usize)
                                                                        & 1 as ::core::ffi::c_ulong) as isize,
                                                                ) as *mut tchunkptr;
                                                            K_0 <<= 1 as ::core::ffi::c_int;
                                                            if !(*C).is_null() {
                                                                T = *C;
                                                ...
                                                if _gm_.release_checks == 0 as ::core::ffi::c_ulong
                                                {
        ...
        != 0
    {
        if (*p).head & INUSE_BITS == 0 as ::core::ffi::c_ulong {
            ...
            if oldsize.wrapping_add((*m).topsize) > nb {
                ...
                let ref mut fresh10 =
                    (*((p as *mut ::core::ffi::c_char).offset(nb as isize) as mchunkptr)).head;
                *fresh10 |= PINUSE_BIT as ::core::ffi::c_ulong;
            ...
            if oldsize.wrapping_add(dvs) >= nb {
                ...
                if dsize as usize >= MIN_CHUNK_SIZE as usize {
                    ...
                    let ref mut fresh11 =
                        (*((p as *mut ::core::ffi::c_char).offset(nb as isize) as mchunkptr)).head;
                    *fresh11 |= PINUSE_BIT as ::core::ffi::c_ulong;
                    (*r_0).head = dsize | PINUSE_BIT;
                    (*((r_0 as *mut ::core::ffi::c_char).offset(dsize as isize) as mchunkptr))
                        .prev_foot = dsize;
                    (*n).head &= !PINUSE_BIT as ::core::ffi::c_ulong;
                    (*m).dvsize = dsize;
                    (*m).dv = r_0;
                } else {
                    let mut newsize_0: size_t = oldsize.wrapping_add(dvs);
                    (*p).head = (*p).head & PINUSE_BIT | newsize_0 | CINUSE_BIT;
                    let ref mut fresh12 = (*((p as *mut ::core::ffi::c_char)
                        .offset(newsize_0 as isize)
                        as mchunkptr))
                        .head;
                    *fresh12 |= PINUSE_BIT as ::core::ffi::c_ulong;
                    (*m).dvsize = 0 as size_t;
                    (*m).dv = ::core::ptr::null_mut::<malloc_chunk>();
                }
                newp = p;
            ...
            if oldsize.wrapping_add(nextsize) >= nb {
                ...
                if nextsize >> SMALLBIN_SHIFT < NSMALLBINS as ::core::ffi::c_ulong {
                ...
                if (rsize_0 as usize) < MIN_CHUNK_SIZE as usize {
                    ...
                    let ref mut fresh13 = (*((p as *mut ::core::ffi::c_char)
                        .offset(newsize_1 as isize)
                        as mchunkptr))
                        .head;
                    *fresh13 |= PINUSE_BIT as ::core::ffi::c_ulong;
                } else {
                    ...
                    let ref mut fresh14 =
                        (*((p as *mut ::core::ffi::c_char).offset(nb as isize) as mchunkptr)).head;
                    *fresh14 |= PINUSE_BIT as ::core::ffi::c_ulong;
                    (*r_1).head = (*r_1).head & PINUSE_BIT | rsize_0 | CINUSE_BIT;
                    let ref mut fresh15 = (*((r_1 as *mut ::core::ffi::c_char)
                        .offset(rsize_0 as isize)
                        as mchunkptr))
                        .head;
                    *fresh15 |= PINUSE_BIT as ::core::ffi::c_ulong;
...
unsafe extern "C" fn internal_memalign(
    ...
    let mut mem: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<::core::ffi::c_void>();
    if (alignment as usize) < MIN_CHUNK_SIZE as usize {
        alignment = MIN_CHUNK_SIZE as usize as size_t;
    }
    if alignment & alignment.wrapping_sub(SIZE_T_ONE) != 0 as ::core::ffi::c_ulong {
    ...
    if bytes as usize >= (MAX_REQUEST as usize).wrapping_sub(alignment as usize) {
        if !m.is_null() {
            *__errno_location() = ENOMEM;
        }
    } else {
        let mut nb: size_t = if (bytes as usize) < MIN_REQUEST as usize {
            MIN_CHUNK_SIZE
        } else {
            bytes
                .wrapping_add(CHUNK_OVERHEAD)
        ...
        if !mem.is_null() {
            ...
            if if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
                if atomic_i32_swap_acquire(&raw mut (*m).mutex, 1 as ::core::ffi::c_int) != 0 {
            ...
            if mem as ::core::ffi::c_ulong
                & (alignment as ::core::ffi::c_ulong).wrapping_sub(1 as ::core::ffi::c_ulong)
                != 0 as ::core::ffi::c_ulong
            {
            ...
            if !((*p).head & INUSE_BITS == 0 as ::core::ffi::c_ulong) {
                ...
                if size as usize > (nb as usize).wrapping_add(MIN_CHUNK_SIZE as usize) {
                    ...
                    let ref mut fresh18 =
                        (*((p as *mut ::core::ffi::c_char).offset(nb as isize) as mchunkptr)).head;
                    *fresh18 |= PINUSE_BIT as ::core::ffi::c_ulong;
                    (*remainder).head =
                        (*remainder).head & PINUSE_BIT | remainder_size | CINUSE_BIT;
                    let ref mut fresh19 = (*((remainder as *mut ::core::ffi::c_char)
                        .offset(remainder_size as isize)
                        as mchunkptr))
                        .head;
                    *fresh19 |= PINUSE_BIT as ::core::ffi::c_ulong;
            ...
            if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
                atomic_i32_store_release(&raw mut (*m).mutex, 0);
            }
        }
    }
    return mem;
                ...
                *a = ::core::ptr::null_mut::<::core::ffi::c_void>();
                    ...
                    != 0
                {
                                ...
                                as *mut ::core::ffi::c_void
                    {
                        ...
                        let ref mut fresh20 = (*((p as *mut ::core::ffi::c_char)
                            .offset(newsize as isize)
                            as mchunkptr))
                            .head;
                        *fresh20 |= PINUSE_BIT as ::core::ffi::c_ulong;
...
pub unsafe extern "C" fn dlrealloc_in_place(
    ...
    let mut mem: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<::core::ffi::c_void>();
    if !oldmem.is_null() {
        if bytes as usize >= MAX_REQUEST as usize {
            *__errno_location() = ENOMEM;
        } else {
            let mut nb: size_t = if (bytes as usize) < MIN_REQUEST as usize {
                MIN_CHUNK_SIZE
...
pub unsafe extern "C" fn dlposix_memalign(
    ...
    if alignment == MALLOC_ALIGNMENT {
        ...
        if r != 0 as ::core::ffi::c_ulong
            || d == 0 as ::core::ffi::c_ulong
            || d & d.wrapping_sub(SIZE_T_ONE) != 0 as ::core::ffi::c_ulong
        {
            return EINVAL;
        } else if bytes as usize <= (MAX_REQUEST as usize).wrapping_sub(alignment as usize) {
            if (alignment as usize) < MIN_CHUNK_SIZE as usize {
                alignment = MIN_CHUNK_SIZE as usize as size_t;
            }
...
pub unsafe extern "C" fn dlmalloc_footprint_limit() -> size_t {
    ...
    return if maf == 0 as ::core::ffi::c_ulong {
        MAX_SIZE_T
    } else {
        maf
    };
...
pub unsafe extern "C" fn dlmalloc_set_footprint_limit(mut bytes: size_t) -> size_t {
    ...
    if bytes == 0 as ::core::ffi::c_ulong {
...
unsafe extern "C" fn selinux_enabled_check() -> ::core::ffi::c_int {
    ...
    while getline(&raw mut buf, &raw mut len, f) >= 0 as ::core::ffi::c_long {
...
unsafe extern "C" fn pax_flags_check() -> ::core::ffi::c_int {
    ...
    while getline(&raw mut buf, &raw mut len, f)
...
unsafe extern "C" fn allocate_space(
    ...
    while len > 0 as ::core::ffi::c_long {
        ...
        len -= to_write as ::core::ffi::c_long;
    }
    return 0 as ::core::ffi::c_int;
}
unsafe extern "C" fn dlmmap_locked(
    ...
    if execfd == -(1 as ::core::ffi::c_int) {
        open_temp_exec_file_opts_idx = 0 as ::core::ffi::c_int;
        current_block = 10187835449159546877;
    } else {
        current_block = 735147466149431745;
    }
    loop {
        match current_block {
            10187835449159546877 => {
            ...
            _ => {
                ...
                if ptr == MFAIL {
                    ...
                    *((start as *mut ::core::ffi::c_char)
                        ...
                        as ::core::ffi::c_long
                        as ptrdiff_t;
                    execsize = (execsize as ::core::ffi::c_ulong)
