...
pub const SIZE_T_SIZE: ::core::ffi::c_ulong = ::core::mem::size_of::<size_t>();
...
pub const MCHUNK_SIZE: ::core::ffi::c_ulong = ::core::mem::size_of::<mchunk>();
pub const CHUNK_OVERHEAD: ::core::ffi::c_ulong = ::core::mem::size_of::<size_t>();
...
unsafe extern "C" fn sys_alloc(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
    ...
    (::core::intrinsics::atomic_load_acquire(&raw mut mparams.magic) != 0 as ::core::ffi::c_ulong
...
unsafe extern "C" fn dlmalloc(mut bytes: size_t) -> *mut ::core::ffi::c_void {
    ...
    if if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
        if ::core::intrinsics::atomic_xchg_acquire(&raw mut _gm_.mutex, 1 as ::core::ffi::c_int)
            != 0
        {
...
unsafe extern "C" fn internal_bulk_free(
    ...
    if if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
        if ::core::intrinsics::atomic_xchg_acquire(&raw mut (*m).mutex, 1 as ::core::ffi::c_int)
            != 0
        {
            spin_acquire_lock(&raw mut (*m).mutex)
        } else {
