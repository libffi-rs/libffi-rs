...
unsafe extern "C" fn initialize_aggregate(
    ...
    while !(*ptr).is_null() {
        if (((**ptr).size == 0 as ::core::ffi::c_ulong
        ...
        (*arg).size = ((*arg).size.wrapping_sub(1 as ::core::ffi::c_ulong)
        ...
        (*arg).size = ((*arg).size as ::core::ffi::c_ulong)
            .wrapping_add((**ptr).size as ::core::ffi::c_ulong) as size_t
            as size_t;
        (*arg).alignment =
    ...
    (*arg).size = ((*arg).size.wrapping_sub(1 as ::core::ffi::c_ulong)
        | ((*arg).alignment as ::core::ffi::c_int - 1 as ::core::ffi::c_int)
            as ::core::ffi::c_ulong)
        .wrapping_add(1 as ::core::ffi::c_ulong) as size_t;
    if (*arg).size == 0 as ::core::ffi::c_ulong {
        return FFI_BAD_TYPEDEF;
    } else {
        return FFI_OK;
    };
...
pub unsafe extern "C" fn ffi_prep_cif_core(
    ...
    if (*(*cif).rtype).size == 0 as ::core::ffi::c_ulong
    ...
    if (*(*cif).rtype).type_0 as ::core::ffi::c_int == FFI_TYPE_STRUCT {
        bytes = ((::core::mem::size_of::<*mut ::core::ffi::c_void>() as ::core::ffi::c_ulong)
            .wrapping_sub(1 as ::core::ffi::c_ulong)
            | (8 as ::core::ffi::c_int - 1 as ::core::ffi::c_int) as ::core::ffi::c_ulong)
            .wrapping_add(1 as ::core::ffi::c_ulong) as ::core::ffi::c_uint;
    }
    ptr = (*cif).arg_types;
    i = (*cif).nargs;
    while i > 0 as ::core::ffi::c_uint {
        ...
        if ((**ptr).alignment as ::core::ffi::c_int - 1 as ::core::ffi::c_int)
            ...
            != 0
        {
            bytes = ((bytes as ::core::ffi::c_ulong).wrapping_sub(1 as ::core::ffi::c_ulong)
                | ((**ptr).alignment as ::core::ffi::c_int - 1 as ::core::ffi::c_int)
                    as ::core::ffi::c_ulong)
                .wrapping_add(1 as ::core::ffi::c_ulong) as ::core::ffi::c_uint;
        }
        bytes = bytes.wrapping_add(
            ((**ptr).size.wrapping_sub(1 as ::core::ffi::c_ulong)
                | (8 as ::core::ffi::c_int - 1 as ::core::ffi::c_int) as ::core::ffi::c_ulong)
                .wrapping_add(1 as ::core::ffi::c_ulong) as ::core::ffi::c_uint,
        );
        i = i.wrapping_sub(1);
