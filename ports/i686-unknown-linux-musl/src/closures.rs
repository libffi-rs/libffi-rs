...
// C2Rust 0.22.1 emitted removed compiler intrinsics for dlmalloc's C11
// atomics. Keep the generated call sites while implementing them with stable
// Rust atomics. Every translated atomic word in this configured build is 32-bit.
unsafe fn atomic_load_relaxed<T: Copy>(ptr: *mut T) -> T {
    let value = core::sync::atomic::AtomicU32::from_ptr(ptr.cast())
        .load(core::sync::atomic::Ordering::Relaxed);
    core::mem::transmute_copy(&value)
}

unsafe fn atomic_load_acquire<T: Copy>(ptr: *mut T) -> T {
    let value = core::sync::atomic::AtomicU32::from_ptr(ptr.cast())
        .load(core::sync::atomic::Ordering::Acquire);
    core::mem::transmute_copy(&value)
}

unsafe fn atomic_xchg_acquire<T: Copy>(ptr: *mut T, value: T) -> T {
    let value = core::mem::transmute_copy::<T, u32>(&value);
    let previous = core::sync::atomic::AtomicU32::from_ptr(ptr.cast())
        .swap(value, core::sync::atomic::Ordering::Acquire);
    core::mem::transmute_copy(&previous)
}

unsafe fn atomic_store_release<T: Copy>(ptr: *mut T, value: T) {
    let value = core::mem::transmute_copy::<T, u32>(&value);
...
extern "C" {
    ...
    fn getline(_: *mut *mut ::core::ffi::c_char, _: *mut size_t, _: *mut FILE) -> ssize_t;
    fn setmntent(_: *const ::core::ffi::c_char, _: *const ::core::ffi::c_char) -> *mut FILE;
    fn endmntent(_: *mut FILE) -> ::core::ffi::c_int;
    fn getmntent_r(
        _: *mut FILE,
        _: *mut mntent,
    ...
    fn hasmntopt(_: *const mntent, _: *const ::core::ffi::c_char) -> *mut ::core::ffi::c_char;
    fn free(_: *mut ::core::ffi::c_void);
    fn abort() -> !;
    fn getenv(_: *const ::core::ffi::c_char) -> *mut ::core::ffi::c_char;
    fn mkstemp(_: *mut ::core::ffi::c_char) -> ::core::ffi::c_int;
    ...
    fn memfd_create(_: *const ::core::ffi::c_char, _: ::core::ffi::c_uint) -> ::core::ffi::c_int;
    fn statfs(_: *const ::core::ffi::c_char, _: *mut statfs) -> ::core::ffi::c_int;
    fn strncmp(
...
pub struct statfs {
    ...
    pub f_spare: [::core::ffi::c_ulong; 4],
}
...
pub const PAX_EMUTRAMP: C2RustUnnamed_2 = 2;
pub const PAX_MPROTECT: C2RustUnnamed_2 = 1;
...
#[inline]
unsafe extern "C" fn __bswap16(mut __x: uint16_t) -> uint16_t {
    return ((__x as ::core::ffi::c_int) << 8 as ::core::ffi::c_int
        | __x as ::core::ffi::c_int >> 8 as ::core::ffi::c_int) as uint16_t;
}
#[inline]
unsafe extern "C" fn __bswap32(mut __x: uint32_t) -> uint32_t {
    return __x >> 24 as ::core::ffi::c_int
        | __x >> 8 as ::core::ffi::c_int & 0xff00 as uint32_t
        | __x << 8 as ::core::ffi::c_int & 0xff0000 as ::core::ffi::c_int as uint32_t
        | __x << 24 as ::core::ffi::c_int;
}
#[inline]
unsafe extern "C" fn __bswap64(mut __x: uint64_t) -> uint64_t {
    return (__bswap32(__x as uint32_t) as uint64_t).wrapping_add(0 as uint64_t)
        << 32 as ::core::ffi::c_int
        | __bswap32((__x >> 32 as ::core::ffi::c_int) as uint32_t) as uint64_t;
}
pub const O_RDWR: ::core::ffi::c_int = 0o2 as ::core::ffi::c_int;
pub const W_OK: ::core::ffi::c_int = 2 as ::core::ffi::c_int;
pub const _SC_PAGE_SIZE: ::core::ffi::c_int = 30 as ::core::ffi::c_int;
...
pub const MFD_CLOEXEC: ::core::ffi::c_uint = 0x1 as ::core::ffi::c_uint;
pub const O_EXCL: ::core::ffi::c_int = 0o200 as ::core::ffi::c_int;
pub const O_CLOEXEC: ::core::ffi::c_int = 0o2000000 as ::core::ffi::c_int;
pub const O_TMPFILE: ::core::ffi::c_int = 0o20200000 as ::core::ffi::c_int;
...
pub const DEFAULT_TRIM_THRESHOLD: size_t = (2 as ::core::ffi::c_uint)
...
pub const HALF_MAX_SIZE_T: ::core::ffi::c_uint = MAX_SIZE_T.wrapping_div(2 as ::core::ffi::c_uint);
...
unsafe extern "C" fn spin_acquire_lock(mut sl: *mut ::core::ffi::c_int) -> ::core::ffi::c_int {
    ...
    while atomic_load_relaxed(sl) != 0 as ::core::ffi::c_int
        || atomic_xchg_acquire(sl, 1 as ::core::ffi::c_int) != 0
    {
        spins += 1;
...
pub const MIN_CHUNK_SIZE: usize =
    MCHUNK_SIZE.wrapping_add(CHUNK_ALIGN_MASK as usize) & !(CHUNK_ALIGN_MASK as usize);
...
pub const MIN_REQUEST: usize = MIN_CHUNK_SIZE
    ...
    .wrapping_sub(SIZE_T_ONE as usize);
...
pub const FENCEPOST_HEAD: usize = INUSE_BITS as usize | SIZE_T_SIZE;
...
pub const MAX_SMALL_REQUEST: usize = (MAX_SMALL_SIZE as usize)
    .wrapping_sub(CHUNK_ALIGN_MASK as usize)
    .wrapping_sub(CHUNK_OVERHEAD);
...
unsafe extern "C" fn init_mparams() -> ::core::ffi::c_int {
    if atomic_xchg_acquire(&raw mut malloc_global_mutex, 1 as ::core::ffi::c_int) != 0 {
        spin_acquire_lock(&raw mut malloc_global_mutex);
    } else {
    };
    if mparams.magic == 0 as ::core::ffi::c_uint {
        let mut magic: size_t = 0;
        let mut psize: size_t = 0;
        let mut gsize: size_t = 0;
        psize = sysconf(_SC_PAGE_SIZE) as size_t;
        gsize = (if sysconf(_SC_PAGE_SIZE) as size_t != 0 as ::core::ffi::c_uint {
            sysconf(_SC_PAGE_SIZE) as ::core::ffi::c_uint
        } else {
            psize as ::core::ffi::c_uint
        }) as size_t;
        if ::core::mem::size_of::<size_t>() as usize
            != ::core::mem::size_of::<*mut ::core::ffi::c_char>() as usize
            || (MAX_SIZE_T as usize) < MIN_CHUNK_SIZE
            || (::core::mem::size_of::<::core::ffi::c_int>() as usize) < 4 as usize
            || MALLOC_ALIGNMENT < 8 as ::core::ffi::c_uint
            || MALLOC_ALIGNMENT & MALLOC_ALIGNMENT.wrapping_sub(SIZE_T_ONE)
                != 0 as ::core::ffi::c_uint
            || MCHUNK_SIZE & MCHUNK_SIZE.wrapping_sub(SIZE_T_ONE as usize) != 0 as usize
            || gsize & gsize.wrapping_sub(SIZE_T_ONE) != 0 as ::core::ffi::c_uint
            || psize & psize.wrapping_sub(SIZE_T_ONE) != 0 as ::core::ffi::c_uint
        {
            abort();
        }
        ...
        mparams.default_mflags = (USE_LOCK_BIT | USE_MMAP_BIT | USE_NONCONTIGUOUS_BIT) as flag_t;
        _gm_.mflags = mparams.default_mflags;
        _gm_.mutex = 0 as ::core::ffi::c_int;
        magic = (time(::core::ptr::null_mut::<time_t>()) as ::core::ffi::c_longlong
            ^ 0x55555555 as ::core::ffi::c_uint as ::core::ffi::c_longlong)
            as size_t;
        magic |= 8 as ::core::ffi::c_uint as ::core::ffi::c_uint;
        magic &= !(7 as ::core::ffi::c_uint) as ::core::ffi::c_uint;
        atomic_store_release(&raw mut mparams.magic, magic);
    }
    atomic_store_release(&raw mut malloc_global_mutex, 0);
    return 1 as ::core::ffi::c_int;
}
unsafe extern "C" fn change_mparam(
    ...
    (atomic_load_acquire(&raw mut mparams.magic) != 0 as ::core::ffi::c_uint || init_mparams() != 0)
        as ::core::ffi::c_int;
    val = (if value == -(1 as ::core::ffi::c_int) {
        MAX_SIZE_T
    } else {
        ...
        M_GRANULARITY => {
            if val >= mparams.page_size
                && val as ::core::ffi::c_uint
                    & (val as ::core::ffi::c_uint).wrapping_sub(1 as ::core::ffi::c_uint)
                    == 0 as ::core::ffi::c_uint
            {
...
unsafe extern "C" fn internal_malloc_stats(mut m: mstate) {
    ...
    if if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
        if atomic_xchg_acquire(&raw mut (*m).mutex, 1 as ::core::ffi::c_int) != 0 {
    ...
    } == 0
    {
        ...
        if !(*m).top.is_null() {
            ...
            fp = (*m).footprint;
            used = (fp as usize).wrapping_sub(
                ((*m).topsize as usize).wrapping_add(
                        ...
                        == 0 as ::core::ffi::c_uint
                    {
                        ...
                        (MALLOC_ALIGNMENT as usize).wrapping_sub(
                            ::core::ptr::null_mut::<::core::ffi::c_char>().offset(
                                ((::core::mem::size_of::<size_t>() as usize)
                                    << 1 as ::core::ffi::c_int)
                                    as isize,
                            ) as *mut ::core::ffi::c_void as usize
                                & CHUNK_ALIGN_MASK as usize,
                        ) & CHUNK_ALIGN_MASK as usize
                    })
                    .wrapping_add(
                        (::core::mem::size_of::<malloc_segment>() as usize)
                            .wrapping_add(CHUNK_OVERHEAD)
                            .wrapping_add(CHUNK_ALIGN_MASK as usize)
                            & !(CHUNK_ALIGN_MASK as usize),
                    )
            ...
            while !s.is_null() {
                let mut q: mchunkptr = (*s).base.offset(
                    (if (*s).base.offset(
                        ((::core::mem::size_of::<size_t>() as usize) << 1 as ::core::ffi::c_int)
                            as isize,
                    ) as *mut ::core::ffi::c_void as size_t
                ...
                while q as *mut ::core::ffi::c_char >= (*s).base
                    && (q as *mut ::core::ffi::c_char) < (*s).base.offset((*s).size as isize)
                    && q != (*m).top
                    && (*q).head as usize != FENCEPOST_HEAD
                {
                    if !((*q).head & INUSE_BITS != PINUSE_BIT) {
                        used = (used as ::core::ffi::c_uint).wrapping_sub(
                            ((*q).head & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT))
                                as ::core::ffi::c_uint,
                        ) as size_t as size_t;
                    }
                    q = (q as *mut ::core::ffi::c_char).offset(((*q).head & !FLAG_BITS) as isize)
                        as mchunkptr;
                }
        ...
        if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
            atomic_store_release(&raw mut (*m).mutex, 0);
        }
        fprintf(
            stderr,
...
unsafe extern "C" fn mmap_alloc(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
    ...
    if (*m).footprint_limit != 0 as ::core::ffi::c_uint {
    ...
    if mmsize > nb {
        ...
        if mm != CMFAIL {
            ...
            let mut psize: size_t = mmsize
                .wrapping_sub(offset)
                .wrapping_sub(MMAP_FOOT_PAD as size_t);
            ...
            (*((p as *mut ::core::ffi::c_char).offset(
                (psize as usize).wrapping_add(::core::mem::size_of::<size_t>() as usize) as isize,
            ) as mchunkptr))
                .head = 0 as size_t;
            if (*m).least_addr.is_null() || mm < (*m).least_addr {
                (*m).least_addr = mm;
            }
            (*m).footprint = ((*m).footprint as ::core::ffi::c_uint)
                .wrapping_add(mmsize as ::core::ffi::c_uint) as size_t
                as size_t;
...
unsafe extern "C" fn mmap_resize(
    ...
    if nb >> SMALLBIN_SHIFT < NSMALLBINS {
        return ::core::ptr::null_mut::<malloc_chunk>();
    }
    if oldsize as usize >= (nb as usize).wrapping_add(SIZE_T_SIZE)
        && oldsize.wrapping_sub(nb) <= mparams.granularity << 1 as ::core::ffi::c_int
    {
        ...
        let mut oldmmsize: size_t = oldsize
            .wrapping_add(offset)
            .wrapping_add(MMAP_FOOT_PAD as size_t);
        ...
        if cp != CMFAIL {
            ...
            (*((newp as *mut ::core::ffi::c_char).offset(psize as isize) as mchunkptr)).head =
                FENCEPOST_HEAD as size_t;
            (*((newp as *mut ::core::ffi::c_char).offset(
                (psize as usize).wrapping_add(::core::mem::size_of::<size_t>() as usize) as isize,
            ) as mchunkptr))
                .head = 0 as size_t;
            if cp < (*m).least_addr {
            ...
            (*m).footprint = ((*m).footprint as ::core::ffi::c_uint)
                .wrapping_add(newmmsize.wrapping_sub(oldmmsize) as ::core::ffi::c_uint)
                as size_t as size_t;
            if (*m).footprint > (*m).max_footprint {
                (*m).max_footprint = (*m).footprint;
            }
...
unsafe extern "C" fn init_top(mut m: mstate, mut p: mchunkptr, mut psize: size_t) {
    ...
    psize = (psize as ::core::ffi::c_uint).wrapping_sub(offset as ::core::ffi::c_uint) as size_t
        as size_t;
    (*m).top = p;
    (*m).topsize = psize;
...
unsafe extern "C" fn prepend_alloc(
            ...
            == 0 as ::core::ffi::c_uint
        {
            ...
            MALLOC_ALIGNMENT.wrapping_sub(
                newbase.offset(
                    ((::core::mem::size_of::<size_t>() as usize) << 1 as ::core::ffi::c_int)
                        as isize,
                ) as *mut ::core::ffi::c_void as ::core::ffi::c_uint
                    & CHUNK_ALIGN_MASK,
            ) & CHUNK_ALIGN_MASK
        }) as isize,
    ) as mchunkptr;
    ...
    if oldfirst == (*m).top {
        (*m).topsize = ((*m).topsize as ::core::ffi::c_uint)
            .wrapping_add(qsize as ::core::ffi::c_uint) as size_t as size_t;
        let mut tsize: size_t = (*m).topsize;
        (*m).top = q;
        (*q).head = tsize | PINUSE_BIT;
    } else if oldfirst == (*m).dv {
        (*m).dvsize = ((*m).dvsize as ::core::ffi::c_uint)
            .wrapping_add(qsize as ::core::ffi::c_uint) as size_t as size_t;
        ...
        if !((*oldfirst).head & INUSE_BITS != PINUSE_BIT) {
            ...
            if nsize >> SMALLBIN_SHIFT < NSMALLBINS {
                    ...
                    != 0
                {
                    if B == F {
                        (*m).smallmap &=
                            !((1 as ::core::ffi::c_int as binmap_t) << I) as ::core::ffi::c_uint;
                    } else if (B
                        == (&raw mut (*m).smallbins as *mut mchunkptr)
                            .offset((I << 1 as ::core::ffi::c_int) as isize)
                            as *mut mchunkptr as *mut ::core::ffi::c_char
            ...
            qsize = (qsize as ::core::ffi::c_uint).wrapping_add(nsize as ::core::ffi::c_uint)
                as size_t as size_t;
        }
        (*oldfirst).head &= !PINUSE_BIT as ::core::ffi::c_uint;
        (*q).head = qsize | PINUSE_BIT;
        (*((q as *mut ::core::ffi::c_char).offset(qsize as isize) as mchunkptr)).prev_foot = qsize;
        if qsize >> SMALLBIN_SHIFT < NSMALLBINS {
            let mut I_0: bindex_t = qsize >> SMALLBIN_SHIFT;
            ...
            if (*m).smallmap & (1 as ::core::ffi::c_int as binmap_t) << I_0 == 0 {
                (*m).smallmap |=
                    ((1 as ::core::ffi::c_int as binmap_t) << I_0) as ::core::ffi::c_uint;
            ...
            let mut X: ::core::ffi::c_uint = qsize as ::core::ffi::c_uint >> TREEBIN_SHIFT;
            if X == 0 as ::core::ffi::c_uint {
                ...
                I_1 = (K << 1 as ::core::ffi::c_int).wrapping_add(
                    qsize as ::core::ffi::c_uint
                        >> K.wrapping_add(TREEBIN_SHIFT.wrapping_sub(1 as ::core::ffi::c_uint))
            ...
            if (*m).treemap & (1 as ::core::ffi::c_int as binmap_t) << I_1 == 0 {
                (*m).treemap |=
                    ((1 as ::core::ffi::c_int as binmap_t) << I_1) as ::core::ffi::c_uint;
                *H_0 = TP_0 as tbinptr;
                    ...
                    if (*T).head & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT) != qsize {
                        let mut C: *mut tchunkptr =
                            (&raw mut (*T).child as *mut *mut malloc_tree_chunk).offset(
                                (K_0 as ::core::ffi::c_uint
                                    >> SIZE_T_BITSIZE.wrapping_sub(SIZE_T_ONE as usize)
                                    & 1 as ::core::ffi::c_uint)
                                    as isize,
                            ) as *mut tchunkptr;
...
unsafe extern "C" fn add_segment(
    ...
    let mut rawsp: *mut ::core::ffi::c_char = old_end.offset(
        -((ssize as usize)
            ...
            .wrapping_add(CHUNK_ALIGN_MASK as usize) as isize),
    );
    ...
    let mut csp: *mut ::core::ffi::c_char = if asp < old_top.offset(MIN_CHUNK_SIZE as isize) {
        old_top
    } else {
        asp
    };
    let mut sp: mchunkptr = csp as mchunkptr;
    let mut ss: msegmentptr = (sp as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as isize)
    ...
    *ss = (*m).seg as malloc_segment;
    ...
    if csp != old_top {
        ...
        (*tn).head &= !PINUSE_BIT as ::core::ffi::c_uint;
        ...
        if psize >> SMALLBIN_SHIFT < NSMALLBINS {
            let mut I: bindex_t = psize >> SMALLBIN_SHIFT;
            ...
            let mut X: ::core::ffi::c_uint = psize as ::core::ffi::c_uint >> TREEBIN_SHIFT;
            if X == 0 as ::core::ffi::c_uint {
                I_0 = 0 as bindex_t;
            } else if X > 0xffff as ::core::ffi::c_uint {
                ...
                let mut K: ::core::ffi::c_uint = (::core::mem::size_of::<::core::ffi::c_uint>()
                    ...
                    .wrapping_sub(1 as ::core::ffi::c_uint)
                    .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
                I_0 = (K << 1 as ::core::ffi::c_int).wrapping_add(
                    psize as ::core::ffi::c_uint
                        >> K.wrapping_add(TREEBIN_SHIFT.wrapping_sub(1 as ::core::ffi::c_uint))
                        & 1 as ::core::ffi::c_uint,
                );
...
unsafe extern "C" fn sys_alloc(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
    ...
    if (*m).mflags as size_t & USE_MMAP_BIT != 0
        ...
        && (*m).topsize != 0 as ::core::ffi::c_uint
    {
    ...
    asize = ((nb as usize)
        .wrapping_add(
                    ...
                    .wrapping_sub(
                        ::core::ptr::null_mut::<::core::ffi::c_char>().offset(
                            ...
                            & (2 as usize)
                                ...
                                .wrapping_sub(1 as ::core::ffi::c_int as usize),
                    )
                    & (2 as usize)
                        .wrapping_mul(::core::mem::size_of::<*mut ::core::ffi::c_void>() as usize)
                        .wrapping_sub(1 as ::core::ffi::c_int as usize)
            ...
            .wrapping_add(
                (::core::mem::size_of::<mchunk>() as usize).wrapping_add(
                    (2 as usize)
                        .wrapping_mul(::core::mem::size_of::<*mut ::core::ffi::c_void>() as usize)
                        .wrapping_sub(1 as ::core::ffi::c_int as usize),
                ) & !(2 as usize)
        ...
        .wrapping_add((mparams.granularity as usize).wrapping_sub(SIZE_T_ONE as usize))
        & !(mparams.granularity as usize).wrapping_sub(SIZE_T_ONE as usize)) as size_t;
    if asize <= nb {
        return ::core::ptr::null_mut::<::core::ffi::c_void>();
    }
    if (*m).footprint_limit != 0 as ::core::ffi::c_uint {
        ...
        if ss.is_null() {
            ...
            if base != CMFAIL {
                ...
                if !(base as size_t & mparams.page_size.wrapping_sub(SIZE_T_ONE)
                    == 0 as ::core::ffi::c_uint)
                {
                    ssize = (ssize as ::core::ffi::c_uint).wrapping_add(
                ...
                if ssize > nb
                    ...
                    && ((*m).footprint_limit == 0 as ::core::ffi::c_uint
            ...
            ssize = ((nb as usize)
                .wrapping_sub((*m).topsize as usize)
                .wrapping_add(
                    (if ::core::ptr::null_mut::<::core::ffi::c_char>().offset(
                        ((::core::mem::size_of::<size_t>() as usize) << 1 as ::core::ffi::c_int)
                            as isize,
                ...
                .wrapping_add((mparams.granularity as usize).wrapping_sub(SIZE_T_ONE as usize))
                & !(mparams.granularity as usize).wrapping_sub(SIZE_T_ONE as usize))
                as size_t;
                ...
                if ssize < HALF_MAX_SIZE_T
                    && (ssize as usize)
                        < (nb as usize).wrapping_add(
                            ...
                            .wrapping_add(MIN_CHUNK_SIZE)
                            .wrapping_add(MALLOC_ALIGNMENT as usize),
                        )
                {
                                ...
                                ((2 as usize)
                                    ...
                                    .wrapping_sub(
                                        ::core::ptr::null_mut::<::core::ffi::c_char>().offset(
                                            ...
                                            as *mut ::core::ffi::c_void
                                            as size_t
                                            & ((2 as usize).wrapping_mul(::core::mem::size_of::<
                                                *mut ::core::ffi::c_void,
                                            >(
                                            )
                                                as usize)
                    ...
                    if esize < HALF_MAX_SIZE_T {
                        let mut end: *mut ::core::ffi::c_char = !(0 as ::core::ffi::c_int as size_t)
                            ...
                            as *mut ::core::ffi::c_char;
                        if end != CMFAIL {
                            ssize = (ssize as ::core::ffi::c_uint)
                                .wrapping_add(esize as ::core::ffi::c_uint)
                                as size_t as size_t;
                        } else {
    ...
    if HAVE_MORECORE != 0 && tbase == CMFAIL {
        if asize < HALF_MAX_SIZE_T {
            ...
            if br_0 != CMFAIL && end_0 != CMFAIL && br_0 < end_0 {
                let mut ssize_0: size_t = end_0.offset_from(br_0) as ::core::ffi::c_int as size_t;
                if ssize_0 as usize
                    > (nb as usize).wrapping_add(
                        (if ::core::ptr::null_mut::<::core::ffi::c_char>().offset(
                            ((::core::mem::size_of::<size_t>() as usize) << 1 as ::core::ffi::c_int)
    ...
    if tbase != CMFAIL {
        (*m).footprint = ((*m).footprint as ::core::ffi::c_uint)
            .wrapping_add(tsize as ::core::ffi::c_uint) as size_t
            as size_t;
        if (*m).footprint > (*m).max_footprint {
            (*m).max_footprint = (*m).footprint;
        }
        if (*m).top.is_null() {
            ...
            if !sp.is_null()
                && 1 as ::core::ffi::c_int as ::core::ffi::c_uint & EXTERN_BIT == 0
                && *(tbase
                    .offset(tsize as isize)
                    .offset(-(::core::mem::size_of::<ptrdiff_t>() as usize as isize))
                    as *mut ptrdiff_t)
                    == (*sp).exec_offset
                && 1 as ::core::ffi::c_int as size_t & USE_MMAP_BIT == mmap_flag
                && ((*m).top as *mut ::core::ffi::c_char >= (*sp).base
                    && ((*m).top as *mut ::core::ffi::c_char)
                        < (*sp).base.offset((*sp).size as isize))
            {
                (*sp).size = ((*sp).size as ::core::ffi::c_uint)
                    .wrapping_add(tsize as ::core::ffi::c_uint)
                    as size_t as size_t;
        ...
        if nb < (*m).topsize {
            (*m).topsize = ((*m).topsize as ::core::ffi::c_uint)
                .wrapping_sub(nb as ::core::ffi::c_uint) as size_t
                as size_t;
...
unsafe extern "C" fn release_unused_segments(mut m: mstate) -> size_t {
            ...
            && 1 as ::core::ffi::c_int as ::core::ffi::c_uint & EXTERN_BIT == 0
        {
                    ...
                    )
            {
                ...
                if p == (*m).dv {
                    ...
                    if !XP.is_null() {
                        ...
                        if tp == *H {
                            *H = R as tbinptr;
                            if (*H).is_null() {
                                (*m).treemap &= !((1 as ::core::ffi::c_int as binmap_t)
                                    << (*tp).index)
                                    as ::core::ffi::c_uint;
                            }
                        } else if (XP as *mut ::core::ffi::c_char >= (*m).least_addr)
                ...
                if dlmunmap(base as *mut ::core::ffi::c_void, size) == 0 as ::core::ffi::c_int {
                    released = (released as ::core::ffi::c_uint)
                        .wrapping_add(size as ::core::ffi::c_uint)
                        as size_t as size_t;
                    (*m).footprint = ((*m).footprint as ::core::ffi::c_uint)
                        .wrapping_sub(size as ::core::ffi::c_uint)
                        as size_t as size_t;
                    sp = pred;
                    ...
                    if X == 0 as ::core::ffi::c_uint {
                        ...
                        let mut K: ::core::ffi::c_uint =
                            (::core::mem::size_of::<::core::ffi::c_uint>() as ::core::ffi::c_uint)
                                ...
                                .wrapping_sub(1 as ::core::ffi::c_uint)
                                .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
                        I = (K << 1 as ::core::ffi::c_int).wrapping_add(
                            psize as ::core::ffi::c_uint
                                >> K.wrapping_add(
    ...
    (*m).release_checks = (if nsegs as size_t > MAX_RELEASE_CHECK_RATE as size_t {
        nsegs as ::core::ffi::c_uint
    } else {
        MAX_RELEASE_CHECK_RATE as ::core::ffi::c_uint
    }) as size_t;
    return released;
}
unsafe extern "C" fn sys_trim(mut m: mstate, mut pad: size_t) -> ::core::ffi::c_int {
    ...
    (atomic_load_acquire(&raw mut mparams.magic) != 0 as ::core::ffi::c_uint || init_mparams() != 0)
        as ::core::ffi::c_int;
    if (pad as usize) < MAX_REQUEST && !(*m).top.is_null() {
        pad = (pad as ::core::ffi::c_uint).wrapping_add(
            (if ::core::ptr::null_mut::<::core::ffi::c_char>().offset(
                ((::core::mem::size_of::<size_t>() as usize) << 1 as ::core::ffi::c_int) as isize,
            ) as *mut ::core::ffi::c_void as size_t
                & CHUNK_ALIGN_MASK
        ...
        if (*m).topsize > pad {
            ...
            if 1 as ::core::ffi::c_int as ::core::ffi::c_uint & EXTERN_BIT == 0 {
                if 1 as ::core::ffi::c_int as size_t & USE_MMAP_BIT != 0 {
            ...
            if released != 0 as ::core::ffi::c_uint {
                (*sp).size = ((*sp).size as ::core::ffi::c_uint)
                    .wrapping_sub(released as ::core::ffi::c_uint)
                    as size_t as size_t;
                (*m).footprint = ((*m).footprint as ::core::ffi::c_uint)
                    .wrapping_sub(released as ::core::ffi::c_uint)
                    as size_t as size_t;
        ...
        released = (released as ::core::ffi::c_uint)
            .wrapping_add(release_unused_segments(m) as ::core::ffi::c_uint)
            as size_t as size_t;
        if released == 0 as ::core::ffi::c_uint && (*m).topsize > (*m).trim_check {
            (*m).trim_check = MAX_SIZE_T;
        }
    }
    return if released != 0 as ::core::ffi::c_uint {
        1 as ::core::ffi::c_int
    } else {
        0 as ::core::ffi::c_int
    };
...
unsafe extern "C" fn dispose_chunk(mut m: mstate, mut p: mchunkptr, mut psize: size_t) {
    ...
    if (*p).head & PINUSE_BIT == 0 {
        ...
        if (*p).head & INUSE_BITS == 0 as ::core::ffi::c_uint {
            psize =
                (psize as ::core::ffi::c_uint).wrapping_add(
                    (prevsize as usize).wrapping_add(MMAP_FOOT_PAD) as ::core::ffi::c_uint,
                ) as size_t as size_t;
            if dlmunmap(
            ...
            {
                (*m).footprint = ((*m).footprint as ::core::ffi::c_uint)
                    .wrapping_sub(psize as ::core::ffi::c_uint)
                    as size_t as size_t;
            }
            return;
        }
        prev = (p as *mut ::core::ffi::c_char).offset(-(prevsize as isize)) as mchunkptr;
        psize = (psize as ::core::ffi::c_uint).wrapping_add(prevsize as ::core::ffi::c_uint)
            as size_t as size_t;
        p = prev;
        ...
        {
            if p != (*m).dv {
                if prevsize >> SMALLBIN_SHIFT < NSMALLBINS {
                ...
                (*m).dvsize = psize;
                (*next).head &= !PINUSE_BIT as ::core::ffi::c_uint;
                (*p).head = psize | PINUSE_BIT;
        ...
        != 0
    {
        if (*next).head & CINUSE_BIT == 0 {
            if next == (*m).top {
                (*m).topsize = ((*m).topsize as ::core::ffi::c_uint)
                    .wrapping_add(psize as ::core::ffi::c_uint)
                    as size_t as size_t;
                let mut tsize: size_t = (*m).topsize;
                (*m).top = p;
                ...
                psize = (psize as ::core::ffi::c_uint).wrapping_add(nsize as ::core::ffi::c_uint)
                    as size_t as size_t;
                if nsize >> SMALLBIN_SHIFT < NSMALLBINS {
        ...
        if psize >> SMALLBIN_SHIFT < NSMALLBINS {
            ...
            if X == 0 as ::core::ffi::c_uint {
                ...
                let mut K: ::core::ffi::c_uint = (::core::mem::size_of::<::core::ffi::c_uint>()
                    ...
                    .wrapping_sub(1 as ::core::ffi::c_uint)
                    .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
                I_2 = (K << 1 as ::core::ffi::c_int).wrapping_add(
                    psize as ::core::ffi::c_uint
                        >> K.wrapping_add(TREEBIN_SHIFT.wrapping_sub(1 as ::core::ffi::c_uint))
                        & 1 as ::core::ffi::c_uint,
                );
            ...
            if (*m).treemap & (1 as ::core::ffi::c_int as binmap_t) << I_2 == 0 {
                (*m).treemap |=
                    ((1 as ::core::ffi::c_int as binmap_t) << I_2) as ::core::ffi::c_uint;
                *H_1 = TP_1 as tbinptr;
...
unsafe extern "C" fn tmalloc_large(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
    ...
    if X == 0 as ::core::ffi::c_uint {
        ...
        let mut K: ::core::ffi::c_uint = (::core::mem::size_of::<::core::ffi::c_uint>()
            ...
            .wrapping_sub(1 as ::core::ffi::c_uint)
            .wrapping_sub(X.leading_zeros() as i32 as ::core::ffi::c_uint);
        idx = (K << 1 as ::core::ffi::c_int).wrapping_add(
            nb as ::core::ffi::c_uint
                >> K.wrapping_add(TREEBIN_SHIFT.wrapping_sub(1 as ::core::ffi::c_uint))
                & 1 as ::core::ffi::c_uint,
        );
    }
    ...
    if !t.is_null() {
        ...
        loop {
            ...
            if trem < rsize {
                v = t;
                rsize = trem;
                if rsize == 0 as ::core::ffi::c_uint {
                    break;
                }
            }
            rt = (*t).child[1 as ::core::ffi::c_int as usize] as tchunkptr;
            t = (*t).child[(sizebits as ::core::ffi::c_uint
                >> SIZE_T_BITSIZE.wrapping_sub(SIZE_T_ONE as usize)
                & 1 as ::core::ffi::c_uint) as usize] as tchunkptr;
            if !rt.is_null() && rt != t {
                rst = rt;
            }
            if t.is_null() {
        ...
        let mut leftbits: binmap_t =
            ((1 as ::core::ffi::c_int as binmap_t) << idx << 1 as ::core::ffi::c_int
                | ((1 as ::core::ffi::c_int as binmap_t) << idx << 1 as ::core::ffi::c_int)
                    .wrapping_neg())
                & (*m).treemap;
        if leftbits != 0 as ::core::ffi::c_uint {
            let mut i: bindex_t = 0;
    ...
    if !v.is_null() && rsize < (*m).dvsize.wrapping_sub(nb) {
            ...
            != 0
        {
                ...
                != 0
            {
                ...
                if (rsize as usize) < MIN_CHUNK_SIZE {
                    (*v).head = rsize.wrapping_add(nb) | PINUSE_BIT | CINUSE_BIT;
                    let ref mut fresh4 = (*((v as *mut ::core::ffi::c_char)
                        .offset(rsize.wrapping_add(nb) as isize)
                        as mchunkptr))
                        .head;
                    *fresh4 |= PINUSE_BIT as ::core::ffi::c_uint;
                } else {
                    (*v).head = nb | PINUSE_BIT | CINUSE_BIT;
                    (*r).head = rsize | PINUSE_BIT;
                    (*((r as *mut ::core::ffi::c_char).offset(rsize as isize) as mchunkptr))
                        .prev_foot = rsize;
                    if rsize >> SMALLBIN_SHIFT < NSMALLBINS {
                        let mut I: bindex_t = rsize >> SMALLBIN_SHIFT;
                        let mut B: mchunkptr = (&raw mut (*m).smallbins as *mut mchunkptr)
                            .offset((I << 1 as ::core::ffi::c_int) as isize)
                            as *mut mchunkptr
                            as *mut ::core::ffi::c_char
                        ...
                        let mut X_0: ::core::ffi::c_uint =
                            rsize as ::core::ffi::c_uint >> TREEBIN_SHIFT;
                        if X_0 == 0 as ::core::ffi::c_uint {
                            ...
                            I_0 = (K_0 << 1 as ::core::ffi::c_int).wrapping_add(
                                rsize as ::core::ffi::c_uint
                                    >> K_0.wrapping_add(
                                        TREEBIN_SHIFT.wrapping_sub(1 as ::core::ffi::c_uint),
                                    )
                                    & 1 as ::core::ffi::c_uint,
...
unsafe extern "C" fn tmalloc_small(mut m: mstate, mut nb: size_t) -> *mut ::core::ffi::c_void {
        ...
        != 0
    {
            ...
            != 0
        {
            ...
            if (rsize as usize) < MIN_CHUNK_SIZE {
                (*v).head = rsize.wrapping_add(nb) | PINUSE_BIT | CINUSE_BIT;
                let ref mut fresh5 = (*((v as *mut ::core::ffi::c_char)
                    .offset(rsize.wrapping_add(nb) as isize)
                    as mchunkptr))
                    .head;
                *fresh5 |= PINUSE_BIT as ::core::ffi::c_uint;
            } else {
                (*v).head = nb | PINUSE_BIT | CINUSE_BIT;
                (*r).head = rsize | PINUSE_BIT;
                (*((r as *mut ::core::ffi::c_char).offset(rsize as isize) as mchunkptr))
                ...
                if DVS != 0 as ::core::ffi::c_uint {
                    let mut DV: mchunkptr = (*m).dv;
                    let mut I: bindex_t = DVS >> SMALLBIN_SHIFT;
                    let mut B: mchunkptr = (&raw mut (*m).smallbins as *mut mchunkptr)
                        .offset((I << 1 as ::core::ffi::c_int) as isize)
                        as *mut mchunkptr
                        as *mut ::core::ffi::c_char
...
unsafe extern "C" fn dlmalloc(mut bytes: size_t) -> *mut ::core::ffi::c_void {
    ...
    if if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
        if atomic_xchg_acquire(&raw mut _gm_.mutex, 1 as ::core::ffi::c_int) != 0 {
    ...
    } == 0
    {
        ...
        let mut nb: size_t = 0;
        if bytes as usize <= MAX_SMALL_REQUEST {
            let mut idx: bindex_t = 0;
            let mut smallbits: binmap_t = 0;
            nb = (if (bytes as usize) < MIN_REQUEST {
                MIN_CHUNK_SIZE
            } else {
                (bytes as usize)
                    .wrapping_add(CHUNK_OVERHEAD)
                ...
                != 0 as ::core::ffi::c_uint
            {
                ...
                idx = (idx as ::core::ffi::c_uint)
                    .wrapping_add(!(smallbits as ::core::ffi::c_uint) & 1 as ::core::ffi::c_uint)
                ...
                if b == F {
                    _gm_.smallmap &=
                        !((1 as ::core::ffi::c_int as binmap_t) << idx) as ::core::ffi::c_uint;
                ...
                (*p).head = (idx as size_t) << 3 as ::core::ffi::c_uint | PINUSE_BIT | CINUSE_BIT;
                let ref mut fresh1 = (*((p as *mut ::core::ffi::c_char)
                    .offset((idx << 3 as ::core::ffi::c_uint) as isize)
                    as mchunkptr))
                    .head;
                *fresh1 |= PINUSE_BIT as ::core::ffi::c_uint;
                mem = (p as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as isize)
                    as *mut ::core::ffi::c_void;
                current_block = 14240994674970768557;
            } else if nb > _gm_.dvsize {
                if smallbits != 0 as ::core::ffi::c_uint {
                    ...
                    if SIZE_T_SIZE != 4 as usize && (rsize as usize) < MIN_CHUNK_SIZE {
                        (*p_0).head =
                            (i as size_t) << 3 as ::core::ffi::c_uint | PINUSE_BIT | CINUSE_BIT;
                        let ref mut fresh2 = (*((p_0 as *mut ::core::ffi::c_char)
                            .offset((i << 3 as ::core::ffi::c_uint) as isize)
                            as mchunkptr))
                            .head;
                        *fresh2 |= PINUSE_BIT as ::core::ffi::c_uint;
                    } else {
                    ...
                    mem = (p_0 as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as isize)
                        as *mut ::core::ffi::c_void;
                    current_block = 14240994674970768557;
                } else if _gm_.treemap != 0 as ::core::ffi::c_uint && {
        ...
        } else if bytes as usize >= MAX_REQUEST {
            nb = MAX_SIZE_T;
            current_block = 7419121793134201633;
        } else {
            nb = ((bytes as usize)
                .wrapping_add(CHUNK_OVERHEAD)
                .wrapping_add(CHUNK_ALIGN_MASK as usize)
                & !(CHUNK_ALIGN_MASK as usize)) as size_t;
            if _gm_.treemap != 0 as ::core::ffi::c_uint && {
        ...
        match current_block {
            7419121793134201633 => {
                if nb <= _gm_.dvsize {
                    ...
                    if rsize_0 as usize >= MIN_CHUNK_SIZE {
                        _gm_.dv =
                        ...
                        let ref mut fresh3 = (*((p_1 as *mut ::core::ffi::c_char)
                            .offset(dvs as isize)
                            as mchunkptr))
                            .head;
                        *fresh3 |= PINUSE_BIT as ::core::ffi::c_uint;
                    }
                    mem = (p_1 as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as isize)
                        as *mut ::core::ffi::c_void;
                } else if nb < _gm_.topsize {
                    _gm_.topsize = (_gm_.topsize as ::core::ffi::c_uint)
                        .wrapping_sub(nb as ::core::ffi::c_uint)
                        as size_t as size_t;
                    ...
                    mem = (p_2 as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as isize)
                        as *mut ::core::ffi::c_void;
                } else {
        ...
        if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
            atomic_store_release(&raw mut _gm_.mutex, 0);
        }
        return mem;
    } else {
        return ::core::ptr::null_mut::<::core::ffi::c_void>();
...
unsafe extern "C" fn dlfree(mut mem: *mut ::core::ffi::c_void) {
    ...
    if !mem.is_null() {
        let mut p: mchunkptr =
            (mem as *mut ::core::ffi::c_char).offset(-(TWO_SIZE_T_SIZES as isize)) as mchunkptr;
        if if _gm_.mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
            if atomic_xchg_acquire(&raw mut _gm_.mutex, 1 as ::core::ffi::c_int) != 0 {
                spin_acquire_lock(&raw mut _gm_.mutex)
            } else {
                ...
                if (*p).head & PINUSE_BIT == 0 {
                    ...
                    if (*p).head & INUSE_BITS == 0 as ::core::ffi::c_uint {
                        psize = (psize as ::core::ffi::c_uint)
                            .wrapping_add((prevsize as usize).wrapping_add(MMAP_FOOT_PAD)
                        ...
                        {
                            _gm_.footprint = (_gm_.footprint as ::core::ffi::c_uint)
                                .wrapping_sub(psize as ::core::ffi::c_uint)
                                as size_t as size_t;
                        }
                        current_block = 14177526720548717257;
                    } else {
                        let mut prev: mchunkptr = (p as *mut ::core::ffi::c_char)
                            .offset(-(prevsize as isize))
                            as mchunkptr;
                        psize = (psize as ::core::ffi::c_uint)
                            .wrapping_add(prevsize as ::core::ffi::c_uint)
                            as size_t as size_t;
                        p = prev;
                            ...
                            != 0
                        {
                            ...
                            current_block = 1642091255827419;
                        }
                    }
                } else {
                    current_block = 10778260831612459202;
                                    ...
                                    != 0
                                {
                                    if (*next).head & CINUSE_BIT == 0 {
                                        if next == _gm_.top {
                                            ...
                                            _gm_.dvsize = (_gm_.dvsize as ::core::ffi::c_uint)
                                                .wrapping_add(psize as ::core::ffi::c_uint)
                                                as size_t
                                                as size_t;
                                            ...
                                            psize = (psize as ::core::ffi::c_uint)
                                                .wrapping_add(nsize as ::core::ffi::c_uint)
                                                as size_t
                                                as size_t;
                                            if nsize >> SMALLBIN_SHIFT < NSMALLBINS {
                                                let mut F_1: mchunkptr = (*next).fd as mchunkptr;
                                        ...
                                        _ => {
                                            if psize >> SMALLBIN_SHIFT < NSMALLBINS {
                                                ...
                                                let mut X: ::core::ffi::c_uint =
                                                    psize as ::core::ffi::c_uint >> TREEBIN_SHIFT;
                                                if X == 0 as ::core::ffi::c_uint {
                                                    I_2 = 0 as bindex_t;
                                                } else if X > 0xffff as ::core::ffi::c_uint {
                                                    I_2 = NTREEBINS
                                                ...
                                                if _gm_.release_checks == 0 as ::core::ffi::c_uint {
...
unsafe extern "C" fn dlcalloc(
    ...
    if n_elements != 0 as ::core::ffi::c_uint {
    ...
    mem = dlmalloc(req);
    if !mem.is_null()
        && !((*((mem as *mut ::core::ffi::c_char).offset(
            -(((::core::mem::size_of::<size_t>() as usize) << 1 as ::core::ffi::c_int) as isize),
        ) as mchunkptr))
            .head
            & INUSE_BITS
        ...
        != 0
    {
        if (*p).head & INUSE_BITS == 0 as ::core::ffi::c_uint {
            ...
            if oldsize.wrapping_add((*m).topsize) > nb {
                ...
                let ref mut fresh8 =
                    (*((p as *mut ::core::ffi::c_char).offset(nb as isize) as mchunkptr)).head;
                *fresh8 |= PINUSE_BIT as ::core::ffi::c_uint;
            ...
            if oldsize.wrapping_add(dvs) >= nb {
                ...
                if dsize as usize >= MIN_CHUNK_SIZE {
                    ...
                    let ref mut fresh9 =
                        (*((p as *mut ::core::ffi::c_char).offset(nb as isize) as mchunkptr)).head;
                    *fresh9 |= PINUSE_BIT as ::core::ffi::c_uint;
                    (*r_0).head = dsize | PINUSE_BIT;
                    (*((r_0 as *mut ::core::ffi::c_char).offset(dsize as isize) as mchunkptr))
                        .prev_foot = dsize;
                    (*n).head &= !PINUSE_BIT as ::core::ffi::c_uint;
                    (*m).dvsize = dsize;
                    (*m).dv = r_0;
                } else {
                    let mut newsize_0: size_t = oldsize.wrapping_add(dvs);
                    (*p).head = (*p).head & PINUSE_BIT | newsize_0 | CINUSE_BIT;
                    let ref mut fresh10 = (*((p as *mut ::core::ffi::c_char)
                        .offset(newsize_0 as isize)
                        as mchunkptr))
                        .head;
                    *fresh10 |= PINUSE_BIT as ::core::ffi::c_uint;
                    (*m).dvsize = 0 as size_t;
                    (*m).dv = ::core::ptr::null_mut::<malloc_chunk>();
                }
                newp = p;
            ...
            if oldsize.wrapping_add(nextsize) >= nb {
                ...
                if (rsize_0 as usize) < MIN_CHUNK_SIZE {
                    ...
                    let ref mut fresh11 = (*((p as *mut ::core::ffi::c_char)
                        .offset(newsize_1 as isize)
                        as mchunkptr))
                        .head;
                    *fresh11 |= PINUSE_BIT as ::core::ffi::c_uint;
                } else {
                    ...
                    let ref mut fresh12 =
                        (*((p as *mut ::core::ffi::c_char).offset(nb as isize) as mchunkptr)).head;
                    *fresh12 |= PINUSE_BIT as ::core::ffi::c_uint;
                    (*r_1).head = (*r_1).head & PINUSE_BIT | rsize_0 | CINUSE_BIT;
                    let ref mut fresh13 = (*((r_1 as *mut ::core::ffi::c_char)
                        .offset(rsize_0 as isize)
                        as mchunkptr))
                        .head;
                    *fresh13 |= PINUSE_BIT as ::core::ffi::c_uint;
...
unsafe extern "C" fn internal_memalign(
    ...
    let mut mem: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<::core::ffi::c_void>();
    if (alignment as usize) < MIN_CHUNK_SIZE {
        alignment = MIN_CHUNK_SIZE as size_t;
    }
    if alignment & alignment.wrapping_sub(SIZE_T_ONE) != 0 as ::core::ffi::c_uint {
    ...
    if bytes as usize >= MAX_REQUEST.wrapping_sub(alignment as usize) {
        if !m.is_null() {
            *__errno_location() = ENOMEM;
        }
    } else {
        let mut nb: size_t = if (bytes as usize) < MIN_REQUEST {
        ...
        if !mem.is_null() {
            ...
            if mem as ::core::ffi::c_uint
                & (alignment as ::core::ffi::c_uint).wrapping_sub(1 as ::core::ffi::c_uint)
                != 0 as ::core::ffi::c_uint
            {
                ...
                let mut pos: *mut ::core::ffi::c_char =
                    if br.offset_from(p as *mut ::core::ffi::c_char) as ::core::ffi::c_int as usize
                        >= MIN_CHUNK_SIZE
                    {
                        br
                    } else {
                ...
                let mut leadsize: size_t =
                    pos.offset_from(p as *mut ::core::ffi::c_char) as ::core::ffi::c_int as size_t;
            ...
            if !((*p).head & INUSE_BITS == 0 as ::core::ffi::c_uint) {
                ...
                if size as usize > (nb as usize).wrapping_add(MIN_CHUNK_SIZE) {
                    ...
                    let ref mut fresh16 =
                        (*((p as *mut ::core::ffi::c_char).offset(nb as isize) as mchunkptr)).head;
                    *fresh16 |= PINUSE_BIT as ::core::ffi::c_uint;
                    (*remainder).head =
                        (*remainder).head & PINUSE_BIT | remainder_size | CINUSE_BIT;
                    let ref mut fresh17 = (*((remainder as *mut ::core::ffi::c_char)
                        .offset(remainder_size as isize)
                        as mchunkptr))
                        .head;
                    *fresh17 |= PINUSE_BIT as ::core::ffi::c_uint;
...
unsafe extern "C" fn ialloc(
    ...
    let mut marray: *mut *mut ::core::ffi::c_void =
    ...
    if !chunks.is_null() {
        ...
        array_size = (if (n_elements as usize)
            .wrapping_mul(::core::mem::size_of::<*mut ::core::ffi::c_void>() as usize)
            < MIN_REQUEST
        {
            MIN_CHUNK_SIZE
    ...
    if opts & 0x1 as ::core::ffi::c_int != 0 {
        element_size = (if (*sizes as usize) < MIN_REQUEST {
            MIN_CHUNK_SIZE
        } else {
            (*sizes as usize)
                .wrapping_add(CHUNK_OVERHEAD)
        ...
        i = 0 as size_t;
        while i != n_elements {
            contents_size = (contents_size as ::core::ffi::c_uint).wrapping_add(
                (if (*sizes.offset(i as isize) as usize) < MIN_REQUEST {
                    MIN_CHUNK_SIZE
                } else {
    ...
    p = (mem as *mut ::core::ffi::c_char).offset(-(TWO_SIZE_T_SIZES as isize)) as mchunkptr;
    ...
    if opts & 0x2 as ::core::ffi::c_int != 0 {
        memset(
            ...
            0 as ::core::ffi::c_int,
            remainder_size
                .wrapping_sub(SIZE_T_SIZE as size_t)
                .wrapping_sub(array_size),
        );
    }
    if marray.is_null() {
        let mut array_chunk_size: size_t = 0;
        array_chunk = (p as *mut ::core::ffi::c_char).offset(contents_size as isize) as mchunkptr;
        array_chunk_size = remainder_size.wrapping_sub(contents_size);
        marray = (array_chunk as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as isize)
    ...
    i = 0 as size_t;
    loop {
        let ref mut fresh18 = *marray.offset(i as isize);
        *fresh18 = (p as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as isize)
            as *mut ::core::ffi::c_void;
        if i != (n_elements as ::core::ffi::c_uint).wrapping_sub(1 as ::core::ffi::c_uint) {
            if element_size != 0 as ::core::ffi::c_uint {
                size = element_size;
            } else {
                size = (if (*sizes.offset(i as isize) as usize) < MIN_REQUEST {
                    MIN_CHUNK_SIZE
                } else {
                    (*sizes.offset(i as isize) as usize)
                        .wrapping_add(CHUNK_OVERHEAD)
            ...
            remainder_size = (remainder_size as ::core::ffi::c_uint)
                .wrapping_sub(size as ::core::ffi::c_uint) as size_t
                as size_t;
            ...
            if !mem.is_null() {
                ...
                *a = ::core::ptr::null_mut::<::core::ffi::c_void>();
                    ...
                    != 0
                {
                    ...
                    if b != fence
                        && *b
                            == (next as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as isize)
                                as *mut ::core::ffi::c_void
                    {
                        ...
                        let ref mut fresh19 = (*((p as *mut ::core::ffi::c_char)
                            .offset(newsize as isize)
                            as mchunkptr))
                            .head;
                        *fresh19 |= PINUSE_BIT as ::core::ffi::c_uint;
                        *b = (p as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as isize)
                            as *mut ::core::ffi::c_void;
                    } else {
...
unsafe extern "C" fn dlrealloc(
    ...
    if oldmem.is_null() {
        ...
        *__errno_location() = ENOMEM;
        ...
        let mut oldp: mchunkptr =
            (oldmem as *mut ::core::ffi::c_char).offset(-(TWO_SIZE_T_SIZES as isize)) as mchunkptr;
        ...
        {
            let mut newp: mchunkptr = try_realloc_chunk(m, oldp, nb, 1 as ::core::ffi::c_int);
            if (*m).mflags as ::core::ffi::c_uint & USE_LOCK_BIT != 0 {
                atomic_store_release(&raw mut (*m).mutex, 0);
            }
            if !newp.is_null() {
                mem = (newp as *mut ::core::ffi::c_char).offset(TWO_SIZE_T_SIZES as isize)
                    as *mut ::core::ffi::c_void;
            } else {
                mem = dlmalloc(bytes);
                if !mem.is_null() {
                    let mut oc: size_t = ((*oldp).head & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT))
                        .wrapping_sub(
                            (if (*oldp).head & INUSE_BITS == 0 as ::core::ffi::c_uint {
                                MMAP_CHUNK_OVERHEAD as size_t
                            } else {
                                CHUNK_OVERHEAD as size_t
                            }),
                        );
...
pub unsafe extern "C" fn dlposix_memalign(
    ...
    if alignment == MALLOC_ALIGNMENT {
        ...
        if r != 0 as ::core::ffi::c_uint
            || d == 0 as ::core::ffi::c_uint
            || d & d.wrapping_sub(SIZE_T_ONE) != 0 as ::core::ffi::c_uint
        {
            return EINVAL;
        } else if bytes as usize <= MAX_REQUEST.wrapping_sub(alignment as usize) {
            if (alignment as usize) < MIN_CHUNK_SIZE {
                alignment = MIN_CHUNK_SIZE as size_t;
            }
...
unsafe extern "C" fn dlpvalloc(mut bytes: size_t) -> *mut ::core::ffi::c_void {
    ...
    return dlmemalign(
        pagesz,
        bytes.wrapping_add(pagesz).wrapping_sub(SIZE_T_ONE) & !pagesz.wrapping_sub(SIZE_T_ONE),
    );
}
...
pub unsafe extern "C" fn dlmalloc_footprint_limit() -> size_t {
    ...
    return if maf == 0 as ::core::ffi::c_uint {
        MAX_SIZE_T
    } else {
        maf
    };
...
unsafe extern "C" fn dlmalloc_usable_size(mut mem: *mut ::core::ffi::c_void) -> size_t {
    if !mem.is_null() {
        let mut p: mchunkptr =
            (mem as *mut ::core::ffi::c_char).offset(-(TWO_SIZE_T_SIZES as isize)) as mchunkptr;
        if (*p).head & INUSE_BITS != PINUSE_BIT {
            return ((*p).head & !(PINUSE_BIT | CINUSE_BIT | FLAG4_BIT)).wrapping_sub(
                (if (*p).head & INUSE_BITS == 0 as ::core::ffi::c_uint {
                    MMAP_CHUNK_OVERHEAD as size_t
                } else {
                    CHUNK_OVERHEAD as size_t
...
unsafe extern "C" fn allocate_space(
    ...
    while len > 0 as ::core::ffi::c_longlong {
        let mut to_write: off_t = if len < page_size as ::core::ffi::c_longlong {
            len
        } else {
            page_size as off_t
        };
        ...
        len -= to_write as ::core::ffi::c_longlong;
    }
    return 0 as ::core::ffi::c_int;
}
unsafe extern "C" fn dlmmap_locked(
    ...
    if execfd == -(1 as ::core::ffi::c_int) {
        open_temp_exec_file_opts_idx = 0 as ::core::ffi::c_int;
        current_block = 14697093323361636514;
    } else {
        current_block = 735147466149431745;
    }
    loop {
        match current_block {
            14697093323361636514 => {
            ...
            _ => {
                ...
                if ptr == MFAIL {
                    if offset == 0 {
                        ...
                        ftruncate(execfd, offset) != 0 as ::core::ffi::c_int;
                        return MFAIL;
                    }
                } else {
                    if offset == 0
                    ...
                    *((start as *mut ::core::ffi::c_char)
                        ...
                        as ::core::ffi::c_int
                        as ptrdiff_t;
                    execsize = (execsize as ::core::ffi::c_uint)
                        .wrapping_add(length as ::core::ffi::c_uint)
                        as size_t as size_t;
                    return start;
                }
            }
