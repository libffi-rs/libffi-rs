...
extern "fastcall" {
    fn ffi_call_i386(_: *mut call_frame, _: *mut ::core::ffi::c_char);
}
...
pub struct call_frame {
    ...
    // C2Rust lowers C alloca to a heap Vec. The assembly bridge copies this
    // prepared heap argument area onto the real machine stack before calling.
    pub stack_bytes: size_t,
    pub saved_esi: ::core::ffi::c_uint,
    pub saved_edi: ::core::ffi::c_uint,
}
...
pub unsafe extern "C" fn ffi_prep_cif_machdep(mut cif: *mut ffi_cif) -> ffi_status {
    ...
    match (*(*cif).rtype).type_0 as ::core::ffi::c_int {
        ...
        FFI_TYPE_STRUCT => {
            current_block_20 = 12259643741576570461;
        }
        FFI_TYPE_COMPLEX => {
            match (**(*(*cif).rtype)
                .elements
            ...
            .type_0 as ::core::ffi::c_int
            {
                ...
                FFI_TYPE_FLOAT | FFI_TYPE_INT | FFI_TYPE_SINT32 | FFI_TYPE_UINT32 => {
                    current_block_20 = 1197143963890534728;
                    match current_block_20 {
                        10279516555703509863 => return FFI_BAD_TYPEDEF,
                        3022994191275552630 => {
                            flags = X86_RET_INT32;
                        }
                        4052296038368693785 => {
                ...
                FFI_TYPE_SINT16 | FFI_TYPE_UINT16 => {
                    current_block_20 = 3022994191275552630;
                    match current_block_20 {
                        10279516555703509863 => return FFI_BAD_TYPEDEF,
                        3022994191275552630 => {
                            flags = X86_RET_INT32;
                ...
                FFI_TYPE_SINT8 | FFI_TYPE_UINT8 => {
                    current_block_20 = 4052296038368693785;
                    match current_block_20 {
                        10279516555703509863 => return FFI_BAD_TYPEDEF,
                        3022994191275552630 => {
                            flags = X86_RET_INT32;
                ...
                _ => {
                    current_block_20 = 10279516555703509863;
                    match current_block_20 {
                        10279516555703509863 => return FFI_BAD_TYPEDEF,
                        3022994191275552630 => {
                            flags = X86_RET_INT32;
    ...
    match current_block_20 {
        12259643741576570461 => {
            ...
            bytes = (bytes as ::core::ffi::c_uint).wrapping_add(
                ((::core::mem::size_of::<*mut ::core::ffi::c_void>() as ::core::ffi::c_uint)
                    .wrapping_sub(1 as ::core::ffi::c_uint)
                    | (4 as ::core::ffi::c_int - 1 as ::core::ffi::c_int) as ::core::ffi::c_uint)
    ...
    while i < n {
        ...
        bytes = (bytes.wrapping_sub(1 as ::core::ffi::c_uint)
            | ((*t).alignment as ::core::ffi::c_int - 1 as ::core::ffi::c_int)
                as ::core::ffi::c_uint)
            .wrapping_add(1 as ::core::ffi::c_uint) as size_t;
        bytes = (bytes as ::core::ffi::c_uint).wrapping_add(
            ((*t).size.wrapping_sub(1 as ::core::ffi::c_uint)
                | (4 as ::core::ffi::c_int - 1 as ::core::ffi::c_int) as ::core::ffi::c_uint)
                .wrapping_add(1 as ::core::ffi::c_uint),
        ) as size_t as size_t;
        i += 1;
...
unsafe extern "C" fn ffi_call_int(
    ...
    bytes = ((*cif).bytes.wrapping_sub(1 as ::core::ffi::c_uint)
        | (16 as ::core::ffi::c_int - 1 as ::core::ffi::c_int) as ::core::ffi::c_uint)
        .wrapping_add(1 as ::core::ffi::c_uint) as size_t;
    ...
    match flags {
        X86_RET_STRUCTARG => {
            if (*pabi).nregs > 0 as ::core::ffi::c_int {
                ...
                current_block_24 = 8724207398491971587;
            }
        }
        X86_RET_STRUCTPOP => {
            current_block_24 = 8724207398491971587;
    ...
    while i < n {
        ...
        if z <= FFI_SIZEOF_ARG as ::core::ffi::c_uint && t != FFI_TYPE_STRUCT {
            ...
            if dir < 0 as ::core::ffi::c_int {
                ...
                argp = ((argp as ::core::ffi::c_uint).wrapping_sub(1 as ::core::ffi::c_uint)
                    | (align as ::core::ffi::c_uint).wrapping_sub(1 as ::core::ffi::c_uint))
                .wrapping_add(1 as ::core::ffi::c_uint)
...
pub unsafe extern "fastcall" fn ffi_closure_inner(
    ...
    argp = if dir < 0 as ::core::ffi::c_int {
        stack.offset(
            ((*cif).bytes.wrapping_sub(1 as ::core::ffi::c_uint)
                | (16 as ::core::ffi::c_int - 1 as ::core::ffi::c_int) as ::core::ffi::c_uint)
    ...
    match flags {
        X86_RET_STRUCTARG => {
            if (*pabi).nregs > 0 as ::core::ffi::c_int {
                ...
                current_block_12 = 1971549592808883872;
            }
        }
        X86_RET_STRUCTPOP => {
            current_block_12 = 1971549592808883872;
...
pub unsafe extern "C" fn ffi_prep_closure_loc(
    ...
    if ffi_tramp_is_present(closure as *mut ::core::ffi::c_void) != 0 {
        if dest == Some(ffi_closure_i386 as unsafe extern "C" fn() -> ()) {
            dest = Some(ffi_closure_i386_alt as unsafe extern "C" fn() -> ())
                as Option<unsafe extern "C" fn() -> ()>;
        } else if dest == Some(ffi_closure_STDCALL as unsafe extern "C" fn() -> ()) {
            dest = Some(ffi_closure_STDCALL_alt as unsafe extern "C" fn() -> ())
                as Option<unsafe extern "C" fn() -> ()>;
        } else {
            dest = Some(ffi_closure_REGISTER_alt as unsafe extern "C" fn() -> ())
                as Option<unsafe extern "C" fn() -> ()>;
        }
        ffi_tramp_set_parms(
...
pub unsafe extern "C" fn ffi_raw_call(
    ...
    alloca_allocations.push(::std::vec::from_elem(
        ...
        (bytes as usize)
            ...
            .wrapping_add(15 as usize) as usize,
    ));
    stack = (alloca_allocations.last_mut().unwrap().as_mut_ptr() as ::core::ffi::c_uint
    ...
    match flags {
        X86_RET_STRUCTARG => {
            if (*pabi).nregs > 0 as ::core::ffi::c_int {
                ...
                current_block_22 = 14659035159762295057;
            }
        }
        X86_RET_STRUCTPOP => {
            current_block_22 = 14659035159762295057;
    ...
    while narg_reg < (*pabi).nregs && i < n {
        ...
        let mut z: size_t = (*ty).size;
        let mut t: ::core::ffi::c_int = (*ty).type_0 as ::core::ffi::c_int;
        if z <= FFI_SIZEOF_ARG as ::core::ffi::c_uint && t != FFI_TYPE_STRUCT && t != FFI_TYPE_FLOAT
        {
            ...
            z = (z.wrapping_sub(1 as ::core::ffi::c_uint)
                | (4 as ::core::ffi::c_int - 1 as ::core::ffi::c_int) as ::core::ffi::c_uint)
                .wrapping_add(1 as ::core::ffi::c_uint) as size_t;
            argp = argp.offset(z as isize);
        }
        avalue = avalue.offset(z as isize);
        bytes = (bytes as ::core::ffi::c_uint).wrapping_sub(z as ::core::ffi::c_uint) as size_t
            as size_t;
        i += 1;
    }
    if i < n {
