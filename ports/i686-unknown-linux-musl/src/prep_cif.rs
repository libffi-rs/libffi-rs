...
unsafe extern "C" fn initialize_aggregate(
    ...
    while !(*ptr).is_null() {
        if (((**ptr).size == 0 as ::core::ffi::c_uint
        ...
        (*arg).size = ((*arg).size.wrapping_sub(1 as ::core::ffi::c_uint)
        ...
        (*arg).size = ((*arg).size as ::core::ffi::c_uint)
            .wrapping_add((**ptr).size as ::core::ffi::c_uint) as size_t
            as size_t;
        (*arg).alignment =
    ...
    (*arg).size = ((*arg).size.wrapping_sub(1 as ::core::ffi::c_uint)
        | ((*arg).alignment as ::core::ffi::c_int - 1 as ::core::ffi::c_int) as ::core::ffi::c_uint)
        .wrapping_add(1 as ::core::ffi::c_uint) as size_t;
    if (*arg).size == 0 as ::core::ffi::c_uint {
        return FFI_BAD_TYPEDEF;
    } else {
        return FFI_OK;
    };
...
pub unsafe extern "C" fn ffi_prep_cif_core(
    ...
    if (*(*cif).rtype).size == 0 as ::core::ffi::c_uint
