...
unsafe extern "C" fn ffi_call_int(
    ...
    {
        ecif.rvalue = &raw mut smst_buffer as *mut float128 as *mut ::core::ffi::c_void;
        ...
        && ecif.rvalue == &raw mut smst_buffer as *mut float128 as *mut ::core::ffi::c_void
    {
        ...
        if (*(*cif).rtype).type_0 as ::core::ffi::c_int == FFI_TYPE_COMPLEX
            && (*cif).flags
                & (FLAG_RETURNS_FP as ::core::ffi::c_int | FLAG_RETURNS_VEC as ::core::ffi::c_int)
                    as ::core::ffi::c_uint
                == 0 as ::core::ffi::c_uint
        {
            let mut hsize: size_t = (**(*(*cif).rtype)
                .elements
                .offset(0 as ::core::ffi::c_int as isize))
            .size;
            let mut off: size_t = 0 as size_t;
            memcpy(
                rvalue as *mut ::core::ffi::c_char as *mut ::core::ffi::c_void,
                (&raw mut smst_buffer as *mut float128 as *mut ::core::ffi::c_char)
                    .offset(off as isize) as *const ::core::ffi::c_void,
                hsize,
            );
            memcpy(
                (rvalue as *mut ::core::ffi::c_char).offset(hsize as isize)
            ...
            memcpy(
                rvalue,
                &raw mut smst_buffer as *mut float128 as *const ::core::ffi::c_void,
                rsize as size_t,
            );
        }
    }
