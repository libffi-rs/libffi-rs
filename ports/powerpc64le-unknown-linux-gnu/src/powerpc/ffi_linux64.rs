...
unsafe extern "C" fn ffi_prep_cif_linux64_core(mut cif: *mut ffi_cif) -> ffi_status {
    ...
    loop {
        match rtype {
            ...
            3 => {
                current_block = 3945171913356392060;
                break;
            }
            2 => {
                current_block = 7230695983778602002;
                break;
            }
            11 | 12 | 14 => {
            ...
            0 => {
                current_block = 13006631542393395751;
                break;
            }
            15 => {
                rtype = (**(*(*cif).rtype)
        ...
        match (**ptr).type_0 as ::core::ffi::c_int {
            FFI_TYPE_LONGDOUBLE => {
                    ...
                    != 0 as ::core::ffi::c_uint
                {
                    ...
                    current_block_79 = 1713858706696839000;
                }
            }
        ...
        match (**ptr).type_0 as ::core::ffi::c_int {
            FFI_TYPE_LONGDOUBLE => {
                    ...
                    != 0 as ::core::ffi::c_uint
                {
                    ...
                    current_block = 17582427730828511370;
                }
            }
            FFI_TYPE_DOUBLE => {
                current_block = 17582427730828511370;
            ...
            FFI_TYPE_UINT8 => {
                ...
                current_block = 15856508086491528895;
            }
            FFI_TYPE_SINT8 => {
        ...
        match (**arg_types.offset(i as isize)).type_0 as ::core::ffi::c_int {
            ...
            FFI_TYPE_LONGDOUBLE => {
                    ...
                    != 0 as ::core::ffi::c_uint
                {
                    ...
                    current_block_132 = 10975318996342434623;
                }
            }
            FFI_TYPE_DOUBLE => {
                current_block_132 = 10975318996342434623;
