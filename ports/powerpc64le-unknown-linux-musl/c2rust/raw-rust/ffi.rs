extern "C" {
    ...
    fn ffi_prep_types_sysv(_: ffi_abi);
    fn ffi_prep_cif_sysv(_: *mut ffi_cif) -> ffi_status;
    fn ffi_prep_closure_loc_sysv(
        _: *mut ffi_closure,
        _: *mut ffi_cif,
        _: Option<
            unsafe extern "C" fn(
...
unsafe extern "C" fn ffi_call_int(
    ...
    let mut smst_buffer: [::core::ffi::c_uchar; 128] = [0; 128];
    ...
    {
        ecif.rvalue = &raw mut smst_buffer as *mut ::core::ffi::c_uchar as *mut ::core::ffi::c_void;
        ...
        ecif.rvalue = alloca_allocations.last_mut().unwrap().as_mut_ptr();
    }
    ffi_call_SYSV(
        &raw mut ecif,
        fn_0,
        ...
        (*cif).flags,
        closure,
        (*cif).bytes.wrapping_neg() as ::core::ffi::c_int,
    );
    if !rvalue.is_null()
        && ecif.rvalue
            == &raw mut smst_buffer as *mut ::core::ffi::c_uchar as *mut ::core::ffi::c_void
    {
        let mut rsize: ::core::ffi::c_uint = (*(*cif).rtype).size as ::core::ffi::c_uint;
        memcpy(
            rvalue,
            &raw mut smst_buffer as *mut ::core::ffi::c_uchar as *const ::core::ffi::c_void,
            rsize as size_t,
        );
    }
}
