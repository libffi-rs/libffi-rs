...
// Complex and 128-bit descriptors omitted by C2Rust host frontend.
pub type UINT128 = u128;
pub type SINT128 = i128;
#[no_mangle]
...
pub unsafe fn initialize_complex_types() {
    COMPLEX_FLOAT_ELEMENTS[0] = &raw mut ffi_type_float;
    COMPLEX_DOUBLE_ELEMENTS[0] = &raw mut ffi_type_double;
    COMPLEX_LONGDOUBLE_ELEMENTS[0] = &raw mut ffi_type_longdouble;
    ffi_type_complex_float.elements = (&raw mut COMPLEX_FLOAT_ELEMENTS).cast::<*mut ffi_type>();
    ffi_type_complex_double.elements = (&raw mut COMPLEX_DOUBLE_ELEMENTS).cast::<*mut ffi_type>();
    ffi_type_complex_longdouble.elements =
        (&raw mut COMPLEX_LONGDOUBLE_ELEMENTS).cast::<*mut ffi_type>();
}
